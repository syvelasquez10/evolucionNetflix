...
public class Toolbar extends ViewGroup
{
    ...
    protected void onLayout(final boolean b, int i, int j, int k, int n) {
        ...
        if (this.shouldLayout((View)this.mNavButtonView)) {
            if (b2) {
                j = this.layoutChildRight((View)this.mNavButtonView, n, mTempMargins, minimumHeightCompat);
                i = k;
            }
            else {
                i = this.layoutChildLeft((View)this.mNavButtonView, k, mTempMargins, minimumHeightCompat);
                j = n;
            }
        }
        k = i;
        ...
        if (this.shouldLayout((View)this.mCollapseButtonView)) {
            if (b2) {
                n = this.layoutChildRight((View)this.mCollapseButtonView, j, mTempMargins, minimumHeightCompat);
                k = i;
            }
            else {
                k = this.layoutChildLeft((View)this.mCollapseButtonView, i, mTempMargins, minimumHeightCompat);
                n = j;
            }
        }
        j = k;
        ...
        if (this.shouldLayout((View)this.mMenuView)) {
            if (b2) {
                j = this.layoutChildLeft((View)this.mMenuView, k, mTempMargins, minimumHeightCompat);
                i = n;
            }
            else {
                i = this.layoutChildRight((View)this.mMenuView, n, mTempMargins, minimumHeightCompat);
                j = k;
            }
        }
        ...
        if (this.shouldLayout(this.mExpandedActionView)) {
            if (b2) {
                j = this.layoutChildRight(this.mExpandedActionView, n, mTempMargins, minimumHeightCompat);
                i = k;
            }
            else {
                i = this.layoutChildLeft(this.mExpandedActionView, k, mTempMargins, minimumHeightCompat);
                j = n;
            }
        }
        k = i;
        ...
        if (this.shouldLayout((View)this.mLogoView)) {
            if (b2) {
                n = this.layoutChildRight((View)this.mLogoView, j, mTempMargins, minimumHeightCompat);
                k = i;
            }
            else {
                k = this.layoutChildLeft((View)this.mLogoView, i, mTempMargins, minimumHeightCompat);
                n = j;
            }
        }
        ...
        for (n = this.mTempViews.size(), k = 0; k < n; ++k) {
            j = this.layoutChildLeft(this.mTempViews.get(k), j, mTempMargins, minimumHeightCompat);
        }
        ...
        k = i;
        for (i = n; i < size; ++i) {
            k = this.layoutChildRight(this.mTempViews.get(i), k, mTempMargins, minimumHeightCompat);
        }

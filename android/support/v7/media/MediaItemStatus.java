...
public final class MediaItemStatus
{
    ...
    public static final class Builder
    {
        ...
        public Builder(final int playbackState) {
            this.mBundle = new Bundle();
            this.setTimestamp(SystemClock.elapsedRealtime());
            this.setPlaybackState(playbackState);
        }
        
        public Builder(final MediaItemStatus mediaItemStatus) {
        ...
        public Builder setContentDuration(final long n) {
            this.mBundle.putLong("contentDuration", n);
            return this;
        }
        
        public Builder setContentPosition(final long n) {
        ...
        public Builder setPlaybackState(final int n) {

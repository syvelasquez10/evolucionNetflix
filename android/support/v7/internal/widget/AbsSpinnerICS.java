...
abstract class AbsSpinnerICS extends AdapterViewICS<SpinnerAdapter>
{
    ...
    protected void onMeasure(final int mWidthMeasureSpec, final int mHeightMeasureSpec) {
        ...
        this.setMeasuredDimension(resolveSize(Math.max(n4, this.getSuggestedMinimumWidth()), mWidthMeasureSpec), resolveSize(Math.max(n3, this.getSuggestedMinimumHeight()), mHeightMeasureSpec));

...
class ActionBarOverlayLayout$4 implements Runnable
{
    ...
    public void run() {
        ...
        if (this.this$0.mActionBarBottom != null && this.this$0.mActionBarBottom.getVisibility() != 8) {
            this.this$0.mCurrentActionBarBottomAnimator = ViewCompat.animate((View)this.this$0.mActionBarBottom).translationY(this.this$0.mActionBarBottom.getHeight()).setListener(this.this$0.mBottomAnimatorListener);
        }
    }
}

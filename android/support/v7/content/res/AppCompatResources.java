...
public final class AppCompatResources
{
    ...
    private static final WeakHashMap<Context, SparseArray<AppCompatResources$ColorStateListCacheEntry>> sColorStateCaches;
    
    static {
        TL_TYPED_VALUE = new ThreadLocal<TypedValue>();
        sColorStateCaches = new WeakHashMap<Context, SparseArray<AppCompatResources$ColorStateListCacheEntry>>(0);
    ...
    private static void addColorStateListToCache(final Context context, final int n, final ColorStateList list) {
        synchronized (AppCompatResources.sColorStateCacheLock) {
            ...
            if ((sparseArray = AppCompatResources.sColorStateCaches.get(context)) == null) {
                ...
                AppCompatResources.sColorStateCaches.put(context, (SparseArray<AppCompatResources$ColorStateListCacheEntry>)sparseArray);
            }
    ...
    private static ColorStateList getCachedColorStateList(final Context context, final int n) {
        synchronized (AppCompatResources.sColorStateCacheLock) {
            final SparseArray<AppCompatResources$ColorStateListCacheEntry> sparseArray = AppCompatResources.sColorStateCaches.get(context);

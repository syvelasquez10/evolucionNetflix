...
class ResourcesFlusher
{
    ...
    private static boolean flushLollipops(final Resources p0) {
        // 
    ...
    private static boolean flushMarshmallows(final Resources p0) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //    78: ifnull          90
        //    81: aload_0        
        //    82: invokestatic    android/support/v7/app/ResourcesFlusher.flushThemedResourcesCache:(Ljava/lang/Object;)Z
        //    85: ifeq            90
        //    88: iload_1        
        //    89: ireturn        
        //    90: iconst_0       
    ...
    private static boolean flushNougats(final Resources p0) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //   106: ifnull          161
        //   109: aload_0        
        //   110: invokestatic    android/support/v7/app/ResourcesFlusher.flushThemedResourcesCache:(Ljava/lang/Object;)Z
        //   113: ifeq            161
        //   116: iload_1        
        //   117: ireturn        
        //   118: astore_0       
    ...
    private static boolean flushThemedResourcesCache(final Object o) {
        ...
        while (true) {
            if (!ResourcesFlusher.sThemedResourceCache_mUnthemedEntriesFieldFetched) {
                ...
                while (true) {
                    try {
                        final LongSparseArray longSparseArray = (LongSparseArray)ResourcesFlusher.sThemedResourceCache_mUnthemedEntriesField.get(o);

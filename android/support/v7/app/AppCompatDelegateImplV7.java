...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, j
{
    ...
    private void callOnPanelClosed(final int n, final AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState, final Menu menu) {
        AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState2 = appCompatDelegateImplV7$PanelFeatureState;
        Object menu2 = menu;
        if (menu == null) {
            AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState3;
            if ((appCompatDelegateImplV7$PanelFeatureState3 = appCompatDelegateImplV7$PanelFeatureState) == null) {
                appCompatDelegateImplV7$PanelFeatureState3 = appCompatDelegateImplV7$PanelFeatureState;
                if (n >= 0) {
                    appCompatDelegateImplV7$PanelFeatureState3 = appCompatDelegateImplV7$PanelFeatureState;
                    if (n < this.mPanels.length) {
                        appCompatDelegateImplV7$PanelFeatureState3 = this.mPanels[n];
                    }
                }
            }
            appCompatDelegateImplV7$PanelFeatureState2 = appCompatDelegateImplV7$PanelFeatureState3;
            menu2 = menu;
            if (appCompatDelegateImplV7$PanelFeatureState3 != null) {
                menu2 = appCompatDelegateImplV7$PanelFeatureState3.menu;
                appCompatDelegateImplV7$PanelFeatureState2 = appCompatDelegateImplV7$PanelFeatureState3;
            }
        }
        if ((appCompatDelegateImplV7$PanelFeatureState2 == null || appCompatDelegateImplV7$PanelFeatureState2.isOpen) && !this.isDestroyed()) {
    ...
    private void checkCloseActionMenu(final i i) {
        ...
        if (windowCallback != null && !this.isDestroyed()) {
            windowCallback.onPanelClosed(108, (Menu)i);
        }
    ...
    private void closePanel(final AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState, final boolean b) {
        if (b && appCompatDelegateImplV7$PanelFeatureState.featureId == 0 && this.mDecorContentParent != null && this.mDecorContentParent.isOverflowMenuShowing()) {
            this.checkCloseActionMenu(appCompatDelegateImplV7$PanelFeatureState.menu);
        }
        else {
            final WindowManager windowManager = (WindowManager)this.mContext.getSystemService("window");
            if (windowManager != null && appCompatDelegateImplV7$PanelFeatureState.isOpen && appCompatDelegateImplV7$PanelFeatureState.decorView != null) {
                windowManager.removeView((View)appCompatDelegateImplV7$PanelFeatureState.decorView);
                if (b) {
                    this.callOnPanelClosed(appCompatDelegateImplV7$PanelFeatureState.featureId, appCompatDelegateImplV7$PanelFeatureState, null);
                }
            }
            appCompatDelegateImplV7$PanelFeatureState.isPrepared = false;
            appCompatDelegateImplV7$PanelFeatureState.isHandled = false;
            appCompatDelegateImplV7$PanelFeatureState.isOpen = false;
            appCompatDelegateImplV7$PanelFeatureState.shownPanelView = null;
            appCompatDelegateImplV7$PanelFeatureState.refreshDecorView = true;
            if (this.mPreparedPanel == appCompatDelegateImplV7$PanelFeatureState) {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            ...
            if (Build$VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener((View)contentView, new AppCompatDelegateImplV7$2(this));
            }
            else {
                ((FitWindowsViewGroup)contentView).setOnFitSystemWindowsListener(new AppCompatDelegateImplV7$3(this));
            }
        }
        if (contentView == null) {
    ...
    private void doInvalidatePanelMenu(final int n) {
        ...
        if ((n == 108 || n == 0) && this.mDecorContentParent != null) {
            final AppCompatDelegateImplV7$PanelFeatureState panelState2 = this.getPanelState(0, false);
            if (panelState2 != null) {
    ...
    private AppCompatDelegateImplV7$PanelFeatureState findMenuPanel(final Menu menu) {
        ...
        for (int i = 0; i < length; ++i) {
            final AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState = mPanels[i];
            if (appCompatDelegateImplV7$PanelFeatureState != null && appCompatDelegateImplV7$PanelFeatureState.menu == menu) {
    ...
    private AppCompatDelegateImplV7$PanelFeatureState getPanelState(final int n, final boolean b) {
        final AppCompatDelegateImplV7$PanelFeatureState[] mPanels = this.mPanels;
        AppCompatDelegateImplV7$PanelFeatureState[] mPanels2 = null;
        Label_0049: {
            if (mPanels != null) {
                mPanels2 = mPanels;
                if (mPanels.length > n) {
            ...
            mPanels2 = new AppCompatDelegateImplV7$PanelFeatureState[n + 1];
            if (mPanels != null) {
                System.arraycopy(mPanels, 0, mPanels2, 0, mPanels.length);
            }
            this.mPanels = mPanels2;
        }
        final AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState = mPanels2[n];
        if (appCompatDelegateImplV7$PanelFeatureState == null) {
            return mPanels2[n] = new AppCompatDelegateImplV7$PanelFeatureState(n);
        }
        return appCompatDelegateImplV7$PanelFeatureState;
    }
    
    private boolean initializePanelContent(final AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState) {
        if (appCompatDelegateImplV7$PanelFeatureState.createdPanelView != null) {
            appCompatDelegateImplV7$PanelFeatureState.shownPanelView = appCompatDelegateImplV7$PanelFeatureState.createdPanelView;
            return true;
        }
        if (appCompatDelegateImplV7$PanelFeatureState.menu == null) {
            return false;
        }
        if (this.mPanelMenuPresenterCallback == null) {
            this.mPanelMenuPresenterCallback = new AppCompatDelegateImplV7$PanelMenuPresenterCallback(this, null);
        }
        appCompatDelegateImplV7$PanelFeatureState.shownPanelView = (View)appCompatDelegateImplV7$PanelFeatureState.getListMenuView(this.mPanelMenuPresenterCallback);
        return appCompatDelegateImplV7$PanelFeatureState.shownPanelView != null;
    }
    ...
    private boolean initializePanelMenu(final AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState) {
        final Context mContext = this.mContext;
        while (true) {
            Label_0203: {
                if ((appCompatDelegateImplV7$PanelFeatureState.featureId != 0 && appCompatDelegateImplV7$PanelFeatureState.featureId != 108) || this.mDecorContentParent == null) {
                    break Label_0203;
                }
                final TypedValue typedValue = new TypedValue();
                ...
                menu.a(this);
                appCompatDelegateImplV7$PanelFeatureState.setMenu(menu);
                return true;
            }
    ...
    private void openPanel(final AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState, final KeyEvent keyEvent) {
        final int n = -1;
        if (!appCompatDelegateImplV7$PanelFeatureState.isOpen && !this.isDestroyed()) {
            if (appCompatDelegateImplV7$PanelFeatureState.featureId == 0) {
                final Context mContext = this.mContext;
                boolean b;
            ...
            final Window$Callback windowCallback = this.getWindowCallback();
            if (windowCallback != null && !windowCallback.onMenuOpened(appCompatDelegateImplV7$PanelFeatureState.featureId, (Menu)appCompatDelegateImplV7$PanelFeatureState.menu)) {
                this.closePanel(appCompatDelegateImplV7$PanelFeatureState, true);
                return;
            }
            final WindowManager windowManager = (WindowManager)this.mContext.getSystemService("window");
            if (windowManager != null && this.preparePanel(appCompatDelegateImplV7$PanelFeatureState, keyEvent)) {
                int n2 = 0;
                Label_0307: {
                    if (appCompatDelegateImplV7$PanelFeatureState.decorView == null || appCompatDelegateImplV7$PanelFeatureState.refreshDecorView) {
                        if (appCompatDelegateImplV7$PanelFeatureState.decorView == null) {
                            if (!this.initializePanelDecor(appCompatDelegateImplV7$PanelFeatureState) || appCompatDelegateImplV7$PanelFeatureState.decorView == null) {
                                return;
                            }
                        }
                        else if (appCompatDelegateImplV7$PanelFeatureState.refreshDecorView && appCompatDelegateImplV7$PanelFeatureState.decorView.getChildCount() > 0) {
                            appCompatDelegateImplV7$PanelFeatureState.decorView.removeAllViews();
                        }
                        if (!this.initializePanelContent(appCompatDelegateImplV7$PanelFeatureState) || !appCompatDelegateImplV7$PanelFeatureState.hasPanelItems()) {
                            return;
                        }
                        ViewGroup$LayoutParams layoutParams = appCompatDelegateImplV7$PanelFeatureState.shownPanelView.getLayoutParams();
                        if (layoutParams == null) {
                            layoutParams = new ViewGroup$LayoutParams(-2, -2);
                        }
                        appCompatDelegateImplV7$PanelFeatureState.decorView.setBackgroundResource(appCompatDelegateImplV7$PanelFeatureState.background);
                        final ViewParent parent = appCompatDelegateImplV7$PanelFeatureState.shownPanelView.getParent();
                        if (parent != null && parent instanceof ViewGroup) {
                            ((ViewGroup)parent).removeView(appCompatDelegateImplV7$PanelFeatureState.shownPanelView);
                        }
                        appCompatDelegateImplV7$PanelFeatureState.decorView.addView(appCompatDelegateImplV7$PanelFeatureState.shownPanelView, layoutParams);
                        if (!appCompatDelegateImplV7$PanelFeatureState.shownPanelView.hasFocus()) {
                            appCompatDelegateImplV7$PanelFeatureState.shownPanelView.requestFocus();
                        }
                        n2 = -2;
                    }
                    else {
                        if (appCompatDelegateImplV7$PanelFeatureState.createdPanelView != null) {
                            final ViewGroup$LayoutParams layoutParams2 = appCompatDelegateImplV7$PanelFeatureState.createdPanelView.getLayoutParams();
                ...
                appCompatDelegateImplV7$PanelFeatureState.isHandled = false;
                final WindowManager$LayoutParams windowManager$LayoutParams = new WindowManager$LayoutParams(n2, -2, appCompatDelegateImplV7$PanelFeatureState.x, appCompatDelegateImplV7$PanelFeatureState.y, 1002, 8519680, -3);
                windowManager$LayoutParams.gravity = appCompatDelegateImplV7$PanelFeatureState.gravity;
                windowManager$LayoutParams.windowAnimations = appCompatDelegateImplV7$PanelFeatureState.windowAnimations;
                windowManager.addView((View)appCompatDelegateImplV7$PanelFeatureState.decorView, (ViewGroup$LayoutParams)windowManager$LayoutParams);
                appCompatDelegateImplV7$PanelFeatureState.isOpen = true;
            }
        }
    }
    
    private boolean performPanelShortcut(final AppCompatDelegateImplV7$PanelFeatureState appCompatDelegateImplV7$PanelFeatureState, final int n, final KeyEvent keyEvent, final int n2) {
        ...
        if (keyEvent.isSystem()) {
            ...
            Label_0064: {
                if (!appCompatDelegateImplV7$PanelFeatureState.isPrepared) {
                    performShortcut = b;
                    if (!this.preparePanel(appCompatDelegateImplV7$PanelFeatureState, keyEvent)) {
                        break Label_0064;
                    }
                }
                performShortcut = b;
                if (appCompatDelegateImplV7$PanelFeatureState.menu != null) {
                    performShortcut = appCompatDelegateImplV7$PanelFeatureState.menu.performShortcut(n, keyEvent, n2);
                }
            }
            b3 = performShortcut;
            if (performShortcut) {
    ...
    private boolean preparePanel(final AppCompatDelegateImplV7$PanelFeatureState mPreparedPanel, final KeyEvent keyEvent) {
        if (!this.isDestroyed()) {
                ...
                if (mPreparedPanel.menu == null || mPreparedPanel.refreshMenuContent) {
                    ...
                    if (b && this.mDecorContentParent != null) {
                        if (this.mActionMenuPresenterCallback == null) {
                            this.mActionMenuPresenterCallback = new AppCompatDelegateImplV7$ActionMenuPresenterCallback(this, null);
                        }
    ...
    private void reopenMenu(final i i, final boolean b) {
        ...
        final AppCompatDelegateImplV7$PanelFeatureState panelState2 = this.getPanelState(0, true);
    ...
    public boolean onMenuItemSelected(final i i, final MenuItem menuItem) {
        final Window$Callback windowCallback = this.getWindowCallback();
        if (windowCallback != null && !this.isDestroyed()) {
            final AppCompatDelegateImplV7$PanelFeatureState menuPanel = this.findMenuPanel((Menu)i.p());
            if (menuPanel != null) {
    ...
    public ActionMode startSupportActionMode(final ActionMode$Callback actionMode$Callback) {
        ...
        final AppCompatDelegateImplV7$ActionModeCallbackWrapperV7 appCompatDelegateImplV7$ActionModeCallbackWrapperV7 = new AppCompatDelegateImplV7$ActionModeCallbackWrapperV7(this, actionMode$Callback);
        final ActionBar supportActionBar = this.getSupportActionBar();
        if (supportActionBar != null) {
            this.mActionMode = supportActionBar.startActionMode(appCompatDelegateImplV7$ActionModeCallbackWrapperV7);
            if (this.mActionMode != null && this.mAppCompatCallback != null) {
                this.mAppCompatCallback.onSupportActionModeStarted(this.mActionMode);
            }
        }
        if (this.mActionMode == null) {
            this.mActionMode = this.startSupportActionModeFromWindow(appCompatDelegateImplV7$ActionModeCallbackWrapperV7);
        }
    ...
    Label_0056:
        while (true) {
            ...
            while (true) {
                while (true) {
                    try {
                        final ActionMode onWindowStartingSupportActionMode = this.mAppCompatCallback.onWindowStartingSupportActionMode(appCompatDelegateImplV7$ActionModeCallbackWrapperV7);
                    ...
                    final StandaloneActionMode mActionMode = new StandaloneActionMode(this.mActionModeView.getContext(), this.mActionModeView, appCompatDelegateImplV7$ActionModeCallbackWrapperV7, this.mActionModePopup == null);
                    ...
                    (this.mFadeAnim = ViewCompat.animate((View)this.mActionModeView).alpha(1.0f)).setListener(new AppCompatDelegateImplV7$5(this));

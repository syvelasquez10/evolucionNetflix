...
class AppCompatDelegateImplV9$ActionModeCallbackWrapperV9 implements ActionMode$Callback
{
    ...
    public void onDestroyActionMode(final ActionMode actionMode) {
        ...
        if (this.this$0.mActionModeView != null) {
            ...
            (this.this$0.mFadeAnim = ViewCompat.animate((View)this.this$0.mActionModeView).alpha(0.0f)).setListener(new AppCompatDelegateImplV9$ActionModeCallbackWrapperV9$1(this));
        }

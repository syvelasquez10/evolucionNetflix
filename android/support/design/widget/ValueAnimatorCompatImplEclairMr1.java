...
class ValueAnimatorCompatImplEclairMr1 extends ValueAnimatorCompat$Impl
{
    ...
    ValueAnimatorCompatImplEclairMr1() {
        ...
        this.mDuration = 200;
        this.mRunnable = new ValueAnimatorCompatImplEclairMr1$1(this);
    }
    ...
    public void setListener(final ValueAnimatorCompat$Impl$AnimatorListenerProxy mListener) {
        this.mListener = mListener;
    }
    
    public void setUpdateListener(final ValueAnimatorCompat$Impl$AnimatorUpdateListenerProxy mUpdateListener) {

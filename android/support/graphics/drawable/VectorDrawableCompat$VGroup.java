...
class VectorDrawableCompat$VGroup
{
    ...
    public VectorDrawableCompat$VGroup(VectorDrawableCompat$VGroup vectorDrawableCompat$VGroup, final ArrayMap<String, Object> arrayMap) {
        this.mStackedMatrix = new Matrix();
        this.mChildren = new ArrayList<Object>();
        this.mRotate = 0.0f;
        this.mPivotX = 0.0f;
        ...
        final ArrayList<Object> mChildren = vectorDrawableCompat$VGroup.mChildren;
        for (int i = 0; i < mChildren.size(); ++i) {
            final VectorDrawableCompat$VGroup value = mChildren.get(i);
            if (value instanceof VectorDrawableCompat$VGroup) {
                vectorDrawableCompat$VGroup = value;
                this.mChildren.add(new VectorDrawableCompat$VGroup(vectorDrawableCompat$VGroup, arrayMap));
            }
            else {

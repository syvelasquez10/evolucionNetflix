    ...
    private boolean moveFocus(int key, final Rect rect) {
        ...
        switch (key) {
            ...
            case 2: {
                ...
                accessibilityNodeInfoCompat2 = FocusStrategy.findNextFocusInRelativeDirection(allNodes, ExploreByTouchHelper.SPARSE_VALUES_ADAPTER, ExploreByTouchHelper.NODE_ADAPTER, accessibilityNodeInfoCompat, key, b, false);
                break;
            }
            case 17:
            case 33:

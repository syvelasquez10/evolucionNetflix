...
public class SearchViewCompat
{
    ...
    public static void setOnCloseListener(final View view, final SearchViewCompat$OnCloseListenerCompat searchViewCompat$OnCloseListenerCompat) {
        SearchViewCompat.IMPL.setOnCloseListener(view, searchViewCompat$OnCloseListenerCompat.mListener);
    }
    
    public static void setOnQueryTextListener(final View view, final SearchViewCompat$OnQueryTextListenerCompat searchViewCompat$OnQueryTextListenerCompat) {
        SearchViewCompat.IMPL.setOnQueryTextListener(view, searchViewCompat$OnQueryTextListenerCompat.mListener);
    }

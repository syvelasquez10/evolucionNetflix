...
class MaterialProgressDrawable extends Drawable implements Animatable
{
    ...
    void applyFinishTranslation(final float n, final MaterialProgressDrawable$Ring materialProgressDrawable$Ring) {
        ...
        materialProgressDrawable$Ring.setStartTrim((materialProgressDrawable$Ring.getStartingEndTrim() - this.getMinProgressArc(materialProgressDrawable$Ring) - materialProgressDrawable$Ring.getStartingStartTrim()) * n + materialProgressDrawable$Ring.getStartingStartTrim());
    ...
    float getMinProgressArc(final MaterialProgressDrawable$Ring materialProgressDrawable$Ring) {
        return (float)Math.toRadians(materialProgressDrawable$Ring.getStrokeWidth() / (6.283185307179586 * materialProgressDrawable$Ring.getCenterRadius()));
    }
    ...
    void updateRingColor(final float n, final MaterialProgressDrawable$Ring materialProgressDrawable$Ring) {
        if (n > 0.75f) {
            materialProgressDrawable$Ring.setColor(this.evaluateColorChange((n - 0.75f) / 0.25f, materialProgressDrawable$Ring.getStartingColor(), materialProgressDrawable$Ring.getNextColor()));
        }
    }

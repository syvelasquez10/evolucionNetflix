...
interface SearchViewCompat$SearchViewCompatImpl
{
    ...
    Object newOnCloseListener(final SearchViewCompat$OnCloseListenerCompat p0);
    
    Object newOnQueryTextListener(final SearchViewCompat$OnQueryTextListenerCompat p0);

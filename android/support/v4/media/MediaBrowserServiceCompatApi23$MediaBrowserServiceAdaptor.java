...
class MediaBrowserServiceCompatApi23$MediaBrowserServiceAdaptor extends MediaBrowserServiceCompatApi21$MediaBrowserServiceAdaptor
{
    ...
    public void onLoadItem(final String s, final MediaBrowserService$Result<MediaBrowser$MediaItem> mediaBrowserService$Result) {
        ((MediaBrowserServiceCompatApi23$ServiceCompatProxy)this.mServiceProxy).onLoadItem(s, new MediaBrowserServiceCompatApi21$ResultWrapper<Parcel>(mediaBrowserService$Result));
    }
}

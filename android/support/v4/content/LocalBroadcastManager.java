                        ...
                        Label_0173: {
                            Label_0168: {
                                synchronized (this.mReceivers) {
                                    ...
                                    // iftrue(Label_0173:, (ReceiverRecord)list2.get(n4).receiver != broadcastReceiver2)
                                    // iftrue(Label_0137:, n4 >= list2.size())
                                    final String action;
                                    Block_9: {
                                        break Block_9;

...
public class CachedModelProxyTest extends TestCase
{
    private ModelProxy<?> createModelProxyWithBasicLolomos() {
        ...
        final CachedModelProxy cachedModelProxy = new CachedModelProxy<Object>(null, root);
        ...
        ((Video.Summary)((Video)branchMap2.getOrCreate("2143")).getOrCreate("summary")).title = "Dawn of the Dead";
        return cachedModelProxy;
    }
    
    public void testGetForEmptyCache() {
        final CachedModelProxy cachedModelProxy = new CachedModelProxy(null, (T)new Root());
    ...
    public void testGetValue() {
        final Root root = new Root();
        final CachedModelProxy cachedModelProxy = new CachedModelProxy(null, root);
        final Video.Summary summary = (Video.Summary)((Video)((BranchMap)root.getOrCreate("videos")).getOrCreate("23")).getOrCreate("summary");
    ...
    public void testGetValueUsingReference() {
        ...
        final Video video = (Video)branchMap.getOrCreate("23");
        final Video.Summary summary = (Video.Summary)video.getOrCreate("summary");
        summary.boxartUrl = "test_url";
        final Video.Summary summary2 = (Video.Summary)cachedModelProxy.getValue(PQL.create("videos", "23", "summary"));
        ...
        final List<Ref> list = video.getReferences().toList();

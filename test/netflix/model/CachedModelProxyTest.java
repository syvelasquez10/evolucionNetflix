...
public class CachedModelProxyTest extends TestCase
{
    ...
    static {
        nullServiceProvider = new CachedModelProxyTest$1();
    }
    ...
    public void testGetForEmptyCache() {
        ...
        set.add(create2);
        final Set<PQL> missingPqls = cachedModelProxy.get(set).missingPqls;
    ...
    public void testGetForMissingPqls() {
        ...
        final Set<PQL> missingPqls = value.missingPqls;
    ...
    public void testGetValue() {
        ...
        final Video$Summary video$Summary = (Video$Summary)((FalkorVideo)((BranchMap)root.getOrCreate("videos")).getOrCreate("23")).getOrCreate("summary");
        video$Summary.boxartUrl = "test_url";
        final Video$Summary video$Summary2 = (Video$Summary)cachedModelProxy.getValue(PQL.create("videos", "23", "summary"));
        Assert.assertEquals((Object)video$Summary, (Object)video$Summary2);
        Assert.assertEquals(video$Summary2.boxartUrl, "test_url");
    }
    ...
    public void testGetValueUsingReference() {
        ...
        final Video$Summary video$Summary = (Video$Summary)falkorVideo.getOrCreate("summary");
        video$Summary.boxartUrl = "test_url";
        final Video$Summary video$Summary2 = (Video$Summary)cachedModelProxy.getValue(PQL.create("videos", "23", "summary"));
        final Video$Summary video$Summary3 = (Video$Summary)cachedModelProxy.getValue(PQL.create("lists", "213", "0", "summary"));
        Assert.assertEquals((Object)video$Summary3, (Object)video$Summary2);
        ...
        Assert.assertEquals((Object)video$Summary, (Object)video$Summary2);
        Assert.assertEquals("test_url", video$Summary2.boxartUrl);
        Assert.assertEquals((Object)video$Summary, (Object)video$Summary3);
        Assert.assertEquals("test_url", video$Summary3.boxartUrl);
    }
    ...
    public void testGetWithRangesForMissingPqls() {
        ...
        final Set<PQL> missingPqls = modelProxyWithBasicLolomos.get(set).missingPqls;
        Assert.assertEquals(1, missingPqls.size());
        Assert.assertTrue(missingPqls.contains(PQL.create("videos", "7890", "summary")));
    }
}

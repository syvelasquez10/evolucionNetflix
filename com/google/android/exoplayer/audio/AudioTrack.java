                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                while (true) {
                                    ...
                                    string = "Spurious audio timestamp (system clock mismatch): " + timestampFramePosition + ", " + n2 + ", " + n + ", " + playbackHeadPositionUs;
                                ...
                                while (true) {
                                    final long n2;
                                    final long timestampFramePosition;
                                    string2 = "Spurious audio timestamp (frame position mismatch): " + timestampFramePosition + ", " + n2 + ", " + n + ", " + playbackHeadPositionUs;

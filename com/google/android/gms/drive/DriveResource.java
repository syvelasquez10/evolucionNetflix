...
public interface DriveResource
{
    ...
    PendingResult<DriveResource$MetadataResult> getMetadata(final GoogleApiClient p0);
    ...
    PendingResult<DriveResource$MetadataResult> updateMetadata(final GoogleApiClient p0, final MetadataChangeSet p1);
}

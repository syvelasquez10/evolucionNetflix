...
{
    boolean a(final h p0) throws RemoteException;
    ...
    {
        public static h aJ(final IBinder binder) {
            if (binder == null) {
                return null;
            }
        ...
        public boolean onTransact(int hashCodeRemote, final Parcel parcel, final Parcel parcel2, final int n) throws RemoteException {
            ...
            switch (hashCodeRemote) {
                ...
                case 8: {
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    final boolean a = this.a(aJ(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    hashCodeRemote = n3;
                    if (a) {
                        hashCodeRemote = 1;
        ...
        private static class a implements h
        {
            ...
            @Override
            public boolean a(final h h) throws RemoteException {
                boolean b = false;

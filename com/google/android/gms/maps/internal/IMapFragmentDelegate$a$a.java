...
class IMapFragmentDelegate$a$a implements IMapFragmentDelegate
{
    private IBinder lb;
    
    IMapFragmentDelegate$a$a(final IBinder lb) {
        this.lb = lb;
    }
    ...
    @Override
    public void onInflate(final d d, final GoogleMapOptions googleMapOptions, final Bundle bundle) {
        while (true) {
            final Parcel obtain = Parcel.obtain();
            final Parcel obtain2 = Parcel.obtain();
            while (true) {

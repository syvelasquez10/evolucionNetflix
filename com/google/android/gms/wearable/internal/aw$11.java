...
class aw$11 extends a
{
    ...
    public void a(final Status status) {
        Label_0034: {
            ...
            synchronized (this.avI.avF) {
                this.avI.avF.remove(this.avf);

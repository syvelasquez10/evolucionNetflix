...
class zzba<K, V> implements zzl<K, V>
{
    ...
    zzba(final int p0, final zzm$zza<K, V> p1) {
        // 
        ...
        //    15: putfield        com/google/android/gms/tagmanager/zzba.zzaQy:Landroid/util/LruCache;
        //    18: return         
        //    Signature:
        //  (ILcom/google/android/gms/tagmanager/zzm$zza<TK;TV;>;)V
        // 
    ...
    public V get(final K k) {
        return (V)this.zzaQy.get((Object)k);
    }
    
    @Override
    public void zzf(final K k, final V v) {
        this.zzaQy.put((Object)k, (Object)v);
    }
}

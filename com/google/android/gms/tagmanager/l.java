...
class l<K, V>
{
    ...
    public l() {
        ...
        //    13: putfield        com/google/android/gms/tagmanager/l.anP:Lcom/google/android/gms/tagmanager/l$a;
        //    16: return         
        // 
    ...
    public k<K, V> a(final int n, final l$a<K, V> l$a) {
        if (n <= 0) {
            throw new IllegalArgumentException("maxSize <= 0");
        }
        if (this.nN() < 12) {
            return new da<K, V>(n, l$a);
        }
        return new bb<K, V>(n, l$a);
    }

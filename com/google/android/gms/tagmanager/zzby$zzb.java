...
class zzby$zzb extends SQLiteOpenHelper
{
    final /* synthetic */ zzby zzaQS;
    private boolean zzaQT;
    private long zzaQU;
    
    zzby$zzb(final zzby zzaQS, final Context context, final String s) {
        this.zzaQS = zzaQS;
    ...
    public SQLiteDatabase getWritableDatabase() {
        if (this.zzaQT && this.zzaQU + 3600000L > this.zzaQS.zzpO.currentTimeMillis()) {

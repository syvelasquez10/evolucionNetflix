...
class cb implements at
{
    ...
    cb(final au apN, final Context context, final String bb, final int be) {
        ...
        this.apM = new db((HttpClient)new DefaultHttpClient(), this.mContext, (db.a)new a());
        this.Bd = 0L;
        this.Be = be;
    }
    ...
    class a implements db.a
    {
        ...
        public void c(final ap ap) {
            final long or = ap.or();
            if (or == 0L) {
                cb.this.c(ap.eH(), cb.this.yD.currentTimeMillis());
            }
            else if (or + 14400000L < cb.this.yD.currentTimeMillis()) {
                cb.this.y(ap.eH());

...
class cb$b extends SQLiteOpenHelper
{
    ...
    cb$b(final cb apO, final Context context, final String s) {
        this.apO = apO;
    ...
    public SQLiteDatabase getWritableDatabase() {
        if (this.Bf && this.Bg + 3600000L > this.apO.yD.currentTimeMillis()) {
            throw new SQLiteException("Database creation failed");
        }
        SQLiteDatabase writableDatabase = null;
        this.Bf = true;
        this.Bg = this.apO.yD.currentTimeMillis();
        while (true) {
            try {
                ...
                this.apO.mContext.getDatabasePath(this.apO.Bb).delete();
                continue;
            }
            break;
        }

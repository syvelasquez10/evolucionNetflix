...
public interface Quests
{
    ...
    PendingResult<Quests$AcceptQuestResult> accept(final GoogleApiClient p0, final String p1);
    
    PendingResult<Quests$ClaimMilestoneResult> claim(final GoogleApiClient p0, final String p1, final String p2);
    ...
    PendingResult<Quests$LoadQuestsResult> load(final GoogleApiClient p0, final int[] p1, final int p2, final boolean p3);
    
    PendingResult<Quests$LoadQuestsResult> loadByIds(final GoogleApiClient p0, final boolean p1, final String... p2);

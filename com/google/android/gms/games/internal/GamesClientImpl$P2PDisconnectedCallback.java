...
final class GamesClientImpl$P2PDisconnectedCallback extends d$b<RoomStatusUpdateListener>
{
    final /* synthetic */ GamesClientImpl Wr;
    private final String Xg;
    
    GamesClientImpl$P2PDisconnectedCallback(final GamesClientImpl wr, final RoomStatusUpdateListener roomStatusUpdateListener, final String xg) {
        this.Wr = wr;

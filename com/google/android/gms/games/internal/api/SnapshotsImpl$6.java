...
class SnapshotsImpl$6 extends SnapshotsImpl$OpenImpl
{
    ...
    SnapshotsImpl$6(final SnapshotsImpl za, final String zg, final String zh, final SnapshotMetadataChange ze, final SnapshotContents zi) {
        this.ZA = za;
        this.ZG = zg;
        this.ZH = zh;
        this.ZE = ze;

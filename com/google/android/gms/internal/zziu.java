...
public class zziu extends WebChromeClient
{
    ...
    public zziu(final zzip zzoL) {
        this.zzoL = zzoL;
    }
    
    private static void zza(final AlertDialog$Builder alertDialog$Builder, final String message, final JsResult jsResult) {
        alertDialog$Builder.setMessage((CharSequence)message).setPositiveButton(17039370, (DialogInterface$OnClickListener)new zziu$3(jsResult)).setNegativeButton(17039360, (DialogInterface$OnClickListener)new zziu$2(jsResult)).setOnCancelListener((DialogInterface$OnCancelListener)new zziu$1(jsResult)).create().show();
    }
    ...
    private static void zza(final Context context, final AlertDialog$Builder alertDialog$Builder, final String text, final String text2, final JsPromptResult jsPromptResult) {
        ...
        alertDialog$Builder.setView((View)view).setPositiveButton(17039370, (DialogInterface$OnClickListener)new zziu$6(jsPromptResult, editText)).setNegativeButton(17039360, (DialogInterface$OnClickListener)new zziu$5(jsPromptResult)).setOnCancelListener((DialogInterface$OnCancelListener)new zziu$4(jsPromptResult)).create().show();
    }
    ...
    public final void onCloseWindow(final WebView webView) {
        ...
        final zzd zzgQ = ((zzip)webView).zzgQ();
        if (zzgQ == null) {
    ...
    public final boolean onConsoleMessage(final ConsoleMessage consoleMessage) {
        ...
        switch (zziu$7.zzJA[consoleMessage.messageLevel().ordinal()]) {
            default: {
                zzb.zzaD(string);
                break;
            }
    ...
    public final boolean onCreateWindow(WebView webView, final boolean b, final boolean b2, final Message message) {
        ...
        webView.setWebViewClient((WebViewClient)this.zzoL.zzgS());
    ...
    public final void onGeolocationPermissionsShowPrompt(final String s, final GeolocationPermissions$Callback geolocationPermissions$Callback) {
        if (geolocationPermissions$Callback != null) {
            geolocationPermissions$Callback.invoke(s, this.zzho(), true);
        }
    }
    
    public final void onHideCustomView() {
        final zzd zzgQ = this.zzoL.zzgQ();
        if (zzgQ == null) {
    ...
    protected final void zza(final View view, final int requestedOrientation, final WebChromeClient$CustomViewCallback webChromeClient$CustomViewCallback) {
        ...
        zzgQ.zza(view, webChromeClient$CustomViewCallback);
        zzgQ.setRequestedOrientation(requestedOrientation);
    }

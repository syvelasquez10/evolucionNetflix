...
public abstract class zzji$zza extends Binder implements zzji
{
    public static zzji zzao(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzji) {
            return (zzji)queryLocalInterface;
        }
        return new zzji$zza$zza(binder);
    }
    ...
    public boolean onTransact(final int n, final Parcel parcel, final Parcel parcel2, final int n2) {
        switch (n) {
            ...
            case 1: {
                ...
                this.zza(account, parcel.readInt(), zzjh$zza.zzan(parcel.readStrongBinder()));

...
public final class zzby
{
    ...
    static {
        ...
        zzuz = zzbu.zza("gads:video_stream_cache:limit_space", 8388608);
        zzuA = zzbu.zza("gads:video_stream_exo_cache:buffer_size", 8388608);
        zzuB = zzbu.zzb("gads:video_stream_cache:limit_time_sec", 300L);
        zzuC = zzbu.zzb("gads:video_stream_cache:notify_interval_millis", 1000L);
        ...
        zzuF = zzbu.zzc("gads:video:metric_frame_hash_times", "");
        zzuG = zzbu.zzb("gads:video:metric_frame_hash_time_leniency", 500L);
        ...
        zzvn = zzbu.zzb("gads:device_info_caching_expiry_ms:expiry", 300000L);
        ...
        zzvt = zzbu.zzb("gads:network:cache_prediction_duration_s", 300L);
        zzvu = zzbu.zza("gads:mediation:dynamite_first", Boolean.valueOf(true));
        zzvv = zzbu.zzb("gads:ad_loader:timeout_ms", 60000L);
        zzvw = zzbu.zzb("gads:rendering:timeout_ms", 60000L);

...
public interface jd extends IInterface
{
    ...
    public abstract static class a extends Binder implements jd
    {
        public static jd aW(final IBinder binder) {
            if (binder == null) {
                return null;
            }
            ...
            if (queryLocalInterface != null && queryLocalInterface instanceof jd) {
                return (jd)queryLocalInterface;
            }
            return new jd.a.a(binder);
        }

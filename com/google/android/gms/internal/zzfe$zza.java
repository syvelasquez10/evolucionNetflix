...
public abstract class zzfe$zza extends Binder implements zzfe
{
    public zzfe$zza() {
        this.attachInterface((IInterface)this, "com.google.android.gms.ads.internal.overlay.client.IAdOverlay");
    }
    
    public static zzfe zzK(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzfe) {
            return (zzfe)queryLocalInterface;
        }
        return new zzfe$zza$zza(binder);
    }

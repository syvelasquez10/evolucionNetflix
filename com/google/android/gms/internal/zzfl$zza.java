...
public abstract class zzfl$zza extends Binder implements zzfl
{
    public static zzfl zzN(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzfl) {
            return (zzfl)queryLocalInterface;
        }
        return new zzfl$zza$zza(binder);
    }

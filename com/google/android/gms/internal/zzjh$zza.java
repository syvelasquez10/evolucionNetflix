...
public abstract class zzjh$zza extends Binder implements zzjh
{
    public static zzjh zzan(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzjh) {
            return (zzjh)queryLocalInterface;
        }
        return new zzjh$zza$zza(binder);
    }

...
public abstract class zzeo$zza extends Binder implements zzeo
{
    public static zzeo zzG(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzeo) {
            return (zzeo)queryLocalInterface;
        }
        return new zzeo$zza$zza(binder);
    }
    ...
    public boolean onTransact(final int n, final Parcel parcel, final Parcel parcel2, final int n2) {
        switch (n) {
            ...
            case 7: {
                parcel.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                this.zza(zzep$zza.zzH(parcel.readStrongBinder()));
                parcel2.writeNoException();
                return true;
            }
        }

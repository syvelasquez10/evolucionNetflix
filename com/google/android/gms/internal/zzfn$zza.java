...
public abstract class zzfn$zza extends Binder implements zzfn
{
    ...
    public static zzfn zzP(final IBinder binder) {
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzfn) {
            return (zzfn)queryLocalInterface;
        }
        return new zzfn$zza$zza(binder);
    }

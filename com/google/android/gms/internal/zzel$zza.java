...
public abstract class zzel$zza extends Binder implements zzel
{
    public static zzel zzI(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzel) {
            return (zzel)queryLocalInterface;
        }
        return new zzel$zza$zza(binder);
    }
    ...
    public boolean onTransact(int n, final Parcel parcel, final Parcel parcel2, final int n2) {
        ...
        switch (n) {
            ...
            case 5: {
                parcel.enforceInterface("com.google.android.gms.ads.internal.mediation.client.INativeContentAdMapper");
                final zzcj zzdw = this.zzdw();
                parcel2.writeNoException();
                IBinder binder;
                if (zzdw != null) {
                    binder = zzdw.asBinder();
                }
                else {
                    binder = null;
                }

...
public final class cf$a implements GooglePlayServicesClient$ConnectionCallbacks, GooglePlayServicesClient$OnConnectionFailedListener
{
    private final Object mw;
    private final cf$b pN;
    private final cg pO;
    
    public cf$a(final Context context, final cf$b cf$b) {
        this(context, cf$b, false);
    }
    
    cf$a(final Context context, final cf$b pn, final boolean b) {
        this.mw = new Object();
        this.pN = pn;

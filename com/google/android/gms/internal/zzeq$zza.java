...
public abstract class zzeq$zza extends Binder implements zzeq
{
    public static zzeq zzI(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzeq) {
            return (zzeq)queryLocalInterface;
        }
        return new zzeq$zza$zza(binder);
    }

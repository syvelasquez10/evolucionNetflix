...
class zzof$zza extends ThreadPoolExecutor
{
    final /* synthetic */ zzof zzaIj;
    
    public zzof$zza(final zzof zzaIj) {
        this.zzaIj = zzaIj;
        super(1, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>());
        this.setThreadFactory(new zzof$zzb(null));
    }
    
    @Override
    protected <T> RunnableFuture<T> newTaskFor(final Runnable p0, final T p1) {
        // 

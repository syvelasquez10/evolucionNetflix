...
public class go
{
    public static final go$a<Void> wy;
    
    static {
        wy = new go$1();
    }
    
    public <T> Future<T> a(final String p0, final go$a<T> p1) {
        // 
        ...
        //    10: invokestatic    com/google/android/gms/internal/gi.submit:(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
        //    13: areturn        
        //    Signature:
        //  <T:Ljava/lang/Object;>(Ljava/lang/String;Lcom/google/android/gms/internal/go$a<TT;>;)Ljava/util/concurrent/Future<TT;>;
        // 

...
public abstract class zzfo$zza extends Binder implements zzfo
{
    public static zzfo zzQ(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof zzfo) {
            return (zzfo)queryLocalInterface;
        }
        return new zzfo$zza$zza(binder);
    }

...
{
    public fs(final Context context) {
        this(context, null);
    }
    
    public fs(final Context context, final AttributeSet set) {
    ...
    public void a(final Resources resources, final int n, final int n2) {
        ...
        fq.a(n >= 0 && n < 3, (Object)("Unknown button size " + n));
        fq.a(n2 >= 0 && n2 < 2 && b, (Object)("Unknown color scheme " + n2));
        this.c(resources);

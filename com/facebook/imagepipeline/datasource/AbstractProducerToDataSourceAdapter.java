...
public abstract class AbstractProducerToDataSourceAdapter<T> extends AbstractDataSource<T>
{
    ...
    protected AbstractProducerToDataSourceAdapter(final Producer<T> producer, final SettableProducerContext mSettableProducerContext, final RequestListener mRequestListener) {
        this.mSettableProducerContext = mSettableProducerContext;
        (this.mRequestListener = mRequestListener).onRequestStart(mSettableProducerContext.getImageRequest(), this.mSettableProducerContext.getCallerContext(), this.mSettableProducerContext.getId(), this.mSettableProducerContext.isPrefetch());
        producer.produceResults(this.createConsumer(), mSettableProducerContext);
    }
    ...
    private Consumer<T> createConsumer() {
        ...
        //     8: areturn        
        //    Signature:
        //  ()Lcom/facebook/imagepipeline/producers/Consumer<TT;>;
        // 
    ...
    private void onFailureImpl(final Throwable failure) {
        if (super.setFailure(failure)) {
            this.mRequestListener.onRequestFailure(this.mSettableProducerContext.getImageRequest(), this.mSettableProducerContext.getId(), failure, this.mSettableProducerContext.isPrefetch());
        }
    }
    ...
    protected void onNewResultImpl(final T t, final boolean b) {
        if (super.setResult(t, b) && b) {

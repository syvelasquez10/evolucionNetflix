...
public class LocalResourceFetchProducer extends LocalFetchProducer
{
    ...
    public LocalResourceFetchProducer(final Executor executor, final PooledByteBufferFactory pooledByteBufferFactory, final Resources mResources, final boolean b) {
    ...
    private int getLength(final ImageRequest p0) {
        ...
        // 
        //     0: aload_0        
        //     1: getfield        com/facebook/imagepipeline/producers/LocalResourceFetchProducer.mResources:Landroid/content/res/Resources;
        //     4: aload_1        
        //     5: invokestatic    com/facebook/imagepipeline/producers/LocalResourceFetchProducer.getResourceId:(Lcom/facebook/imagepipeline/request/ImageRequest;)I
        //     8: invokevirtual   android/content/res/Resources.openRawResourceFd:(I)Landroid/content/res/AssetFileDescriptor;
        //    11: astore_1       
        //    12: aload_1        
        ...
        //  -----  -----  -----  -----  -------------------------------------------------
        //  0      12     36     39     Landroid/content/res/Resources$NotFoundException;
        //  0      12     54     58     Any
        //  12     18     81     86     Landroid/content/res/Resources$NotFoundException;
        //  12     18     76     81     Any
    ...
    protected EncodedImage getEncodedImage(final ImageRequest imageRequest) {
        return this.getEncodedImage(this.mResources.openRawResource(getResourceId(imageRequest)), this.getLength(imageRequest));
    }

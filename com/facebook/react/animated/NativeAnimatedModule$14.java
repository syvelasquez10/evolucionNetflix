...
class NativeAnimatedModule$14 implements NativeAnimatedModule$UIThreadOperation
{
    ...
    NativeAnimatedModule$14(final NativeAnimatedModule this$0, final int val$parentNodeTag, final int val$childNodeTag) {
        this.this$0 = this$0;
    ...
    public void execute(final NativeAnimatedNodesManager nativeAnimatedNodesManager) {
        nativeAnimatedNodesManager.disconnectAnimatedNodes(this.val$parentNodeTag, this.val$childNodeTag);
    }
}

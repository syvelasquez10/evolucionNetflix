...
public class FirstAvailableDataSourceSupplier<T> implements Supplier<DataSource<T>>
{
    ...
    private FirstAvailableDataSourceSupplier(final List<Supplier<DataSource<T>>> mDataSourceSuppliers) {
    ...
    public static <T> FirstAvailableDataSourceSupplier<T> create(final List<Supplier<DataSource<T>>> list) {
        return new FirstAvailableDataSourceSupplier<T>(list);
    }
    
    @Override
    public boolean equals(final Object o) {
        return o == this || (o instanceof FirstAvailableDataSourceSupplier && Objects.equal(this.mDataSourceSuppliers, ((FirstAvailableDataSourceSupplier)o).mDataSourceSuppliers));
    }

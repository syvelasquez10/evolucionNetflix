...
class WhistleEngine$7 implements Runnable
{
    final /* synthetic */ WhistleEngine this$0;
    final /* synthetic */ int val$line;
    
    WhistleEngine$7(final WhistleEngine this$0, final int val$line) {
        this.this$0 = this$0;
    ...
    public void run() {
        if (this.this$0.eventListener != null) {
            this.this$0.eventListener.callEnded(this.val$line);
        }
    }
}

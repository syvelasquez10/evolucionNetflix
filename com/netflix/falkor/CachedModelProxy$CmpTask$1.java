...
class CachedModelProxy$CmpTask$1 extends FalkorVolleyWebClientRequest<Void>
{
    ...
    protected Void parseFalkorResponse(final String s) {
        ...
        if (this.this$1.shouldCustomHandleResponse()) {
            ...
            CachedModelProxy.sLastWriteTimeMS = SystemClock.elapsedRealtime();
            if (Log.isLoggable()) {
                Log.v("CachedModelProxy", "parseFalkorResponse: current merge time - " + CachedModelProxy.sLastWriteTimeMS);
            }

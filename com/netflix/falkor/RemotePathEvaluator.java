            ...
            while (true) {
                Label_0248: {
                    ...
                    try {
                        ...
                        final Class<?> clazz3 = null;
                        final Method method = ((Class<?>)rootType).getMethod("get" + string.substring(0, 1).toUpperCase() + string.substring(1), (Class<?>[])new Class[0]);

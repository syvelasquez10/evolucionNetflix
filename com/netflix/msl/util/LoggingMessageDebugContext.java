...
public class LoggingMessageDebugContext implements MessageDebugContext
{
    ...
    private final LoggingMessageDebugContext$HeaderOutput headerOutput;
    
    public LoggingMessageDebugContext(final LoggingMessageDebugContext$HeaderOutput headerOutput) {
    ...
    private void errorHeader(final String s, final ErrorHeader errorHeader) {
        ...
        this.headerOutput.header(String.format("MSL Error Header %s:\n%s", s, marshalErrorHeaderAsJson.toString(4)));
    }
    ...
    private void logHeader(final String s, final Header header) {
        try {
            ...
            this.headerOutput.error("Unable to marshal header in " + s, ex);
            return;
        }
        this.headerOutput.error("Unknown Header type " + header.getClass().toString() + " during " + s);
    }
    ...
    private void marshalEntityAuth(final JSONObject jsonObject, final EntityAuthenticationData entityAuthenticationData) {
        ...
        try {
            ...
            jsonObject.put("entityauthdata", entityAuthenticationData);
        }
    ...
    private JSONObject marshalHeaderAsJson(final MessageHeader messageHeader) {
        ...
        if (userAuthenticationData != null) {
            jsonObject.put("userauthdata", new JSONObject(userAuthenticationData.toJSONString()));
        }
        ...
        for (final ServiceToken serviceToken : serviceTokens) {
            ...
            jsonObject4.put("data", new String(serviceToken.getData(), Charset.forName("UTF-8")));
    ...
    private void messageHeader(final String s, final MessageHeader messageHeader) {
        ...
        this.headerOutput.header(String.format("MSL Message Header %s:\n%s", s, marshalHeaderAsJson.toString(4)));
    }

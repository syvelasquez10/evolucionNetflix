...
class ViewDetailsActionHandler extends BaseNflxHandler
{
    ...
    protected NflxHandler$Response handleEpisodeFromTinyUrl(final String s, final String s2, final String s3) {
        DetailsActivityLauncher.show(this.mActivity, VideoType.SHOW, s, "", NflxProtocolUtils.getPlayContext(s3), this.getAction(), this.getActionToken());
        return NflxHandler$Response.HANDLING;
    }
    
    @Override
    protected NflxHandler$Response handleMovieFromTinyUrl(final String s, final String s2, final String s3) {
        DetailsActivityLauncher.show(this.mActivity, VideoType.MOVIE, s, "", NflxProtocolUtils.getPlayContext(s3), this.getAction(), this.getActionToken());
        return NflxHandler$Response.HANDLING;
    }
}

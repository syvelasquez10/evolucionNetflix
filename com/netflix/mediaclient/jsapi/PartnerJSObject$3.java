...
class PartnerJSObject$3 implements Runnable
{
    ...
    PartnerJSObject$3(final PartnerJSObject this$0, final String val$service, final int val$idx, final String val$userId) {
        this.this$0 = this$0;
        ...
        while (true) {
            if (partner == null) {
                try {
                    ...
                    this.this$0.returnResultToJS("nrdpPartner.Signup._handleExternalUserData", getErrorForPartner(null, this.val$idx, this.val$service, "101", "Service not found!"));
                    return;
                    // iftrue(Label_0132:, partner.getSignup() != null)
                    Log.e("nf_partner", "Service does not support SSO!");
                    this.this$0.returnResultToJS("nrdpPartner.Signup._handleExternalUserData", getErrorForPartner(this.val$userId, this.val$idx, this.val$service, "102", "Service does not support Signup!"));
                    return;
                }
                catch (Exception ex) {
                ...
                Label_0132: {
                    partner.getSignup().getExternalUserData(this.val$service, this.val$userId, this.val$idx, new PartnerJSObject$3$1(this));
                }
                return;
            }
            continue;

...
class PartnerJSObject$4$1 implements ResponseListener
{
    final /* synthetic */ PartnerJSObject$4 this$1;
    
    PartnerJSObject$4$1(final PartnerJSObject$4 this$1) {
        this.this$1 = this$1;
    }
    ...
    public void onResponseReceived(final Response response) {
        try {
            this.this$1.this$0.returnResultToJS("nrdpPartner.Signup._handleExternalUserConfirmation", response.toJson());
        }
        catch (Exception ex) {

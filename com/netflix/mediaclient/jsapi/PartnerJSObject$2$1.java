...
class PartnerJSObject$2$1 implements ResponseListener
{
    final /* synthetic */ PartnerJSObject$2 this$1;
    
    PartnerJSObject$2$1(final PartnerJSObject$2 this$1) {
        this.this$1 = this$1;
    }
    ...
    public void onResponseReceived(final Response response) {
        try {
            this.this$1.this$0.returnResultToJS("nrdpPartner.Sso._handleExternalUserAuth", response.toJson());
        }
        catch (Exception ex) {

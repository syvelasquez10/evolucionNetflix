...
class PartnerJSObject$3$1 implements ResponseListener
{
    final /* synthetic */ PartnerJSObject$3 this$1;
    
    PartnerJSObject$3$1(final PartnerJSObject$3 this$1) {
        this.this$1 = this$1;
    }
    ...
    public void onResponseReceived(final Response response) {
        try {
            this.this$1.this$0.returnResultToJS("nrdpPartner.Signup._handleExternalUserData", response.toJson());
        }
        catch (Exception ex) {

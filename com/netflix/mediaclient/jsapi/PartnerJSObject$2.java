...
class PartnerJSObject$2 implements Runnable
{
    final /* synthetic */ PartnerJSObject this$0;
    final /* synthetic */ int val$idx;
    final /* synthetic */ String val$service;
    
    PartnerJSObject$2(final PartnerJSObject this$0, final String val$service, final int val$idx) {
        this.this$0 = this$0;
        ...
        while (true) {
            if (partner == null) {
                try {
                    ...
                    this.this$0.returnResultToJS("nrdpPartner.Sso._handleExternalUserAuth", getErrorForPartner(null, this.val$idx, this.val$service, "101", "Service not found!"));
                    return;
                    while (true) {
                        Log.e("nf_partner", "Service does not support SSO!");
                        this.this$0.returnResultToJS("nrdpPartner.Sso._handleExternalUserAuth", getErrorForPartner(null, this.val$idx, this.val$service, "102", "Service does not support SSO!"));
                        return;
                        continue;
                    }
                }
                ...
                Label_0129: {
                    partner.getSSO().requestExternalUserAuth(this.val$service, this.val$idx, new PartnerJSObject$2$1(this));
                }
                return;
            }
            continue;

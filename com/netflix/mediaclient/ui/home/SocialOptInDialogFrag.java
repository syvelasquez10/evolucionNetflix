...
public class SocialOptInDialogFrag extends NetflixDialogFrag
{
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        return (Dialog)new AlertDialog$Builder((Context)this.getActivity(), 2131558719).setTitle(2131493256).setMessage(2131493257).setPositiveButton(2131493259, (DialogInterface$OnClickListener)new SocialOptInDialogFrag$2(this, socialOptInDialogFrag$OptInResponseHandler)).setNegativeButton(2131493258, (DialogInterface$OnClickListener)new SocialOptInDialogFrag$1(this, socialOptInDialogFrag$OptInResponseHandler)).create();
    }
}

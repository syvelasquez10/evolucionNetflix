...
class OldSlidingMenu$GenresListAdapter extends BaseAdapter
{
    private final List<GenreList> genres;
    final /* synthetic */ OldSlidingMenu this$0;
    
    public OldSlidingMenu$GenresListAdapter(final OldSlidingMenu this$0, final List<GenreList> genres) {
        this.this$0 = this$0;
        this.genres = genres;
    }
    ...
    public View getView(final int n, final View view, final ViewGroup viewGroup) {
        View inflate = view;
        if (view == null) {
            inflate = this.this$0.activity.getLayoutInflater().inflate(2130903152, (ViewGroup)null);
            inflate.setTag((Object)new OldSlidingMenu$Holder((TextView)inflate.findViewById(2131427686), inflate.findViewById(2131427687)));
        }
        ...
        this.this$0.updateAdapterViews(oldSlidingMenu$Holder, item);

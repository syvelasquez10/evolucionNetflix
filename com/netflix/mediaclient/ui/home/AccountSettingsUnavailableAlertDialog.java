...
public class AccountSettingsUnavailableAlertDialog extends NetflixDialogFrag
{
    protected static AccountSettingsUnavailableAlertDialog createAccountSettingsUnavailableAlertDialog(final NetflixActivity netflixActivity) {
        ...
        accountSettingsUnavailableAlertDialog.setStyle(1, 2131361924);
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        alertDialog$Builder.setPositiveButton(2131165543, (DialogInterface$OnClickListener)new AccountSettingsUnavailableAlertDialog$1(this));
        alertDialog$Builder.setMessage((CharSequence)this.getString(2131165706));

...
public class AccountSettingsUnavailableAlertDialog extends NetflixDialogFrag
{
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        alertDialog$Builder.setPositiveButton(2131165568, (DialogInterface$OnClickListener)new AccountSettingsUnavailableAlertDialog$1(this));
        alertDialog$Builder.setMessage((CharSequence)this.getString(2131165362));

...
class HomeActivity$4 implements DrawerLayout$DrawerListener
{
    ...
    public void onDrawerOpened(View view) {
        ...
        if (this.this$0.notificationsListStatus == IrisUtils$NotificationsListStatus.HAS_UNREAD_MESSAGES) {
            ...
            this.this$0.readRunnable = new HomeActivity$4$1(this);
            ...
            while (true) {
                ...
                while (true) {
                    try {
                        ...
                        Log.w("HomeActivity", "setupViews() Got exception", ex);
                        continue;
                    }
                    break;
                }

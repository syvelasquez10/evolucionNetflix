...
public class NotificationsFrag extends NetflixFrag
{
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        final View inflate = layoutInflater.inflate(2130903274, viewGroup, false);
        (this.mNotificationsList = (StaticListView)inflate.findViewById(2131690272)).setItemsCanFocus(true);

...
public class NotificationsFrag extends NetflixFrag
{
    ...
    private JSONObject getModelObject(final IrisNotificationSummary irisNotificationSummary, final int n) {
        ...
        try {
            ...
            Log.w(NotificationsFrag.TAG, "getModelObject() got an exception", ex);
            return jsonObject;
        }
    }
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        (this.mNotificationsList = (StaticListView)inflate.findViewById(2131690318)).setItemsCanFocus(true);

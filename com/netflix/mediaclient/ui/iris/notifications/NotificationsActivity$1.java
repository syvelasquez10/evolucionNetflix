...
class NotificationsActivity$1 implements ManagerStatusListener
{
    final /* synthetic */ NotificationsActivity this$0;
    
    NotificationsActivity$1(final NotificationsActivity this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void onManagerReady(final ServiceManager serviceManager, final Status status) {
        Log.d(NotificationsActivity.TAG, "Manager is here!");
    ...
    public void onManagerUnavailable(final ServiceManager serviceManager, final Status status) {
        Log.d(NotificationsActivity.TAG, "Manager isn't available!");

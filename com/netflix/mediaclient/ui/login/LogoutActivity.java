...
public class LogoutActivity extends AccountActivity
{
    ...
    private void handleLogoutComplete() {
        ...
        Toast.makeText(this.getApplicationContext(), 2131493187, 1).show();
    ...
    public static void showLogoutDialog(final Activity activity) {
        new AlertDialog$Builder((Context)activity).setMessage(2131493185).setNegativeButton(2131493101, (DialogInterface$OnClickListener)null).setPositiveButton(2131493157, (DialogInterface$OnClickListener)new LogoutActivity$1(activity)).show();
    }

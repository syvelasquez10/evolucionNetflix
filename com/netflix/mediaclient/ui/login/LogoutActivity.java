...
public class LogoutActivity extends AccountActivity
{
    ...
    private void handleLogoutComplete() {
        ...
        Toast.makeText(this.getApplicationContext(), 2131493210, 1).show();
    ...
    public static void showLogoutDialog(final Activity activity) {
        new AlertDialog$Builder((Context)activity).setMessage(2131493208).setNegativeButton(2131493123, (DialogInterface$OnClickListener)null).setPositiveButton(2131493180, (DialogInterface$OnClickListener)new LogoutActivity$1(activity)).show();
    }

...
public class EmailPasswordFragment extends LoginBaseFragment implements GoogleApiClient$ConnectionCallbacks, GoogleApiClient$OnConnectionFailedListener
{
    ...
    private void attemptLogin() {
        ...
        if (this.passwordIsInvalid(this.getServiceManager(), string2)) {
            final String string3 = this.getString(2131296528);
        ...
        if (this.emailIsInvalid(this.getServiceManager(), string)) {
            final String string4 = this.getString(2131296527);
        ...
        this.mStatusMessageView.setText(2131296847);
    ...
    private void handleLoginComplete(final com.netflix.mediaclient.android.app.Status status) {
        ...
        if (status.isSucces() || status.getStatusCode() == StatusCode.NRD_REGISTRATION_EXISTS) {
            SignInLogUtils.reportSignInRequestSessionEnded((Context)this.getNetflixActivity(), SignInLogging$SignInType.emailPassword, IClientLogging$CompletionReason.success, (Error)null);
            this.getNetflixActivity().showDebugToast(this.getString(2131296791));
    ...
    private String handleUserAgentErrors(final com.netflix.mediaclient.android.app.Status status) {
        ...
        if (statusCode == StatusCode.NRD_LOGIN_ACTIONID_4 || statusCode == StatusCode.NRD_LOGIN_ACTIONID_8 || statusCode == StatusCode.USER_SIGNIN_RETRY) {
            final String string = this.getString(2131296670);
        ...
        if (statusCode == StatusCode.NRD_LOGIN_ACTIONID_2) {
            final String string2 = this.getString(2131296844) + " (" + statusCode.getValue() + ")";
        ...
        if (statusCode == StatusCode.NETWORK_ERROR) {
            final String string3 = this.getString(2131296846) + " (" + statusCode.getValue() + ")";
    ...
    private void noConnectivityWarning() {
        if (AndroidUtils.isActivityFinishedOrDestroyed((Context)this.getActivity())) {
            return;
        }
    ...
    private void onForgotPassword() {
        ...
        this.getNetflixActivity().displayServiceAgentDialog(this.getString(2131296836, new Object[] { "https://signup.netflix.com/loginhelp" }), null, false);
    }
    ...
    private void reportCancel(final String s) {
        ...
        UserActionLogUtils.reportNavigationActionStarted((Context)this.getNetflixActivity(), (UserActionLogging$CommandName)null, this.getNetflixActivity().getUiScreen());
    }
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        final View inflate = layoutInflater.inflate(2130903185, viewGroup, false);
    ...
    protected void setupViews(final View view) {
        ...
        (this.mEmailEditText = (EditText)view.findViewById(2131755497)).requestFocus();
        this.mPasswordEditText = (EditText)view.findViewById(2131755498);
        this.mLoginForm = view.findViewById(2131755495);
        this.mLoginButton = view.findViewById(2131755493);
        this.mStatusGroup = view.findViewById(2131755334);
        this.mStatusMessageView = (TextView)view.findViewById(2131755496);
        ...
        view.findViewById(2131755493).setOnClickListener((View$OnClickListener)new EmailPasswordFragment$3(this));
        view.findViewById(2131755494).setOnClickListener((View$OnClickListener)new EmailPasswordFragment$4(this));
    }
}

...
public class KongBattleIntroScreen extends KongBaseScreen
{
    ...
    void initViews(final View view) {
        if (view == null) {
            ...
            this.battleIntroContainer = (ViewGroup)view.findViewById(2131624459);
            this.nextEpisodeContainer = (ViewGroup)view.findViewById(2131624455);
            final NetflixActivity activity = this.postPlayManager.getActivity();
            this.battleCardWidth = activity.getResources().getDimensionPixelSize(2131296355);
            ...
            if (this.nextEpisodeVideoId > 0) {
                this.backButtonWidth = activity.getResources().getDimensionPixelSize(2131296368);
                this.battleEpisodeSpacing = activity.getResources().getDimensionPixelSize(2131296354);
            ...
            if (this.battleIntroContainer != null) {
                this.battleTitle = (TextView)this.battleIntroContainer.findViewById(2131624462);
                this.battleCountdownTimer = (TextView)this.battleIntroContainer.findViewById(2131624463);
                this.battleIntroCompoundView = (PressAnimationFrameLayout)this.battleIntroContainer.findViewById(2131624460);
                this.battleIntroPlaceholderView = this.battleIntroContainer.findViewById(2131624461);
                this.battleIntroPlaceholderView.getLayoutParams().height = (int)this.battleCardHeight;
                if (this.battleIntroCompoundView != null) {
                    this.leftGate = (ImageView)this.battleIntroCompoundView.findViewById(2131624268);
                    this.rightGate = (ImageView)this.battleIntroCompoundView.findViewById(2131624267);
                    this.versusHex = (ImageView)this.battleIntroCompoundView.findViewById(2131624271);
                    this.versusHexSword = (ImageView)this.battleIntroCompoundView.findViewById(2131624272);
                    this.kongAvatar = (ImageView)this.battleIntroCompoundView.findViewById(2131624270);
                    this.opponentAvatar = (ImageView)this.battleIntroCompoundView.findViewById(2131624269);
                    this.leftGateWidth = DeviceUtils.getScreenWidthInPixels((Context)activity);
                    this.rightGateWidth = this.leftGateWidth;
                    this.battleCard = (ImageView)this.battleIntroCompoundView.findViewById(2131624273);
                    this.battleCardComposite = this.battleIntroCompoundView.findViewById(2131624265);
            ...
            if (this.nextEpisodeContainer != null) {
                this.nextEpisode = (AdvancedImageView)this.nextEpisodeContainer.findViewById(2131624456);
                ...
                this.nextEpisodeTitle = (TextView)this.nextEpisodeContainer.findViewById(2131624457);
                this.nextEpisodeCountdownTimer = (TextView)this.nextEpisodeContainer.findViewById(2131624458);

...
public class KongPowerUpScreen extends KongBaseScreen
{
    ...
    boolean startAnimation() {
        ...
        final int dimensionPixelSize = this.getActivity().getResources().getDimensionPixelSize(2131427482);
        ...
        final float n3 = DeviceUtils.getScreenHeightInPixels((Context)this.getActivity()) / this.getActivity().getResources().getDimension(2131427464) * 0.9f;

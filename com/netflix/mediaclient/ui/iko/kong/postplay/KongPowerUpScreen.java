...
public class KongPowerUpScreen extends KongBaseScreen
{
    ...
    void initViews(final View view) {
        ...
        this.powerUpContainer = (ViewGroup)this.powerUpViewsContainer.findViewById(2131690069);
        this.powerUpParams = new FrameLayout$LayoutParams(-2, this.context.getResources().getDimensionPixelSize(2131361922), 17);
        this.powerUpTitleView = (TextView)this.powerUpViewsContainer.findViewById(2131690068);
    ...
    boolean startAnimation() {
        ...
        final int dimensionPixelSize = this.getActivity().getResources().getDimensionPixelSize(2131361940);
        ...
        final float n3 = DeviceUtils.getScreenHeightInPixels((Context)this.getActivity()) / this.getActivity().getResources().getDimension(2131361922) * 0.9f;

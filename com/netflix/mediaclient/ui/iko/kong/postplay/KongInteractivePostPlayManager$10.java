...
class KongInteractivePostPlayManager$10 implements Runnable
{
    final /* synthetic */ KongInteractivePostPlayManager this$0;
    
    KongInteractivePostPlayManager$10(final KongInteractivePostPlayManager this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        if (this.this$0.areResourcesSuccessfullyLoaded()) {
            AsyncTaskCompat.execute(new KongInteractivePostPlayManager$10$1(this));
            return;
        }

...
class KongInteractivePostPlayManager$4 implements Runnable
{
    final /* synthetic */ KongInteractivePostPlayManager this$0;
    
    KongInteractivePostPlayManager$4(final KongInteractivePostPlayManager this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        if (this.this$0.soundPoolManager == null) {
            Log.d("KongInteractivePostPlayManager", "Sound pool manager is null. Cannot verify the readiness.");
            return;
        }
        if (this.this$0.soundPoolManager.isReady()) {
            this.this$0.onResourcesLoaded();
            return;
        }
        this.this$0.handler.postDelayed((Runnable)this, 1000L);
    }
}

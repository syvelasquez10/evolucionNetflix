...
public class KongBackgroundScreen extends KongBaseScreen
{
    ...
    void initViews(final View view) {
        this.background = (ImageView)view.findViewById(2131624452);
        this.backgroundPattern = (ImageView)view.findViewById(2131624453);
        this.background.setOnTouchListener((View$OnTouchListener)new KongBackgroundScreen$1(this, view));
        this.title = (TextView)view.findViewById(2131624274);
        this.titleContainer = (ViewGroup)view.findViewById(2131624473);
        this.titleFlare = (ImageView)view.findViewById(2131624275);
        this.progress = (ProgressBar)view.findViewById(2131624474);
        this.closeButton = (ImageView)view.findViewById(2131624467);
        (this.backButton = (ImageView)view.findViewById(2131624466)).setOnClickListener((View$OnClickListener)new KongBackgroundScreen$2(this));
    }

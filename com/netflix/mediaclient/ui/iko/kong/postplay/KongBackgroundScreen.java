...
public class KongBackgroundScreen extends KongBaseScreen
{
    ...
    void initViews(final View view) {
        this.background = (ImageView)view.findViewById(2131821219);
        this.backgroundPattern = (ImageView)view.findViewById(2131821220);
        this.background.setOnTouchListener((View$OnTouchListener)new KongBackgroundScreen$1(this, view));
        this.title = (TextView)view.findViewById(2131821057);
        this.titleContainer = (ViewGroup)view.findViewById(2131821238);
        this.titleFlare = (ImageView)view.findViewById(2131821058);
        this.progress = (ProgressBar)view.findViewById(2131821239);
        this.closeButton = (ImageView)view.findViewById(2131821204);
        (this.backButton = (ImageView)view.findViewById(2131820961)).setOnClickListener((View$OnClickListener)new KongBackgroundScreen$2(this));
    }

...
public class KongInteractiveMomentsManager implements InteractiveMomentsManager
{
    ...
    public void init(final PlayerFragment mFragment) {
        ...
        this.imageContainer = (ViewGroup)view.findViewById(2131689878);
        ...
        this.imageBackground = (ImageView)view.findViewById(2131689880);
        this.image = (ImageView)view.findViewById(2131689570);
        this.title = (TextView)view.findViewById(2131689574);
        this.mBottomPanelHeight = this.mFragment.getResources().getDimensionPixelSize(2131361931);

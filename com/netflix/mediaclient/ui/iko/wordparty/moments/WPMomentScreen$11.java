...
class WPMomentScreen$11 implements ValueAnimator$AnimatorUpdateListener
{
    ...
    WPMomentScreen$11(final WPMomentScreen this$0, final boolean val$open, final View val$panelView, final int val$color, final int val$cardIndex, final int val$size, final ObjectAnimator val$cardAnimator) {
        this.this$0 = this$0;

...
class WPInteractiveMomentsManager$8 implements Runnable
{
    final /* synthetic */ WPInteractiveMomentsManager this$0;
    
    WPInteractiveMomentsManager$8(final WPInteractiveMomentsManager this$0) {
        this.this$0 = this$0;
    }
    ...
    public void run() {
        if (Log.isLoggable()) {
            Log.d("WPInteractiveMomentsManager", "clearPanel: bottomPanelVisible = " + this.this$0.bottomPanelVisible);
        }
        if (!this.this$0.isActivityInvalid()) {
            this.this$0.fragment.stopScreenUpdateTask();
            if (this.this$0.fragment.getScreen() != null) {
                this.this$0.fragment.getScreen().hideTopBottomPanel();
            }
        }
    }
}

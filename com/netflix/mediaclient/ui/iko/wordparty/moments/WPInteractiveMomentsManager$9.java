...
class WPInteractiveMomentsManager$9 implements Runnable
{
    final /* synthetic */ WPInteractiveMomentsManager this$0;
    
    WPInteractiveMomentsManager$9(final WPInteractiveMomentsManager this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        final WPInteractiveMomentsModel$WPMoment access$1500 = this.this$0.currentInteractiveMoment;
        if (access$1500 == null) {
            return;
        }
        if (Log.isLoggable()) {
            Log.d("WPInteractiveMomentsManager", "loadMomentScreenResources: configuring card resources in bg thread");
        }
        this.this$0.momentScreen.configureCards(access$1500);
    }
}

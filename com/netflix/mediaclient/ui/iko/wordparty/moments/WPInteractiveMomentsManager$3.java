...
class WPInteractiveMomentsManager$3 implements Runnable
{
    final /* synthetic */ WPInteractiveMomentsManager this$0;
    
    WPInteractiveMomentsManager$3(final WPInteractiveMomentsManager this$0) {
        this.this$0 = this$0;
    }
    ...
    public void run() {
        if (Log.isLoggable()) {
            Log.d("WPInteractiveMomentsManager", "loadPugResourcesBg: loading in background");
        }

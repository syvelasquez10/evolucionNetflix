...
public class WPStandardCardLayout extends WPCardLayout
{
    ...
    protected void storeViews(final Context context) {
        ...
        this.cardWidth = resources.getDimensionPixelSize(2131361948);
        this.cardHeight = resources.getDimensionPixelSize(2131361946);
        final FrameLayout$LayoutParams frameLayout$LayoutParams = new FrameLayout$LayoutParams(this.cardWidth + 2, resources.getDimensionPixelSize(2131361947) + 2);
        frameLayout$LayoutParams.gravity = 48;

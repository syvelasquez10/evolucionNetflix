...
class WPInteractiveMomentsManager$7 extends AnimatorListenerAdapter
{
    final /* synthetic */ WPInteractiveMomentsManager this$0;
    final /* synthetic */ boolean val$reveal;
    
    WPInteractiveMomentsManager$7(final WPInteractiveMomentsManager this$0, final boolean val$reveal) {
        this.this$0 = this$0;
        this.val$reveal = val$reveal;
    }
    
    public void onAnimationEnd(final Animator animator) {
        super.onAnimationEnd(animator);
        if (Log.isLoggable()) {
            Log.d("WPInteractiveMomentsManager", "startRevealScaleAnimation onAnimationEnd");
        }
        this.this$0.revealCompleted(this.val$reveal && this.this$0.isShowingInteractiveMoment);
    }
}

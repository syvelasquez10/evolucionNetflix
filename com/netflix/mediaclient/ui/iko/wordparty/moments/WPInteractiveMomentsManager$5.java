...
class WPInteractiveMomentsManager$5 extends AnimatorListenerAdapter
{
    final /* synthetic */ WPInteractiveMomentsManager this$0;
    final /* synthetic */ int val$duration;
    
    WPInteractiveMomentsManager$5(final WPInteractiveMomentsManager this$0, final int val$duration) {
        this.this$0 = this$0;
    ...
    public void onAnimationEnd(final Animator animator) {
        ...
        if (Log.isLoggable()) {
            Log.d("WPInteractiveMomentsManager", "playPugIntro onAnimationEnd");
        }
        this.this$0.startPugIntroAnimation(this.val$duration - 1000);
    }
}

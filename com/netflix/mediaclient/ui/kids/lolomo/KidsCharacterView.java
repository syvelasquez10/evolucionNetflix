...
public class KidsCharacterView extends RelativeLayout implements IVideoView<Video>
{
    ...
    public KidsCharacterView(final Context context, final boolean b) {
        ...
        (this.img = (AdvancedImageView)this.findViewById(2131165402)).setCornerRadius(this.getResources().getDimensionPixelSize(2131361962));
        ...
        if (kidsWithUpDownScrolling) {
            ...
            this.setPadding(0, 0, this.getResources().getDimensionPixelSize(2131361971), this.getResources().getDimensionPixelSize(2131361972));
            return;
        }

...
public class KidsSeasonSelector extends RelativeLayout
{
    ...
    public KidsSeasonSelector(final KidsShowDetailsFrag kidsShowDetailsFrag, final KidsShowDetailsAdapter adapter) {
        ...
        this.itemWidth = this.getResources().getDimensionPixelSize(2131361971);
        ...
        this.seasonsGroup = (LinearLayout)this.findViewById(2131165413);
        (this.scroller = (HorizontalScrollView)this.findViewById(2131165412)).setHorizontalScrollBarEnabled(false);
    ...
    private View createItemView(final int n, final boolean b) {
        ...
        textView.setOnClickListener((View$OnClickListener)new KidsSeasonSelector$3(this, textView));
    ...
    public void setSeasonNumber(final int n, final boolean b) {
        ...
        for (int i = 0; i < this.itemViews.size(); ++i) {
            ...
            if (safeEquals) {
                ...
                this.scroller.post((Runnable)new KidsSeasonSelector$2(this, b, n2));
            }
        }
    }
}

...
class GalleryGenresLoMoFrag$2 implements RecyclerViewHeaderAdapter$IViewCreator
{
    ...
    private int getImageWidth() {
        return (this.this$0.recyclerView.getWidth() - (this.this$0.getActivity().getResources().getDimensionPixelSize(2131427780) * 2 + this.this$0.getActivity().getResources().getDimensionPixelOffset(2131427778) * this.this$0.numColumns)) / this.this$0.numColumns;
    }

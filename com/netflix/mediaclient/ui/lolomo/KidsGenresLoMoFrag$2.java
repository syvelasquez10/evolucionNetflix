...
class KidsGenresLoMoFrag$2 implements RecyclerViewHeaderAdapter$IViewCreator
{
    ...
    private int getImageWidth() {
        return (this.this$0.recyclerView.getWidth() - (this.this$0.getActivity().getResources().getDimensionPixelSize(2131296606) * 2 + this.this$0.getActivity().getResources().getDimensionPixelOffset(2131296604) * this.this$0.numColumns)) / this.this$0.numColumns;
    }

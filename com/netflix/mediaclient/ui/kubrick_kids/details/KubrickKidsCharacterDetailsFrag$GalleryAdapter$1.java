...
class KubrickKidsCharacterDetailsFrag$GalleryAdapter$1 implements RecyclerViewHeaderAdapter$IViewCreator
{
    ...
    private int getImageHeight() {
        return (int)((KidsUtils.getDetailsPageContentWidth((Context)this.val$this$0.getActivity()) - this.val$this$0.getActivity().getResources().getDimensionPixelOffset(2131296487) * (this.val$this$0.numColumns + 1.0f)) / this.val$this$0.numColumns * 0.5625f);
    }

...
class KubrickKidsCharacterDetailsFrag$KubrickKidsCharacterDetailsViewGroup extends KubrickVideoDetailsViewGroup
{
    ...
    private Drawable getBackgroundResource() {
        switch (this.this$0.kidsColor) {
            default: {
                return this.this$0.getActivity().getResources().getDrawable(2130837576);
            }
            case 2131558505: {
    ...
    protected void findViews() {
        super.findViews();
        this.characterView = (AdvancedImageView)this.findViewById(2131624250);
        this.playView = (ImageView)this.findViewById(2131624255);
    ...
    protected void updateBoxart(final KidsCharacterDetails kidsCharacterDetails) {
        ...
        NetflixActivity.getImageLoader((Context)this.this$0.getActivity()).showImg(this.horzDispImg, storyUrl, IClientLogging$AssetType.boxArt, String.format(this.getResources().getString(2131165354), this.this$0.kidsCharacterDetails.getTitle()), BrowseExperience.getImageLoaderConfig(), true);

...
public class KubrickKidsShowDetailsFrag extends KubrickShowDetailsFrag
{
    ...
    protected int calculateSpinnerLeftPosition() {
        ...
        return n + (int)this.getResources().getDimension(2131296478);
    }
    ...
    protected ViewGroup createSeasonsSpinnerGroup() {
        ...
        this.setSpinnerBackground(this.getResources().getColor(2131230898));
        ...
        if (seasonsSpinnerAdapter != null) {
            ...
            seasonsSpinnerAdapter.setDropDownTextColor(2131230898);
        }
    ...
    protected void setSpinnerBackground(final int n) {
        ...
        final LayerDrawable layerDrawable = (LayerDrawable)this.getResources().getDrawable(2130837769);
    ...
    protected void setupRecyclerViewAdapter() {
        this.episodesAdapter = new KubrickKidsShowDetailsFrag$KubrickKidsAdapter(this, this.getNetflixActivity(), this, new KubrickKidsShowDetailsFrag$1(this));
    ...
    protected void setupSeasonsSpinnerAdapter() {
        ...
        adapter.setItemBackgroundColor(2131230898);

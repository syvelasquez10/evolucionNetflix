...
public class SearchResultView extends FrameLayout implements PlayContextProvider
{
    ...
    private void findViews() {
        this.img = (AdvancedImageView)this.findViewById(2131690249);
        this.title = (TextView)this.findViewById(2131690250);
    }
    ...
    private void init() {
        ...
        this.setForeground(this.getResources().getDrawable(2130837935));
        this.findViews();
        this.setupViews();

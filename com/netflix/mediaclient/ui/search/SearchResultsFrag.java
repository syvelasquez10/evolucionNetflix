...
public class SearchResultsFrag extends NetflixFrag
{
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        final View inflate = layoutInflater.inflate(2130903112, (ViewGroup)null);
        this.adapter = new SearchResultsAdapter();
        (this.gridView = (StickyGridHeadersGridView)inflate.findViewById(2131099911)).setAdapter((ListAdapter)this.adapter);
    ...
    private class SearchResultsAdapter extends BaseAdapter implements AdapterView$OnItemClickListener, StickyGridHeadersBaseAdapter
    {
        ...
        public View getHeaderView(final int n, final View view, final ViewGroup viewGroup) {
            ...
            if ((inflate = view) == null) {
                inflate = SearchResultsFrag.this.getActivity().getLayoutInflater().inflate(2130903113, (ViewGroup)null);
            }
            ((TextView)inflate.findViewById(2131099912)).setText(SearchResultsFrag.this.results.getSectionTitle((Context)SearchResultsFrag.this.getActivity(), n));
            return inflate;
        }

...
public class SearchQueryDetailsActivity extends NetflixActivity
{
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        this.leWrapper = new LoadingAndErrorWrapper(this.findViewById(2131165583), this.leCallback);
        final int dimensionPixelOffset = this.getResources().getDimensionPixelOffset(2131361872);
        (this.content = this.findViewById(2131165584)).setPadding(dimensionPixelOffset, 0, dimensionPixelOffset, 0);
        this.content.setVisibility(4);
        this.findViewById(2131165595).setVisibility(0);
        (this.titleView = (TextView)this.findViewById(2131165596)).setText((CharSequence)this.getTitleForType(this.type, this.title));
        this.titleView.setVisibility(0);
        (this.gridView = (StaticGridView)this.findViewById(2131165597)).setLayoutAnimation(AnimationUtils.createGridLayoutAnimator((Context)this));

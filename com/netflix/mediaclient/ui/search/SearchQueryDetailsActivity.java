...
public class SearchQueryDetailsActivity extends NetflixActivity
{
    ...
    private void findViews() {
        this.titleView = (TextView)this.findViewById(2131755218);
        this.gridView = (StaticGridView)this.findViewById(2131755886);
        this.loadingWrapper = this.findViewById(2131755870);
        this.content = (LoggingScrollView)this.findViewById(2131755871);
    }
    ...
    private String getTitleForType(final SearchQueryDetailsActivity$SearchQueryDetailsType searchQueryDetailsActivity$SearchQueryDetailsType, final String s) {
        ...
        if (searchQueryDetailsActivity$SearchQueryDetailsType == SearchQueryDetailsActivity$SearchQueryDetailsType.SEARCH_SUGGESTION) {
            return this.getString(2131296828, new Object[] { s });
        }
    ...
    private void setupViews() {
        final int dimensionPixelOffset = this.getResources().getDimensionPixelOffset(2131427806);

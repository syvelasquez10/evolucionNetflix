...
class NotificationsFrag$NotificationsListAdapter extends BaseAdapter
{
    ...
    private void updateAvailableButtons(final SocialNotification socialNotification, final SocialNotificationSummary socialNotificationSummary, final NotificationViewHolder notificationViewHolder, final View view) {
        if (this.this$0.mNotifications == null || this.this$0.mNotifications.getSocialNotificationsListSummary() == null) {
            ...
            if (addToMyListButton != null && this.this$0.mServiceManager != null && netflixActivity != null) {
                this.this$0.mServiceManager.registerAddToMyListListener(id, this.this$0.mServiceManager.createAddToMyListWrapper(netflixActivity, addToMyListButton, id, type, socialNotificationsListSummary.getBaseTrackId(), true));
                this.this$0.mServiceManager.updateMyListState(id, socialNotificationSummary.getInQueueValue());
            }
            ...
            if (this.this$0.shouldShowPlayButtonFromNotifications() && playMovieButton != null) {
                playMovieButton.setOnClickListener((View$OnClickListener)new NotificationsFrag$NotificationsListAdapter$1(this, netflixActivity, id, new PlayContextImp(requestId, socialNotificationsListSummary.getPlayerTrackId(), 0, 0), type));
            }
            view.setOnClickListener((View$OnClickListener)new NotificationsFrag$NotificationsListAdapter$2(this, requestId, socialNotificationsListSummary, netflixActivity, type, id, socialNotificationSummary));
    ...
    public View getView(final int n, final View view, final ViewGroup viewGroup) {
        ...
        if (!this.this$0.areMoreNotificationsAvailable() && (this.this$0.mNotifications == null || this.this$0.mNotifications.getSocialNotifications() == null || this.this$0.mNotifications.getSocialNotifications().size() == 0)) {
            SocialNotification.showSingleLineText(notificationViewHolder, 2131493390);
            inflate.setOnClickListener((View$OnClickListener)null);
        }
        else {
            if (this.this$0.areMoreNotificationsAvailable() && n == this.getCount() - 1) {
                SocialNotification.showSingleLineText(notificationViewHolder, 2131493362);
                inflate.setOnClickListener((View$OnClickListener)null);
            ...
            if (notificationByType == null) {
                ...
                SocialNotification.showSingleLineText(notificationViewHolder, 2131493389);
                inflate.setOnClickListener((View$OnClickListener)null);
                return inflate;
            }
            if (this.this$0.getActivity() != null && NetflixActivity.getImageLoader((Context)this.this$0.getActivity()) != null) {
                notificationByType.initView(inflate, notificationViewHolder, item, (Context)this.this$0.getActivity());

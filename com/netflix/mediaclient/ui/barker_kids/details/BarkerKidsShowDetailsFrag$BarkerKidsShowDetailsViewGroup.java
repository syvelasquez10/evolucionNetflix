...
class BarkerKidsShowDetailsFrag$BarkerKidsShowDetailsViewGroup extends BarkerVideoDetailsViewGroup
{
    private PressAnimationFrameLayout pressableCWImgGroup;
    final /* synthetic */ BarkerKidsShowDetailsFrag this$0;
    
    public BarkerKidsShowDetailsFrag$BarkerKidsShowDetailsViewGroup(final BarkerKidsShowDetailsFrag this$0, final Context context) {
        this.this$0 = this$0;
        super(context);
        this.setupViews();
    }

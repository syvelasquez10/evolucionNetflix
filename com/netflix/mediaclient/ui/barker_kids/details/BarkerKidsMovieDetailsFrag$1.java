...
class BarkerKidsMovieDetailsFrag$1 implements RecyclerViewHeaderAdapter$IViewCreator
{
    ...
    private int getImageHeight() {
        return (int)((KidsUtils.getDetailsPageContentWidth((Context)this.this$0.getActivity()) - this.this$0.getActivity().getResources().getDimensionPixelOffset(2131427763) * (this.this$0.numColumns + 1.0f)) / this.this$0.numColumns * 1.43f);
    }

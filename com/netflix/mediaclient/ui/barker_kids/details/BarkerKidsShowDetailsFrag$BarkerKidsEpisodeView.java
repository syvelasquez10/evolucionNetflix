...
class BarkerKidsShowDetailsFrag$BarkerKidsEpisodeView extends BarkerShowDetailsFrag$BarkerEpisodeView
{
    ...
    public BarkerKidsShowDetailsFrag$BarkerKidsEpisodeView(final BarkerKidsShowDetailsFrag this$0, final Context context, final int n) {
        ...
        this.pressableViewGroup = (PressAnimationFrameLayout)this.findViewById(2131821046);
        this.image.setPressedStateHandlerEnabled(false);
    }
    
    @Override
    protected void adjustEpisodeImageHeight() {
        this.image.getLayoutParams().height = (int)((KidsUtils.getDetailsPageContentWidth((Context)this.this$0.getActivity()) - this.this$0.getActivity().getResources().getDimensionPixelOffset(2131427767) * (this.this$0.getNumColumns() + 1.0f)) / this.this$0.getNumColumns() * 0.5625f);
    }
    ...
    protected void updateTitle(final EpisodeDetails episodeDetails) {
        if (this.title != null) {
            ...
            this.title.setTextColor(this.getResources().getColor(2131755161));

...
public class BarkerKidsCharacterView extends FrameLayout implements VideoViewGroup$IVideoView<Video>
{
    ...
    static {
        BACKGROUND_DRAWABLE_IDS = new BarkerKidsCharacterView$1();
    }
    
    public BarkerKidsCharacterView(final Context context) {
        super(context);
        this.setFocusable(true);
        this.playContext = PlayContext.EMPTY_CONTEXT;
        final int dimensionPixelSize = this.getResources().getDimensionPixelSize(2131427494);
        ...
        final int dimensionPixelSize2 = this.getResources().getDimensionPixelSize(2131427496);
    ...
    public String getImageUrl(final Video video, final boolean b) {
        return BrowseExperience.getLomoVideoViewImageUrl(this.getContext(), video, BarkerKidsCharacterView.class, 0);
    }
    ...
    public void update(final Video video, final Trackable trackable, int n, final boolean b, final boolean b2) {
        ...
        n %= BarkerKidsCharacterView.BACKGROUND_DRAWABLE_IDS.size();
        this.bg.setBackgroundResource((int)BarkerKidsCharacterView.BACKGROUND_DRAWABLE_IDS.get(n).first);
        this.kidsColor = BarkerKidsCharacterView.BACKGROUND_DRAWABLE_IDS.get(n).second;

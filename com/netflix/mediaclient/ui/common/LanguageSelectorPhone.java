...
public final class LanguageSelectorPhone extends LanguageSelector implements TabHost$OnTabChangeListener
{
    ...
    private View getTabIndicator(final Context context, final TabHost tabHost, final int text, final boolean b) {
        final View inflate = LayoutInflater.from(context).inflate(2130903104, (ViewGroup)null, false);
        final TextView textView = (TextView)inflate.findViewById(2131165403);
    ...
    protected int calculateListViewHeight() {
        ...
        final int n = (int)this.mController.getResources().getDimension(2131361861);
        final int n2 = (int)this.mController.getResources().getDimension(2131361860);
        final int n3 = (int)this.mController.getResources().getDimension(2131361884);
        int intrinsicHeight;
        if ((intrinsicHeight = this.mController.getResources().getDrawable(2130837729).getIntrinsicHeight()) == -1) {
            intrinsicHeight = (int)this.mController.getResources().getDimension(2131361885);
        }
    ...
    protected void init(final View view, final Language language) {
        ...
        (this.mTabHost = (TabHost)view.findViewById(2131165398)).setOnTabChangedListener((TabHost$OnTabChangeListener)this);
        this.mTabHost.setup();
        this.setNewTab((Context)this.mController, this.mTabHost, "ListAudios", 2131493117, 2131165399, true);
        this.setNewTab((Context)this.mController, this.mTabHost, "ListSubtitles", 2131493116, 2131165400, false);

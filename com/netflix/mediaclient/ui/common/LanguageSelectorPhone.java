...
public final class LanguageSelectorPhone extends LanguageSelector implements TabHost$OnTabChangeListener
{
    ...
    protected void init(final View view, final Language language) {
        ...
        this.mTabHost.setup();
        this.setNewTab((Context)this.mController, this.mTabHost, "ListAudios", 2131165394, 2131624247, true);
        this.setNewTab((Context)this.mController, this.mTabHost, "ListSubtitles", 2131165552, 2131624249, false);

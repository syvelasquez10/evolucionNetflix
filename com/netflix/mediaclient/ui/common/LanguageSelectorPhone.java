...
public final class LanguageSelectorPhone extends LanguageSelector implements TabHost$OnTabChangeListener
{
    ...
    private View getTabIndicator(final Context context, final TabHost tabHost, final int text, final boolean b) {
        final View inflate = LayoutInflater.from(context).inflate(2130903154, (ViewGroup)null, false);
        final TextView textView = (TextView)inflate.findViewById(2131624349);
    ...
    protected int calculateListViewHeight() {
        ...
        final int n = (int)resources.getDimension(2131296377);
        final int n2 = (int)resources.getDimension(2131296312);
        final int n3 = (int)resources.getDimension(2131296623);
    ...
    protected void init(final View view, final Language language) {
        ...
        (this.mTabHost = (TabHost)view.findViewById(2131624348)).setOnTabChangedListener((TabHost$OnTabChangeListener)this);
        this.mTabHost.setup();
        this.setNewTab((Context)this.mController, this.mTabHost, "ListAudios", 2131165420, 2131624302, true);
        this.setNewTab((Context)this.mController, this.mTabHost, "ListSubtitles", 2131165667, 2131624304, false);

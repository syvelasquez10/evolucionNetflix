...
public abstract class LanguageSelector
{
    ...
    protected void createAndShowDialog(final View view) {
        ...
        languageSelector$LanguageAlertDialog.setButton(-1, (CharSequence)this.mController.getString(2131165485), (DialogInterface$OnClickListener)new LanguageSelector$3(this, this.mCallback.wasPlaying(), languageSelector$LanguageAlertDialog));
    ...
    protected void initLists(final View view, final Language language) {
        (this.mAudiosListView = (ListView)view.findViewById(2131624247)).setChoiceMode(1);
        ...
        (this.mSubtitlesListView = (ListView)view.findViewById(2131624249)).setChoiceMode(1);

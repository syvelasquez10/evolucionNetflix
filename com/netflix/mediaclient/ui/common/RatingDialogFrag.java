...
public class RatingDialogFrag extends NetflixDialogFrag implements RatingBar$OnRatingBarChangeListener, MdxMiniPlayerDialog
{
    ...
    public static RatingDialogFrag newInstance(final Rating rating, final String s, final String s2) {
        ...
        ratingDialogFrag.setStyle(1, 2131427387);
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        final View inflate = layoutInflater.inflate(2130903100, viewGroup, false);
        int n = 2131099879;
        ...
        ((TextView)inflate.findViewById(2131099878)).setText((CharSequence)this.getString(2131493190, new Object[] { this.mVideoTitle }));
        return inflate;
    }

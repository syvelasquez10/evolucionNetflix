...
public class RatingDialogFrag extends NetflixDialogFrag implements NetflixRatingBar$OnNetflixRatingBarChangeListener, MdxMiniPlayerFrag$MdxMiniPlayerDialog
{
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        this.mRatingBar = (NetflixRatingBar)inflate.findViewById(2131690225);
        this.mTitle = (TextView)inflate.findViewById(2131690224);
        this.mRatingGroup = (ViewGroup)inflate.findViewById(2131690226);

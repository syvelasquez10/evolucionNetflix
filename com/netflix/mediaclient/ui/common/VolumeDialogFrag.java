...
public class VolumeDialogFrag extends NetflixDialogFrag implements SeekBar$OnSeekBarChangeListener, MdxMiniPlayerFrag$MdxMiniPlayerDialog
{
    ...
    public static VolumeDialogFrag newInstance() {
        ...
        volumeDialogFrag.setStyle(1, 2131558713);
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        final View inflate = layoutInflater.inflate(2130903201, viewGroup, false);
        (this.seekBar = (NetflixSeekBar)inflate.findViewById(2131165688)).setOnSeekBarChangeListener((SeekBar$OnSeekBarChangeListener)this);

...
class DebugMenuItems$1 implements MenuItem$OnMenuItemClickListener
{
    ...
    DebugMenuItems$1(final DebugMenuItems this$0, final String[] val$testEnvironments, final String val$currentEnvironment, final String[] val$prodEnvironments) {
        this.this$0 = this$0;
    ...
    private void showOptionsDialog(final int n, final boolean b, final String[] array) {
        ...
        alertDialog$Builder.setSingleChoiceItems(array, n, (DialogInterface$OnClickListener)new DebugMenuItems$1$1(this, b));

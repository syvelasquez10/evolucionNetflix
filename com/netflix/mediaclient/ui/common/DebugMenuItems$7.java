...
class DebugMenuItems$7 implements MenuItem$OnMenuItemClickListener
{
    ...
    DebugMenuItems$7(final DebugMenuItems this$0, final String[] val$testEnvironments, final String val$currentEnvironment, final String[] val$prodEnvironments) {
        this.this$0 = this$0;
    ...
    private void showOptionsDialog(final int n, final boolean b, final String[] array) {
        ...
        alertDialog$Builder.setSingleChoiceItems(array, n, (DialogInterface$OnClickListener)new DebugMenuItems$7$1(this, b));

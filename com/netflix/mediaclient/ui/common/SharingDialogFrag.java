...
public class SharingDialogFrag extends NetflixDialogFrag implements MdxMiniPlayerFrag$MdxMiniPlayerDialog
{
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        final View inflate = layoutInflater.inflate(2130903190, viewGroup, false);
        inflate.findViewById(2131165666).setOnClickListener((View$OnClickListener)new SharingDialogFrag$1(this));
        return inflate;
    }
}

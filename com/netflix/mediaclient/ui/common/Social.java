...
public class Social extends Section
{
    ...
    private void initSocial() {
        this.mShareButton = (ImageButton)this.mContext.findViewById(2131165547);
        if (this.mShareButton != null) {
        ...
        this.mNotSharingButton = this.mContext.findViewById(2131165564);
        this.mNotSharingLabel = this.mContext.findViewById(2131165565);

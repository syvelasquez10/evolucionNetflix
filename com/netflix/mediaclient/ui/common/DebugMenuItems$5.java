...
class DebugMenuItems$5 implements MenuItem$OnMenuItemClickListener
{
    ...
    DebugMenuItems$5(final DebugMenuItems this$0, final Menu val$menu) {
        this.this$0 = this$0;
        this.val$menu = val$menu;
    }
    
    public boolean onMenuItemClick(final MenuItem menuItem) {
        CronetHttpURLConnectionFactory.getInstance((Context)this.this$0.activity).stopNetLog();
        this.val$menu.removeItem(menuItem.getItemId());
        this.this$0.addStartCronetLogging(this.val$menu);
        return true;
    }
}

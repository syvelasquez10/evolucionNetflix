...
public enum BrowseExperience implements IExperience
{
    ...
    TEST_6538_CELL_2("TEST_6538_CELL_2", 2, (BrowseExperience$ExperienceMap)new BrowseExperience$5()) {
        private final Set<VideoType> VALID_DETAIL_TYPES;
    ...
    TEST_6538_CELL_3("TEST_6538_CELL_3", 5, (BrowseExperience$ExperienceMap)new BrowseExperience$11()) {
        private final Set<VideoType> VALID_DETAIL_TYPES;
        ...
        @Override
        public int getLomoRowTitleVisibility(final NetflixActivity netflixActivity, final BasicLoMo basicLoMo) {
            switch (BrowseExperience$17.$SwitchMap$com$netflix$mediaclient$servicemgr$interface_$LoMoType[basicLoMo.getType().ordinal()]) {
                default: {
                    return 0;
                }
                case 1: {
    ...
    TEST_6538_CELL_4("TEST_6538_CELL_4", 3, (BrowseExperience$ExperienceMap)new BrowseExperience$7()) {
        private final Set<VideoType> VALID_DETAIL_TYPES;
    ...
    TEST_6538_CELL_5("TEST_6538_CELL_5", 4, (BrowseExperience$ExperienceMap)new BrowseExperience$9()) {
        private final Set<VideoType> VALID_DETAIL_TYPES;
    ...
    protected static final String USE_LOLOMO_VERT_ART = "USE_LOLOMO_VERT_ART";
    ...
    public static boolean isKubrickKids() {
        return BrowseExperience.currExperience == BrowseExperience.TEST_6538_CELL_3 || BrowseExperience.currExperience == BrowseExperience.TEST_6538_CELL_4 || BrowseExperience.currExperience == BrowseExperience.TEST_6538_CELL_5;
    }
    ...
    public static void refresh(final Context context, final UserProfile userProfile) {
        ...
        switch (BrowseExperience$17.$SwitchMap$com$netflix$mediaclient$ui$experience$PersistentExperience[value.ordinal()]) {
            default: {
                BrowseExperience.currExperience = BrowseExperience.STANDARD;
                break;
            }
            ...
            case 3: {
                ...
                if (b) {
                    currExperience3 = BrowseExperience.TEST_6538_CELL_2;
                }
                else {
            ...
            case 4: {
                ...
                if (b) {
                    currExperience4 = BrowseExperience.TEST_6538_CELL_3;
                }
                else {
            ...
            case 5: {
                ...
                if (b) {
                    currExperience5 = BrowseExperience.TEST_6538_CELL_4;
                }
                else {
            ...
            case 6: {
                ...
                if (b) {
                    currExperience6 = BrowseExperience.TEST_6538_CELL_5;
                }
                else {
    ...
    public static boolean useLolomoVerticalArt() {
        return ((HashMap<K, Boolean>)BrowseExperience.currExperience.data).get("USE_LOLOMO_VERT_ART");
    }
}

...
final class BrowseExperience$1 extends BrowseExperience$ExperienceMap
{
    BrowseExperience$1() {
        ...
        ((HashMap<String, Integer>)this).put("LOMO_FRAG_OFFSET_LEFT_DIMEN_INT", 2131296554);
        ((HashMap<String, Integer>)this).put("LOMO_FRAG_OFFSET_RIGHT_DIMEN_INT", 2131296554);
        ...
        ((HashMap<String, Boolean>)this).put("USE_LOLOMO_VERT_ART", true);

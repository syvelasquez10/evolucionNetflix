...
public class PinDialog extends NetflixDialogFrag
{
    ...
    protected static PinDialog createPinDialog(final PlayVerifierVault playVerifierVault) {
        ...
        pinDialog.setStyle(1, 2131493008);
        return pinDialog;
    }
    ...
    private InputMethodManager getIMM(final ServiceManager serviceManager) {
        ...
        return (InputMethodManager)this.getActivity().getSystemService("input_method");
    }
    ...
    protected static void notifyCallerPinVerified(final NetflixActivity netflixActivity, final PlayVerifierVault playVerifierVault, final PinAndAgeVerifier$PinAndAgeVerifyCallback pinAndAgeVerifier$PinAndAgeVerifyCallback) {
        if (playVerifierVault == null || netflixActivity == null || playVerifierVault.getAsset() == null) {
            ...
            if (PlayVerifierVault$RequestedBy.PLAYER.getValue().equals(playVerifierVault.getInvokeLocation())) {
                if (pinAndAgeVerifier$PinAndAgeVerifyCallback != null) {
                    pinAndAgeVerifier$PinAndAgeVerifyCallback.onPlayVerified(true, playVerifierVault);
                    return;
                }
                Log.i("nf_pin", "notifyCallerPinVerified RequestedBy.PLAYER callback is null");
            }
            else if (PlayVerifierVault$RequestedBy.OFFLINE_DOWNLOAD.getValue().equals(playVerifierVault.getInvokeLocation())) {
                if (pinAndAgeVerifier$PinAndAgeVerifyCallback != null) {
                    pinAndAgeVerifier$PinAndAgeVerifyCallback.onOfflineDownloadPinAndAgeVerified(true, playVerifierVault);
                    return;
                }
    ...
    private void processUserInputPin(final String s) {
        ...
        this.getServiceManager().verifyPin(s, new PinDialog$OnPinVerifiedCallback(this, this.mCallback));
    }
    ...
    private static void showConnectivityErrorDialog(final NetflixActivity netflixActivity, final Status status) {
        new AlertDialog$Builder((Context)netflixActivity).setCancelable(false).setMessage(String.format("%s (%d)", netflixActivity.getString(2131296855), status.getStatusCode().getValue())).setPositiveButton(2131296724, (DialogInterface$OnClickListener)new PinDialog$2()).show();
    }
    ...
    private void showProgress(final boolean mInProgress) {
        ...
        if (mInProgress) {
            this.mPinMessage.setText(2131296735);
        }
    }
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        final View inflate = this.getActivity().getLayoutInflater().inflate(2130903248, (ViewGroup)null);
        this.mSpinner = (ProgressBar)inflate.findViewById(2131755650);
        (this.mPinEditText = (EditText)inflate.findViewById(2131755647)).setOnEditorActionListener((TextView$OnEditorActionListener)new PinDialog$PinDialogOnDone(this, null));
        this.mPinEditText.setOnKeyListener((View$OnKeyListener)new PinDialog$PinDialogOnKeyPress(this, null));
        this.mPinMessage = (TextView)inflate.findViewById(2131755646);
        (this.mPinForgotView = (TextView)inflate.findViewById(2131755649)).setMovementMethod((MovementMethod)new PinDialog$1(this));
        this.mPinForgotView.setFocusable(false);
        this.mErrorIcon = (ImageView)inflate.findViewById(2131755648);
        ...
        create.setButton(-2, this.getString(2131296564), (DialogInterface$OnClickListener)new PinDialog$PinDialogOnCancel(this, null));
        this.mActive = true;
        return create;
    }
    ...
    public void retryOnPinFailure() {
        this.mPinMessage.setText(2131296731);
        this.mPinEditText.getText().clear();
        this.showErrorIcon(true);
        this.showSoftKeyboard(this.getServiceManager(), this.mPinEditText);
    }
    
    public void setPinVerifierCallback(final PinAndAgeVerifier$PinAndAgeVerifyCallback mCallback) {

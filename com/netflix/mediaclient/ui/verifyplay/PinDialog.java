...
public class PinDialog extends NetflixDialogFrag
{
    ...
    protected static PinDialog createPinDialog(final PlayVerifierVault playVerifierVault) {
        ...
        pinDialog.setStyle(1, 2131558721);
        return pinDialog;
    }
    ...
    private static void showConnectivityErrorDialog(final NetflixActivity netflixActivity, final Status status) {
        new AlertDialog$Builder((Context)netflixActivity).setCancelable(false).setMessage((CharSequence)String.format("%s (%d)", netflixActivity.getString(2131493258), status.getStatusCode().getValue())).setPositiveButton(2131493003, (DialogInterface$OnClickListener)new PinDialog$2()).show();
    }
    ...
    private void showProgress(final boolean mInProgress) {
        ...
        if (mInProgress) {
            this.mPinMessage.setText(2131493294);
        }
    }
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        this.mSpinner = (ProgressBar)inflate.findViewById(2131427699);
        (this.mPinEditText = (EditText)inflate.findViewById(2131427696)).setOnEditorActionListener((TextView$OnEditorActionListener)new PinDialog$PinDialogOnDone(this, null));
        this.mPinEditText.setOnKeyListener((View$OnKeyListener)new PinDialog$PinDialogOnKeyPress(this, null));
        this.mPinMessage = (TextView)inflate.findViewById(2131427695);
        (this.mPinForgotView = (TextView)inflate.findViewById(2131427698)).setMovementMethod((MovementMethod)new PinDialog$1(this));
        this.mPinForgotView.setFocusable(false);
        this.mErrorIcon = (ImageView)inflate.findViewById(2131427697);
        ...
        create.setButton(-2, (CharSequence)this.getString(2131493120), (DialogInterface$OnClickListener)new PinDialog$PinDialogOnCancel(this, null));
        this.mActive = true;
    ...
    public void retryOnPinFailure() {
        this.mPinMessage.setText(2131493296);

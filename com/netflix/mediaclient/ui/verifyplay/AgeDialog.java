...
public class AgeDialog extends NetflixDialogFrag
{
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        create.setButton(-2, (CharSequence)this.getString(2131165398), (DialogInterface$OnClickListener)new AgeDialog$AgeDialogOnCancel(this, null));
        create.setButton(-1, (CharSequence)this.getString(2131165388), (DialogInterface$OnClickListener)new AgeDialog$AgeDialogOnVerify(this, null));
        this.mActive = true;

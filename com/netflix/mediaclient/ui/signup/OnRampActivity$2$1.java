...
class OnRampActivity$2$1 extends SimpleManagerCallback
{
    final /* synthetic */ OnRampActivity$2 this$1;
    final /* synthetic */ ServiceManager val$svcManager;
    
    OnRampActivity$2$1(final OnRampActivity$2 this$1, final ServiceManager val$svcManager) {
        this.this$1 = this$1;
    ...
    public void onAutoLoginTokenCreated(final String s, final Status status) {
        if (status.isSucces() && !StringUtils.isEmpty(s)) {

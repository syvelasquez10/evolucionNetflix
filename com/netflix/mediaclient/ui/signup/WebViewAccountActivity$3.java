...
class WebViewAccountActivity$3 implements Runnable
{
    final /* synthetic */ WebViewAccountActivity this$0;
    
    WebViewAccountActivity$3(final WebViewAccountActivity this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        if (!this.this$0.mWebViewLoaded) {
            this.this$0.webViewVisibility(true);

...
public class AvatarsGridActivity extends NetflixActivity
{
    ...
    private void initUI() {
        ...
        this.mGridView = (GridView)this.findViewById(2131624064);
        this.mLoadingWrapper = new LoadingAndErrorWrapper(this.findViewById(2131624063), this.errorCallback);
        ...
        if (netflixActionBar != null) {
            netflixActionBar.setTitle(this.getResources().getString(2131165678));
    ...
    private void updateTopGridViewMargin() {
        int topMargin = (int)this.getResources().getDimension(2131296608);

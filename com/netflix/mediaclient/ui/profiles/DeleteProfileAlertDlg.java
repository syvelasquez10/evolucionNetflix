...
public class DeleteProfileAlertDlg extends NetflixDialogFrag
{
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        final DialogInterface$OnClickListener dialogInterface$OnClickListener = (DialogInterface$OnClickListener)this.getActivity();
        alertDialog$Builder.setNegativeButton(2131165587, dialogInterface$OnClickListener);
        alertDialog$Builder.setPositiveButton(2131165588, dialogInterface$OnClickListener);
        alertDialog$Builder.setMessage((CharSequence)this.getString(2131165589));

...
class AvatarsGridActivity$ProfileAvatarAdapter extends BaseAdapter
{
    ...
    public View getView(final int n, final View view, final ViewGroup viewGroup) {
        View inflate = view;
        if (view == null) {
            inflate = this.this$0.getLayoutInflater().inflate(2130903071, viewGroup, false);
            inflate.setTag((Object)new AvatarsGridActivity$ViewHolder((AdvancedImageView)inflate.findViewById(2131689610), (ImageView)inflate.findViewById(2131689611)));
        }
        ...
        if (this.this$0.mSelectedIconPos == n) {
            ...
            avatarsGridActivity$ViewHolder.topEditImg.setBackgroundResource(2130837908);
        }
        else {
    ...
    public void setupGridViewColumns() {
        ...
        if (width > 0) {
            ...
            final float dimension = resources.getDimension(2131362281);
            final float n = resources.getDimension(2131362280) + dimension;

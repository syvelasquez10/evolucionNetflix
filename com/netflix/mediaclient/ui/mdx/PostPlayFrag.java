...
public class PostPlayFrag extends NetflixFrag implements NetflixRatingBar$RatingBarDataProvider
{
    ...
    private void findViews(final View view) {
        this.episodeTitle = (TextView)view.findViewById(2131755737);
        this.showTitle = (TextView)view.findViewById(2131755733);
        this.targetName = (TextView)view.findViewById(2131755736);
        this.countdown = (TextView)view.findViewById(2131755729);
        this.synopsis = (TextView)view.findViewById(2131755738);
        this.playButton = (Button)view.findViewById(2131755739);
        this.stopButton = (ImageView)view.findViewById(2131755740);
        this.episodesButton = (ImageView)view.findViewById(2131755741);
        this.backToBrowsingButton = (TextView)view.findViewById(2131755732);
        this.postPlayForTitleEndContainer = (ViewGroup)view.findViewById(2131755731);
        this.postPlayForNextContainer = (ViewGroup)view.findViewById(2131755735);
        this.rating = (NetflixRatingBar)view.findViewById(2131755734);
    }
        ...
        if (this.targetName != null) {
            ...
            if (serviceManager != null && ServiceManagerUtils.isMdxAgentAvailable(serviceManager)) {
                ...
                if (!TextUtils.isEmpty((CharSequence)currentDeviceFriendlyName)) {
                    this.targetName.setText((CharSequence)Html.fromHtml(this.getString(2131296745, new Object[] { String.valueOf(currentDeviceFriendlyName) })));
                }
            }
        }
    }
    ...
    private void setupCountdownTimer() {
        ...
        this.countdownTimer.setTime(this.getResources().getInteger(2131558424));
    }
    ...
    private void updateDetails(final EpisodeDetails episodeDetails) {
        if (this.episodeTitle != null) {
            this.episodeTitle.setText((CharSequence)this.getResources().getString(2131296646, new Object[] { this.episodeDetails.getSeasonAbbrSeqLabel(), this.episodeDetails.getEpisodeNumber(), this.episodeDetails.getTitle() }));
        }
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        final View inflate = layoutInflater.inflate(2130903266, (ViewGroup)null, false);

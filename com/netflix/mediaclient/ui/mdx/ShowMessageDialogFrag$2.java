...
class ShowMessageDialogFrag$2 implements DialogInterface$OnClickListener
{
    final /* synthetic */ ShowMessageDialogFrag this$0;
    final /* synthetic */ String[] val$codes;
    
    ShowMessageDialogFrag$2(final ShowMessageDialogFrag this$0, final String[] val$codes) {
        this.this$0 = this$0;
    ...
    public void onClick(DialogInterface dialogInterface, final int n) {
        ...
        synchronized (dialogInterface) {
            ...
            if (dialogInterface instanceof ShowMessageDialogFrag$MessageResponseProvider) {
                ((ShowMessageDialogFrag$MessageResponseProvider)dialogInterface).onResponse(this.val$codes[1]);
            }
        }
    }
}

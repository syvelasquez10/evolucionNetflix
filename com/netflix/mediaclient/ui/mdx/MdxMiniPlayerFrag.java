...
public class MdxMiniPlayerFrag extends NetflixFrag implements IMiniPlayerFrag
{
    ...
    private void updateVideoMetadata(final VideoDetails currentVideo) {
        ...
        if (this.currentVideo.getType() == VideoType.EPISODE) {
            ...
            String s = this.activity.getString(2131231062, new Object[] { this.currentVideo.getPlayable().getSeasonAbbrSeqLabel(), this.currentVideo.getPlayable().getEpisodeNumber(), this.currentVideo.getTitle() });
            if (this.currentVideo.isNSRE()) {
                s = this.activity.getString(2131231063, new Object[] { this.currentVideo.getTitle() });
            }

...
public class BarkerShowDetailsFrag$BarkerEpisodeView extends EpisodesFrag$EpisodeView
{
    ...
    private void updateRuntime(final EpisodeDetails episodeDetails) {
        if (this.episodeTime != null) {
            ...
            String text = this.getResources().getString(2131296719, new Object[] { TimeUtils.convertSecondsToMinutes(episodeDetails.getPlayable().getRuntime()) });
            if (episodeDetails.isNSRE()) {
                text = text + "        " + episodeDetails.getAvailabilityDateMessage();
            }
            this.episodeTime.setText((CharSequence)text);
        }
    }
    ...
    protected void adjustEpisodeImageHeight() {
        ...
        this.image.getLayoutParams().height = (int)((BarkerUtils.getDetailsPageContentWidth((Context)this.this$0.getActivity()) - (this.this$0.getNumColumns() + 1.0f) * this.this$0.getActivity().getResources().getDimensionPixelOffset(2131427767)) / this.this$0.getNumColumns() * 0.5625f);
    }
    ...
    protected void findViews() {
        super.findViews();
        this.image = (AdvancedImageView)this.findViewById(2131820719);
        this.progressBarBackground = this.findViewById(2131820730);
        this.unavailable = this.findViewById(2131820721);
        this.episodePreviewContainer = this.findViewById(2131820718);
        this.badgeContainer = this.findViewById(2131820724);
    }
    ...
    protected void updateTitle(final EpisodeDetails episodeDetails) {
        if (this.this$0.getActivity() != null) {
            if (this.title != null) {
                this.title.setTextColor(this.getResources().getColor(2131755208));
            }

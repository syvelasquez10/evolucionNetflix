...
public class PreReleaseDetailsActivity extends MovieDetailsActivity
{
    ...
    private void showSnackBar() {
        final Snackbar make = Snackbar.make(this.findViewById(16908290), 2131165740, 0);
        make.getView().getLayoutParams().width = -1;
        final TextView textView = (TextView)((Snackbar$SnackbarLayout)make.getView()).findViewById(2131624350);

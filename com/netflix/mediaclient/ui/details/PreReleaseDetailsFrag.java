...
public class PreReleaseDetailsFrag extends MovieDetailsFrag
{
    ...
    protected VideoDetailsViewGroup$DetailsStringProvider getDetailsStringProvider(final MovieDetails movieDetails) {
        if (!this.isMovie && movieDetails instanceof ShowDetails) {
            return new ShowDetailsFrag$ShowDetailsStringProvider((Context)this.getActivity(), (ShowDetails)movieDetails);
        }
        return super.getDetailsStringProvider(movieDetails);
    }

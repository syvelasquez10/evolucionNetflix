...
public class DetailsMenu
{
    ...
    private void updateShareItemAsUnshared() {
        this.shareItem.setTitle(2131493066).setEnabled(false).setVisible(true);
    }
    
    private void updateShareItemToUnshare(final ServiceManager serviceManager, final String s) {
        this.shareItem.setTitle(2131493065).setOnMenuItemClickListener((MenuItem$OnMenuItemClickListener)new UnshareClickHandler(serviceManager, s)).setEnabled(true).setVisible(true);
    }
    ...
    private class OnVideoHideCallback extends LoggingManagerCallback
    {
        ...
        public void onVideoHide(final int n) {
            ...
            if (n != 0) {
                ...
                Toast.makeText((Context)DetailsMenu.this.activity, 2131493067, 1).show();
                return;
            }
            Toast.makeText((Context)DetailsMenu.this.activity, 2131493064, 1).show();

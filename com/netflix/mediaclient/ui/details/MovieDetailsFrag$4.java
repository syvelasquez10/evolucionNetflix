...
class MovieDetailsFrag$4 implements RecyclerViewHeaderAdapter$IViewCreator
{
    ...
    private void calculateViewDimensions() {
        ...
        if (this.this$0.getActivity() instanceof MementoMovieDetailsActivity) {
            ...
            detailsPageContentWidth = DeviceUtils.getScreenWidthInPixels((Context)this.this$0.getActivity()) - this.this$0.recyclerView.getPaddingLeft() - this.this$0.recyclerView.getPaddingRight() - (this.this$0.numColumns + 1) * this.this$0.getActivity().getResources().getDimensionPixelOffset(2131362066);
        }

...
class NetflixRatingBar$SetVideoRatingCallback extends LoggingManagerCallback
{
    ...
    public void onVideoRatingSet(final UserRating userRating, final Status status) {
        ...
        if (status.isError()) {
            ...
            UserActionLogUtils.reportRateActionEnded(this.this$0.getContext(), IClientLogging$CompletionReason.failed, ConsolidatedLoggingUtils.createUIError(status, this.this$0.getContext().getString(2131493186), ActionOnUIError.displayedError), null, this.this$0.currRating);
            return;
        }
        Log.v("NetflixRatingBar", "Rating has been updated");
        Toast.makeText(this.this$0.getContext(), 2131493187, 1).show();

...
class PreReleaseShowDetailsFrag$PreReleaseVideoDetailsViewGroup extends VideoDetailsViewGroup
{
    private static final String TAG = "PreReleaseVideoDetailsViewGroup";
    private Button playButton;
    private TextView supplementalMessage;
    final /* synthetic */ PreReleaseShowDetailsFrag this$0;
    
    public PreReleaseShowDetailsFrag$PreReleaseVideoDetailsViewGroup(final PreReleaseShowDetailsFrag this$0, final Context context) {
        this.this$0 = this$0;
        super(context);
    }
    ...
    private void fetchSupplementalVideos(final String s) {
        ...
        serviceManager.getBrowse().fetchShowDetails(s, null, false, new PreReleaseShowDetailsFrag$PreReleaseVideoDetailsViewGroup$FetchSupplementalsCallback(this, this.this$0.requestId));
    }
    ...
    protected void findViews() {
        super.findViews();
        this.playButton = (Button)this.findViewById(2131821544);
        this.supplementalMessage = (TextView)this.findViewById(2131821537);
    }

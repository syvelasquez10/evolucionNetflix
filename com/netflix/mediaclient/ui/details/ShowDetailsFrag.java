...
public class ShowDetailsFrag extends DetailsFrag<ShowDetails>
{
    ...
    protected void initDetailsViewGroup(final View view) {
        this.detailsViewGroup = (VideoDetailsViewGroup)view.findViewById(2131624528);
    }
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        final LinearLayout linearLayout = (LinearLayout)onCreateView.findViewById(2131624532);

...
public class SendAsFacebookMessageDialog extends NetflixDialogFrag
{
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        this.tryUpdateUI();
        return (Dialog)new AlertDialog$Builder((Context)this.getActivity()).setPositiveButton(2131165543, (DialogInterface$OnClickListener)new SendAsFacebookMessageDialog$3(this)).setNegativeButton(2131165385, (DialogInterface$OnClickListener)new SendAsFacebookMessageDialog$2(this)).setView(inflate).setCancelable(false).create();
    }

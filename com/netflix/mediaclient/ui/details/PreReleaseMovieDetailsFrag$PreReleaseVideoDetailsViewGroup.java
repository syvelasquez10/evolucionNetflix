...
class PreReleaseMovieDetailsFrag$PreReleaseVideoDetailsViewGroup extends VideoDetailsViewGroup
{
    private static final String TAG = "PreReleaseVideoDetailsViewGroup";
    private Button playButton;
    private TextView supplementalMessage;
    final /* synthetic */ PreReleaseMovieDetailsFrag this$0;
    
    public PreReleaseMovieDetailsFrag$PreReleaseVideoDetailsViewGroup(final PreReleaseMovieDetailsFrag this$0, final Context context) {
        this.this$0 = this$0;
        super(context);
    }
    ...
    private void fetchSupplementalVideos(final String s) {
        ...
        serviceManager.getBrowse().fetchMovieDetails(s, null, new PreReleaseMovieDetailsFrag$PreReleaseVideoDetailsViewGroup$FetchSupplementalsCallback(this, this.this$0.requestId));
    }

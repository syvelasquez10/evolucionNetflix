...
class MovieDetailsFrag$6 implements VideoDetailsViewGroup$DetailsStringProvider
{
    ...
    public CharSequence getGenresText() {
        ...
        return StringUtils.createBoldLabeledText((Context)this.this$0.getActivity(), 2131296663, this.val$details.getGenres());
    }
    
    @Override
    public CharSequence getStarringText() {
        return StringUtils.createBoldLabeledText((Context)this.this$0.getActivity(), 2131296813, this.val$details.getActors());
    }
}

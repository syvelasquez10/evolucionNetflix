...
public class EpisodeListFrag extends NetflixDialogFrag implements ErrorWrapper.Callback, MdxMiniPlayerDialog, ManagerStatusListener
{
    ...
    public EpisodeListFrag() {
        ...
        this.episodeRefreshReceiver = new BroadcastReceiver() {
            public void onReceive(final Context context, final Intent intent) {
                if (!EpisodeListFrag.this.isDestroyed()) {
                    final String action = intent.getAction();
                    Log.v("EpisodeListFrag", "receiver inovoked, action: " + action);
    ...
    private void completeInitIfPossible() {
        ...
        if (this.getActivity() instanceof DetailsActivity && addToMyListButton != null) {
            this.addToListWrapper = this.manager.createAddToMyListWrapper((DetailsActivity)this.getActivity(), addToMyListButton);
    ...
    public static NetflixDialogFrag create(final String s, final String s2, final boolean b) {
        ...
        episodeListFrag.setStyle(1, 2131558603);
    ...
    private ViewGroup createSeasonsSpinnerGroup() {
        ...
        (this.spinnerViewGroup = (ViewGroup)new FrameLayout((Context)this.getActivity())).setBackgroundResource(2131296343);
    ...
    private void fetchShowDetails() {
        ...
        this.manager.fetchShowDetails(this.showId, this.episodeId, new FetchShowDetailsCallback(this.requestId));
    }
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        final View inflate = layoutInflater.inflate(2130903110, (ViewGroup)null, false);

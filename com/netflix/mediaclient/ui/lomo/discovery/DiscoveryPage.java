...
public class DiscoveryPage extends LinearLayout
{
    ...
    private void init(final Context context) {
        ...
        this.topPlayableLayout = (ViewGroup)this.findViewById(2131689768);
        this.pivot1Boxart = (AdvancedImageView)this.findViewById(2131689769);
        this.pivot2Boxart = (AdvancedImageView)this.findViewById(2131689771);
        this.pivot1Title = (TextView)this.findViewById(2131689770);
        this.pivot2Title = (TextView)this.findViewById(2131689772);
        this.allCWView = this.findViewById(2131689773);

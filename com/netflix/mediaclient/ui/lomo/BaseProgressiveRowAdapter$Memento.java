...
class BaseProgressiveRowAdapter$Memento
{
    ...
    protected BaseProgressiveRowAdapter$Memento(final BasicLoMo lomo, final boolean hasMoreData, final int currDataIndex, final BasePaginatedAdapter<?> basePaginatedAdapter) {
        this.lomo = lomo;

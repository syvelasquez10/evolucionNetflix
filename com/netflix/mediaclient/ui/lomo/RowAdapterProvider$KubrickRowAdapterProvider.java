...
class RowAdapterProvider$KubrickRowAdapterProvider extends RowAdapterProvider$DefaultRowAdapterProvider
{
    ...
    protected RowAdapterProvider$KubrickRowAdapterProvider(final ServiceManager serviceManager, final RowAdapterCallbacks rowAdapterCallbacks, final ObjectRecycler$ViewRecycler objectRecycler$ViewRecycler, final boolean b) {
        ...
        this.iq = new ProgressiveIqAdapter<Object>((BasePaginatedAdapter<Video>)new KubrickPaginatedLargeVideoAdapter((Context)activity), serviceManager, rowAdapterCallbacks, objectRecycler$ViewRecycler);

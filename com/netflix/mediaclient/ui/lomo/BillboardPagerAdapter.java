...
{
    public BillboardPagerAdapter(final ServiceManager serviceManager, final RowAdapterCallbacks rowAdapterCallbacks, final ObjectRecycler$ViewRecycler objectRecycler$ViewRecycler) {
    ...
    protected void fetchMoreData(final int n, final int n2) {
        ...
        this.getManager().getBrowse().fetchVideos(loMo, n, n2, false, false, new FetchVideosHandler<Object>("BaseProgressivePagerAdapter", (FetchVideosHandler$FetchCallback<Object>)this, loMo.getTitle(), n, n2));
    }

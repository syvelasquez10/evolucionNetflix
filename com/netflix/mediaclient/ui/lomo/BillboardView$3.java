...
class BillboardView$3 implements View$OnClickListener
{
    ...
    BillboardView$3(final BillboardView this$0, final ServiceManager val$serviceMan, final Billboard val$video) {
        this.this$0 = this$0;
    ...
    public void onClick(final View view) {
        ...
        DetailsActivityLauncher.show((NetflixActivity)this.this$0.getContext(), this.val$video.getType(), this.val$video.getParentId(), this.val$video.getParentTitle(), this.this$0.playContext, "BbView");
    }
}

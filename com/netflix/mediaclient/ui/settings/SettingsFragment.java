...
public class SettingsFragment extends PreferenceFragment
{
    ...
    private void changePlayer(final PlayerType playerType) {
        if (playerType == null) {
            ...
            new AlertDialog$Builder((Context)this.activity).setTitle((CharSequence)"").setMessage(2131493120).setPositiveButton(2131493003, (DialogInterface$OnClickListener)null).show();
            return;
        }
    ...
    private void populatePlayerTypes(final ListPreference listPreference) {
        ...
        if (AndroidUtils.isOpenMaxALSupported()) {
            ...
            list.add((String)this.getText(2131493148));
            list2.add("XALAMP");
        ...
        if (PlayerTypeFactory.isPlayerTypeSupported(PlayerType.device12)) {
            list.add((String)this.getText(2131493155));
            list2.add("JPLAYER2");

...
public class SettingsFragment extends PreferenceFragment
{
    ...
    private void changePlayer(final PlayerType playerType) {
        if (playerType == null) {
            ...
            new AlertDialog$Builder((Context)this.activity).setTitle((CharSequence)"").setMessage(2131493115).setPositiveButton(2131492977, (DialogInterface$OnClickListener)null).show();
            return;
        }
    ...
    private void populatePlayerTypes(final ListPreference listPreference) {
        ...
        sb.append(this.getString(2131493114)).append(" ");
        ...
        if (PlayerTypeFactory.isPlayerTypeSupported(PlayerType.device12)) {
            list.add((String)this.getText(2131493154));
            list2.add("JPLAYER2");

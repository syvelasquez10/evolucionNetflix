...
public class SettingsFragment extends PreferenceFragment
{
    ...
    private void changePlayer(final PlayerType playerType) {
        if (playerType == null) {
            ...
            new AlertDialog$Builder((Context)this.activity).setTitle((CharSequence)"").setMessage(2131493114).setPositiveButton(2131492976, (DialogInterface$OnClickListener)null).show();
            return;
        }
    ...
    private void handleCastAppIdSettings() {
        ...
        if (preference != null) {
            preference.setSummary((CharSequence)((Object)this.getText(2131493307) + CastConfiguration.getCastApplicationId((Context)this.activity)));
    ...
    private void populatePlayerTypes(final ListPreference listPreference) {
        ...
        sb.append(this.getString(2131493113)).append(" ");
    ...
    private void populateSubtitleConfig(final ListPreference listPreference) {
        ...
        final ArrayList<String> list2 = new ArrayList<String>();
        list.add(this.getText(2131493289));
        list2.add("DEFAULT");
    ...
    private void updateAboutDevice() {
        final String string = this.getString(2131493173);
        int n = 0;

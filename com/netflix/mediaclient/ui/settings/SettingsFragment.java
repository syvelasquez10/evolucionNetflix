...
public class SettingsFragment extends PreferenceFragment implements SharedPreferences$OnSharedPreferenceChangeListener, ManagerStatusListener
{
    ...
    private void changePlayer(final PlayerType playerType) {
        if (playerType == null) {
            ...
            new AlertDialog$Builder((Context)this.activity).setTitle((CharSequence)"").setMessage(2131231348).setPositiveButton(2131231126, (DialogInterface$OnClickListener)null).show();
            return;
        }
    ...
    private void handleCastAppIdSettings() {
        ...
        if (preference != null) {
            preference.setSummary((CharSequence)((Object)this.getText(2131230992) + SettingsConfiguration.getCastApplicationId((Context)this.activity)));
    ...
    private void populatePlayerTypes(final ListPreference listPreference) {
        ...
        sb.append(this.getString(2131231347)).append(" ");
        ...
        if (AndroidUtils.isOpenMaxALSupported()) {
            list.add((String)this.getText(2131231352));
            list2.add("XAL");
            ...
            list.add((String)this.getText(2131231353));
            list2.add("XALAMP");
        ...
        if (PlayerTypeFactory.isPlayerTypeSupported(PlayerType.device10)) {
            list.add((String)this.getText(2131231349));
            list2.add("JPLAYER");
        ...
        if (PlayerTypeFactory.isPlayerTypeSupported(PlayerType.device11)) {
            list.add((String)this.getText(2131231351));
        ...
        if (PlayerTypeFactory.isPlayerTypeSupported(PlayerType.device12)) {
            list.add((String)this.getText(2131231350));
            list2.add("JPLAYER2");
    ...
    private void populateSubtitleConfig(final ListPreference listPreference) {
        ...
        final ArrayList<String> list2 = new ArrayList<String>();
        list.add(this.getText(2131231357));
        list2.add("DEFAULT");
        list.add(this.getText(2131231358));
        list2.add("ENHANCED_XML");
        list.add(this.getText(2131231360));

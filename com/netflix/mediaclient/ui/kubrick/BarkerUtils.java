...
import com.netflix.mediaclient.ui.kubrick.details.RelatedTitleState;
...
public class BarkerUtils
{
    ...
    public static LoMoUtils$LoMoWidthType getCwGalleryWidthType(final NetflixActivity netflixActivity) {
        if (BrowseExperience.get() == BrowseExperience.KUBRICK_AB_TEST_HIGH_DENSITY || BarkerHelper.isInTest((Context)netflixActivity)) {

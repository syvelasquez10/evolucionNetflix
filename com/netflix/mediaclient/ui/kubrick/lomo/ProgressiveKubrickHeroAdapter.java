...
public class ProgressiveKubrickHeroAdapter extends BaseProgressiveRowAdapter<KubrickVideo>
{
    ...
    protected void fetchMoreData(final int n, final int n2) {
        ...
        this.getManager().getBrowse().fetchVideos(loMo, n, n2, false, true, KubrickLolomoUtils.shouldFetchByLomoType("BaseProgressiveRowAdapter", loMo), new FetchVideosHandler<Object>("BaseProgressiveRowAdapter", (FetchVideosHandler$FetchCallback<Video>)this, loMo.getTitle(), n, n2));
    }

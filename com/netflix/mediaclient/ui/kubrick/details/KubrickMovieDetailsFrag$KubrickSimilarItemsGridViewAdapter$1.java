...
class KubrickMovieDetailsFrag$KubrickSimilarItemsGridViewAdapter$1 implements RecyclerViewHeaderAdapter$IViewCreator
{
    ...
    private int getImageHeight() {
        return (int)((KubrickUtils.getDetailsPageContentWidth((Context)this.val$this$0.getActivity()) - this.val$this$0.getActivity().getResources().getDimensionPixelOffset(2131296507) * (this.val$numColumns + 1.0f)) / this.val$numColumns * 0.5625f);
    }

...
class ContactUsActivity$3 implements Runnable
{
    final /* synthetic */ ContactUsActivity this$0;
    
    ContactUsActivity$3(final ContactUsActivity this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        Log.d("VoipActivity", "User did NOT verified call to proceed!");
        this.this$0.mVerificationDialogDisplayed = false;
        this.this$0.callFailed(null, null, -1);
    }
}

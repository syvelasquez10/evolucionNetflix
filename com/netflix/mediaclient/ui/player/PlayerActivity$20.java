...
class PlayerActivity$20 implements Social$SocialProviderCallback
{
    ...
    public void doNotShare() {
        ...
        if (serviceManager == null || !serviceManager.isReady()) {
            ...
            serviceManager.getBrowse().hideVideo(this.this$0.mAsset.getPlayableId(), new PlayerActivity$20$1(this));
        }
    }

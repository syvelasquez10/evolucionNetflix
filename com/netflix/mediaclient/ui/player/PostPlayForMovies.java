...
public final class PostPlayForMovies extends PostPlay
{
    ...
    private void addBoxArt(final int n, final int n2) {
        ...
        advancedImageView.setBackgroundResource(2130837568);
    ...
    private void init() {
        ...
        this.addBoxArt(2131165589, 0);
        this.addBoxArt(2131165591, 1);
        this.addBoxArt(2131165593, 2);
        this.addPlayButton(2131165590, 0);
        this.addPlayButton(2131165592, 1);
        this.addPlayButton(2131165594, 2);
    }
    ...
    private void updateUi(final PostPlayVideo details, final int n) {
        if (details != null) {
            ...
            final String format = String.format(this.mContext.getResources().getString(2131493321), title);
    ...
    @Override
    void findViews() {
        this.mRatingBar = (NetflixRatingBar)this.mContext.findViewById(2131165588);
        this.mVideoDetails = (TextView)this.mContext.findViewById(2131165587);
        this.mBackgroundContainer = this.mContext.findViewById(2131165595);
        this.mMetadata = this.mContext.findViewById(2131165586);
    }

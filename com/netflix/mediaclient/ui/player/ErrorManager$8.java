...
class ErrorManager$8 implements Runnable
{
    final /* synthetic */ ErrorManager this$0;
    
    ErrorManager$8(final ErrorManager this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        this.this$0.context.startActivity(LogoutActivity.create((Context)this.this$0.context));

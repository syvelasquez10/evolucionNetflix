...
class ActionId11ErrorDescriptor extends PlaybackErrorDescriptor
{
    ...
    static ActionId11ErrorDescriptor build(final PlayerFragment playerFragment, final NccpActionId nccpActionId, final String s) {
        ...
        if (StringUtils.isEmpty(s2 = nccpActionId.getMessage())) {
            s2 = playerFragment.getString(2131296328);
        }
        return new ActionId11ErrorDescriptor(new AlertDialogFactory$TwoButtonAlertDialogDescriptor(s, s2, null, new ExitPlayerAction(playerFragment.getActivity()), playerFragment.getString(2131296633), new LaunchHelpInBrowserAction(playerFragment.getActivity(), "https://help.netflix.com/en/node/14384")));
    }
}

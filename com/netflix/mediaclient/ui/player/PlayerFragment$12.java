...
class PlayerFragment$12 implements TappableSurfaceView$SurfaceMeasureListener
{
    ...
    public void onSurfaceMeasureChange(final int n, final int n2) {
        final SecondSurface access$2400 = this.this$0.mSurface2;
        if (access$2400 != null) {
            access$2400.setSurfaceSize(n, n2);
        }
    }
}

...
public class CoppolaLoadingDecorator extends PlayScreenDecorator
{
    ...
    private void animateProgressBar() {
        ...
        final ObjectAnimator ofFloat = ObjectAnimator.ofFloat((Object)this.loadingIndicator, "translationX", new float[] { -(int)this.getController().getResources().getDimension(2131362075), 0.0f });
    ...
    private void updateLoadingText(final String s, final boolean b, String text, final int n, final boolean b2) {
        ...
        if (Coppola1Utils.showCountdownTimer((Context)this.getController().getActivity()) && this.finishTime >= currentTimeMillis && this.getController().isInPortrait() && ViewUtils.isVisible(this.launchButton)) {
            ...
            String s3;
            if (b) {
                s3 = resources.getString(2131231069, new Object[] { n, s2 });
            }
            else {
                s3 = resources.getString(2131231110, new Object[] { s2 });
            }
            ...
            if (b) {
                text = resources.getString(2131231067, new Object[] { text, n, s });
                if (b2) {
                    text = resources.getString(2131231066, new Object[] { s });
                }
                this.loadingTextIndicator.setText((CharSequence)text);
                return;
            }
            this.loadingTextIndicator.setText(2131231092);
        }
    }
    ...
    private void updateUI(final ViewGroup viewGroup) {
        ...
        this.horzDispImg = (AdvancedImageView)viewGroup.findViewById(2131690063);
        this.loadingIndicator = viewGroup.findViewById(2131690069);
        this.loadingTextIndicator = (TextView)viewGroup.findViewById(2131690066);
        this.gradient = viewGroup.findViewById(2131690064);
        this.blackBackground = viewGroup.findViewById(2131690062);
        this.animateProgressBar();
        boolean b;
        ...
        this.launchButton = viewGroup.findViewById(2131690067);
        ...
        if (!Coppola1Utils.isNewPlayerExperience((Context)this.getController().getActivity()) && !Coppola1Utils.shouldInjectPlayerFragment((Context)this.getController().getActivity())) {
            ...
            (this.oldLaunchButton = viewGroup.findViewById(2131690068)).setVisibility(0);
    ...
    private void updateViewMargins(final boolean b) {
        if (ViewUtils.isVisible((View)this.loadingTextIndicator)) {
            ...
            int leftMargin;
            if (b) {
                leftMargin = (int)resources.getDimension(2131362066);
            }
            else {

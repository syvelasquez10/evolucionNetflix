...
class PlayerFragment$EndOfBrowsePlayRunnable implements Runnable
{
    final /* synthetic */ PlayerFragment this$0;
    
    PlayerFragment$EndOfBrowsePlayRunnable(final PlayerFragment this$0) {
        this.this$0 = this$0;
    }
    ...
    public void run() {
        ...
        Label_0174: {
            ...
            Log.i("PlayerFragment", "reportBrowsePlayEndRunnable() - reporting");
            try {
                this.this$0.getServiceManager().getBrowse().endBrowsePlaySession(Long.valueOf(this.this$0.mPlayer.getXid()), Integer.valueOf(this.this$0.mAsset.getPlayableId()), 120, this.this$0.getPlayer().getCurrentPositionMs() / 1000);
                this.this$0.mWasEndOfBrowsePlayreported = true;
                return;
            }
            catch (Exception ex) {
                if (Log.isLoggable()) {
                    Log.w("PlayerFragment", "EndOfBrowsePlayRunnable: got exception trying to cast arguments: " + ex);
                }
                ErrorLoggingManager.logHandledException("SPY-8604 - Got exception trying to cast arguments: " + ex);
                return;
            }
        }
        Log.w("PlayerFragment", "reportBrowsePlayEndRunnable() - will be rescheduled!");
    }
}

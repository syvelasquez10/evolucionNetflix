...
class OfflineErrorDialog$4 implements DialogInterface$OnClickListener
{
    final /* synthetic */ OfflineErrorDialog this$0;
    
    OfflineErrorDialog$4(final OfflineErrorDialog this$0) {
        this.this$0 = this$0;
    }
    ...
    public void onClick(final DialogInterface dialogInterface, final int n) {
        ...
        if (!AndroidUtils.isActivityFinishedOrDestroyed((Context)access$300)) {
            if (ConnectivityUtils.isConnected((Context)access$300)) {
                ...
                Toast.makeText((Context)access$300, 2131296900, 0).show();
            }
        }

...
class OfflineErrorDialog$8 implements DialogInterface$OnClickListener
{
    final /* synthetic */ OfflineErrorDialog this$0;
    
    OfflineErrorDialog$8(final OfflineErrorDialog this$0) {
        this.this$0 = this$0;
    }
    ...
    public void onClick(final DialogInterface dialogInterface, final int n) {
        ...
        if (access$000 != null) {
            access$000.requestRenewPlayWindowForPlayable(this.this$0.getPlayableId());
        }
        else {
            Log.i("offlineErrorDialog", "createPlayWindowExpiredButRenewableDialog no offlineAgent");
        }

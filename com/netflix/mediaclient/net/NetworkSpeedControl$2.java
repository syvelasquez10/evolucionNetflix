...
class NetworkSpeedControl$2 implements View$OnClickListener
{
    ...
    public void onClick(final View view) {
        ...
        alertDialog$Builder.setTitle(2131297152);
        alertDialog$Builder.setPositiveButton(2131297033, (DialogInterface$OnClickListener)new NetworkSpeedControl$2$1(this));
        alertDialog$Builder.setNegativeButton(2131297032, (DialogInterface$OnClickListener)new NetworkSpeedControl$2$2(this));

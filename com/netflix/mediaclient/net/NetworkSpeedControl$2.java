...
class NetworkSpeedControl$2 implements View$OnClickListener
{
    ...
    public void onClick(final View view) {
        ...
        alertDialog$Builder.setTitle(2131297164);
        alertDialog$Builder.setPositiveButton(2131297045, (DialogInterface$OnClickListener)new NetworkSpeedControl$2$1(this));
        alertDialog$Builder.setNegativeButton(2131297044, (DialogInterface$OnClickListener)new NetworkSpeedControl$2$2(this));

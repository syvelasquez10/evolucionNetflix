...
public class SetFailedSubtitleDownloadUrl extends BaseInvoke
{
    ...
    public SetFailedSubtitleDownloadUrl(final String s, final ISubtitleDef$SubtitleFailure subtitleDef$SubtitleFailure) {
        ...
        this.setArguments(s2, subtitleDef$SubtitleFailure);
    }
    
    private void setArguments(final String s, final ISubtitleDef$SubtitleFailure subtitleDef$SubtitleFailure) {
        try {

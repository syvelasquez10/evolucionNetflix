...
class NetflixActivity$14 implements SlidingUpPanelLayout$PanelSlideListener
{
    ...
    public void onPanelCollapsed(final View view) {
        ...
        if (this.this$0.castPlayerFrag != null) {
            this.this$0.castPlayerFrag.onPanelCollapsed();
        }
    }
    ...
    public void onPanelExpanded(final View view) {
        ...
        if (this.this$0.castPlayerFrag != null) {
            this.this$0.castPlayerFrag.onPanelExpanded();
        }
    }
    ...
    public void onPanelSlide(final View view, final float n) {
        ...
        if (this.this$0.castPlayerFrag != null) {
            this.this$0.castPlayerFrag.onPanelSlide(n);
        }

...
class NetflixActivity$15 implements Runnable
{
    ...
    @Override
    public void run() {
        if (this.this$0.isVisible && !AndroidUtils.isActivityFinishedOrDestroyed((Context)this.this$0) && this.this$0.castPlayerFrag != null && this.this$0.slidingPanel != null && this.this$0.netflixActionBar != null) {
            if (Log.isLoggable()) {
                Log.v("NetflixActivity", "Checking to see if action bar visibility is valid.  Frag showing: " + this.this$0.castPlayerFrag.isShowing() + ", panel expanded: " + this.this$0.slidingPanel.isExpanded() + ", system action bar showing: " + this.this$0.netflixActionBar.isShowing());
            }
            if (this.this$0.castPlayerFrag.isShowing() && this.this$0.slidingPanel.isExpanded()) {
            ...
            else if ((!Coppola1Utils.isCoppolaContext((Context)this.this$0) || DeviceUtils.isPortrait((Context)this.this$0)) && !this.this$0.netflixActionBar.isShowing()) {

...
public abstract class FragmentHostActivity extends NetflixActivity
{
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        this.contentHost = (LinearLayout)this.findViewById(2131427524);
        this.primaryFragContainer = (ViewGroup)this.findViewById(2131427525);
        this.secondaryFragContainer = (ViewGroup)this.findViewById(2131427526);
        if (bundle == null) {
            ...
            beginTransaction.add(2131427525, this.primaryFrag, "primary");
            if (this.secondaryFrag != null) {
                beginTransaction.add(2131427526, this.secondaryFrag, "secondary");
            }

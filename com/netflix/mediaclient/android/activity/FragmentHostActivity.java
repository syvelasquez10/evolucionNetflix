...
public abstract class FragmentHostActivity extends NetflixActivity
{
    ...
    private void setupMiniPlayerFrag(final Bundle bundle) {
        ...
        if (!BrowseExperience.shouldShowMemento((Context)this) || (BrowseExperience.shouldShowMemento((Context)this) && bundle == null)) {
            ...
            if (this.miniPlayerFrag != null) {
                beginTransaction.replace(2131689954, this.miniPlayerFrag, "mini_player");
            }
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        this.contentHost = (LinearLayout)this.findViewById(2131689742);
        this.primaryFragContainer = (ViewGroup)this.findViewById(2131689744);
        ...
        this.secondaryFragContainer = (ViewGroup)this.findViewById(2131689745);
        ...
        if (bundle == null) {
            ...
            final FragmentTransaction beginTransaction = this.getFragmentManager().beginTransaction();
            beginTransaction.add(2131689744, this.primaryFrag, "primary");
            if (this.secondaryFrag != null) {
                beginTransaction.add(2131689745, this.secondaryFrag, "secondary");
            }
            beginTransaction.commit();
        }
        else {

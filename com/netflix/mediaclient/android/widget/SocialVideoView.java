...
public class SocialVideoView extends VideoView
{
    ...
    private void drawConnectToFacebook(final Canvas canvas) {
        this.setImageResource(2130837569);
        super.onDraw(canvas);
    ...
    private void init() {
        ...
        this.singleImgSize = resources.getDimensionPixelOffset(2131361848);
        this.textSizeMicro = resources.getDimensionPixelOffset(2131361820);
        this.padding = resources.getDimensionPixelOffset(2131361818);
    ...
    private void initTextPaint(final Resources resources) {
        if (SocialVideoView.microSecondaryLeftPaint == null) {
            ...
            SocialVideoView.microSecondaryLeftPaint.setColor(resources.getColor(2131165217));
        ...
        if (SocialVideoView.microSecondaryCenterPaint == null) {
            ...
            SocialVideoView.microSecondaryCenterPaint.setColor(resources.getColor(2131165217));
            SocialVideoView.microSecondaryCenterPaint.setTextAlign(Paint$Align.CENTER);
        }
        if (SocialVideoView.smallPrimaryLeftPaint == null) {
            (SocialVideoView.smallPrimaryLeftPaint = new TextPaint()).setTextSize((float)resources.getDimensionPixelOffset(2131361821));
            SocialVideoView.smallPrimaryLeftPaint.setColor(resources.getColor(2131165216));
    ...
    protected void onSizeChanged(final int n, final int n2, final int n3, final int n4) {
        ...
        this.connectText = new StaticLayout((CharSequence)this.getResources().getString(2131493162), SocialVideoView.smallPrimaryLeftPaint, n - this.padding * 2, Layout$Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        this.socialGroupText = new StaticLayout((CharSequence)this.getResources().getString(2131493161), SocialVideoView.microSecondaryLeftPaint, n - this.padding * 2, Layout$Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
    }

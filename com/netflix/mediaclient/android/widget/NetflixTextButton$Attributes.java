...
class NetflixTextButton$Attributes
{
    ...
    NetflixTextButton$Attributes(Context obtainStyledAttributes, final int n) {
        ...
        obtainStyledAttributes = (Context)new ContextThemeWrapper(obtainStyledAttributes, n).obtainStyledAttributes(new int[] { 2130772270, 2130772272, 2130772273, 2130772274, 2130772275, 2130772271, 2130772276, 2130772277 });
        try {

...
public final class BuildConfig
{
    ...
    public static final String ANDROID_ENDPOINT_FULL = "/android/3.16/api";
    ...
    public static final String CRITTER_VERSION_NAME = "3.16.0";
    ...
    public static final int VERSION_CODE = 5294;
    public static final String VERSION_NAME = "3.16.0 build 5294";

...
public final class BuildConfig
{
    ...
    public static final String ANDROID_ENDPOINT_FULL = "/android/4.15/api";
    ...
    public static final String BUILD_DATE = "20170407";
    public static final String BUILD_TIME = "230950";
    ...
    public static final String CRITTER_VERSION_NAME = "4.15.1";
    ...
    public static final boolean INTERCEPT_EXCEPTIONS_FOR_DEBUGGING = true;
    ...
    public static final String MSL_APPBOOT_URL = "appboot.netflix.com";
    ...
    public static final int VERSION_CODE = 14947;
    public static final String VERSION_NAME = "4.15.1 build 14947";
    ...
    public static final boolean useHttpsForApiRequests = false;
}

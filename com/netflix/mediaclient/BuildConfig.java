...
public final class BuildConfig
{
    ...
    public static final String ANDROID_ENDPOINT_FULL = "/android/4.5/api";
    ...
    public static final String CRITTER_VERSION_NAME = "4.5.1";
    ...
    public static final int VERSION_CODE = 7734;
    public static final String VERSION_NAME = "4.5.1 build 7734";

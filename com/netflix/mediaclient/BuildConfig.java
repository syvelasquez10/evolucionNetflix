...
public final class BuildConfig
{
    ...
    public static final String ANDROID_ENDPOINT_FULL = "/android/3.15/api";
    ...
    public static final String CRITTER_VERSION_NAME = "3.15.0";
    ...
    public static final int VERSION_CODE = 5235;
    public static final String VERSION_NAME = "3.15.0 build 5235";

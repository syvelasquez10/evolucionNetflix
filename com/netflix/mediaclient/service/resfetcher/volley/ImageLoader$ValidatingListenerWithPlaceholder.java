...
class ImageLoader$ValidatingListenerWithPlaceholder extends ImageLoader$ValidatingListener
{
    ...
    public ImageLoader$ValidatingListenerWithPlaceholder(final ImageLoader this$0, final AdvancedImageView advancedImageView, final String s) {
        this.this$0 = this$0;
    ...
    protected void updateView(final ImageView imageView, final Bitmap bitmap) {
        if (bitmap == null) {
            this.this$0.setDrawableResource(imageView, 2130837574);
            return;
        }

...
class ResourceFetcher$1 implements Response$ErrorListener
{
    ...
    ResourceFetcher$1(final ResourceFetcher this$0, final ResourceFetcherCallback val$realCallback, final String val$resourceUrl) {
        this.this$0 = this$0;
    ...
    public void onErrorResponse(final VolleyError volleyError) {
        ...
        if (this.val$realCallback != null) {
            this.val$realCallback.onResourceFetched(this.val$resourceUrl, null, CommonStatus.NETWORK_ERROR);
        }
    }
}

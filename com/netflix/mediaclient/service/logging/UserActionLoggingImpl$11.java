...
class UserActionLoggingImpl$11 implements Runnable
{
    final /* synthetic */ UserActionLoggingImpl this$0;
    final /* synthetic */ DataContext val$dataContext;
    final /* synthetic */ UserActionLogging$Streams val$endStreams;
    final /* synthetic */ UIError val$error;
    final /* synthetic */ IClientLogging$CompletionReason val$reason;
    
    UserActionLoggingImpl$11(final UserActionLoggingImpl this$0, final IClientLogging$CompletionReason val$reason, final UIError val$error, final UserActionLogging$Streams val$endStreams, final DataContext val$dataContext) {
        this.this$0 = this$0;
        this.val$reason = val$reason;
        this.val$error = val$error;
        this.val$endStreams = val$endStreams;
    ...
    public void run() {
        ...
        if (this.this$0.mUpgradeStreamsSession == null) {
            Log.w("nf_log", "UpgradeStreams session does NOT exist!");
            return;
        }
        final UpgradeStreamsEndedEvent endedEvent = this.this$0.mUpgradeStreamsSession.createEndedEvent(this.val$reason, this.val$error, this.val$endStreams);
        if (endedEvent == null) {
            Log.d("nf_log", "User session still waits on session id, do not post at this time.");
            return;
        }
        this.this$0.populateEvent(endedEvent, this.val$dataContext, this.this$0.mUpgradeStreamsSession.getView());
        this.this$0.mEventHandler.removeSession(this.this$0.mUpgradeStreamsSession);
        Log.d("nf_log", "UpgradeStreams session end event posting...");
        this.this$0.mEventHandler.post(endedEvent);
        this.this$0.mUpgradeStreamsSession = null;

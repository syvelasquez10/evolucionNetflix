...
class UserActionLoggingImpl$1 implements Runnable
{
    ...
    UserActionLoggingImpl$1(final UserActionLoggingImpl this$0, final IClientLogging$CompletionReason val$reason, final UIError val$error, final IClientLogging$ModalView val$dest, final DataContext val$dataContext) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (this.this$0.mAcknowledgeSignup == null) {
            Log.w("nf_log", "AcknowledgeSignup session does NOT exist!");
            return;
        }
        final AcknowledgeSignupEndedEvent endedEvent = this.this$0.mAcknowledgeSignup.createEndedEvent(this.val$reason, this.val$error, this.val$dest);
        if (endedEvent == null) {
        ...
        this.this$0.mEventHandler.removeSession(this.this$0.mAcknowledgeSignup);
        Log.d("nf_log", "AcknowledgeSignup session end event posting...");
        this.this$0.mEventHandler.post(endedEvent);
        this.this$0.mAcknowledgeSignup = null;

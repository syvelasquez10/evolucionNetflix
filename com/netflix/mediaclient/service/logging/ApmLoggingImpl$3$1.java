...
class ApmLoggingImpl$3$1 implements Log$ResetSessionIdCallback
{
    final /* synthetic */ ApmLoggingImpl$3 this$1;
    final /* synthetic */ UserSessionStartedEvent val$ev;
    final /* synthetic */ UserSession val$us;
    
    ApmLoggingImpl$3$1(final ApmLoggingImpl$3 this$1, final UserSession val$us, final UserSessionStartedEvent val$ev) {
        this.this$1 = this$1;
        this.val$us = val$us;
        this.val$ev = val$ev;
    }
    ...
    public void sessionCreated(final String s) {
        this.this$1.this$0.mEventHandler.removeSession(this.this$1.this$0.mUserSession);
        this.this$1.this$0.mUserSession = this.val$us;
        this.val$us.setId(Long.valueOf(s));
        this.this$1.this$0.mNrdpLogSessionId = s;
        this.this$1.this$0.mEventHandler.addSession(this.this$1.this$0.mUserSession);
        final DeviceUniqueId id = this.val$us.getId();
        this.val$ev.setSessionId(id);
        this.this$1.this$0.sendUserSessionEvent(this.val$ev, this.this$1.val$dataContext, this.this$1.val$ui);
        ...
        if (pendingEndEvent != null) {
            ...
            this.this$1.this$0.mEventHandler.post(pendingEndEvent);

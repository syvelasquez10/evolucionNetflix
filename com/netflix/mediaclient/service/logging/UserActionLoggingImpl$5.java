...
class UserActionLoggingImpl$5 implements Runnable
{
    ...
    UserActionLoggingImpl$5(final UserActionLoggingImpl this$0, final IClientLogging$CompletionReason val$reason, final UIError val$error, final Integer val$rank, final int val$rating, final DataContext val$dataContext) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (this.this$0.mRateTitleSession == null) {
            Log.w("nf_log", "RateTitle session does NOT exist!");
            return;
        }
        final RateTitleEndedEvent endedEvent = this.this$0.mRateTitleSession.createEndedEvent(this.val$reason, this.val$error, this.val$rank, this.val$rating);
        if (endedEvent == null) {
            Log.d("nf_log", "RateTitle  session still waits on session id, do not post at this time.");
            return;
        }
        this.this$0.populateEvent(endedEvent, this.val$dataContext, this.this$0.mRateTitleSession.getView());
        this.this$0.mEventHandler.removeSession(this.this$0.mRateTitleSession);
        Log.d("nf_log", "RateTitle session end event posting...");
        this.this$0.mEventHandler.post(endedEvent);
        this.this$0.mRateTitleSession = null;

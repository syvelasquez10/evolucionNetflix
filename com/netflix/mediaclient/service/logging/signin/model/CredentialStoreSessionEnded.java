...
public class CredentialStoreSessionEnded extends SessionEndedEvent
{
    ...
    public CredentialStoreSessionEnded(final IClientLogging$CompletionReason mCompletionReason, final Error mError, final SignInLogging$CredentialService mCredentialService) {

...
public final class RemoveCachedVideoSessionEndedEvent extends BaseUIActionSessionEndedEvent
{
    ...
    public RemoveCachedVideoSessionEndedEvent(final DeviceUniqueId deviceUniqueId, final long n, final String oxid, final IClientLogging$ModalView clientLogging$ModalView, final UserActionLogging$CommandName userActionLogging$CommandName, final IClientLogging$CompletionReason clientLogging$CompletionReason, final UIError uiError) {
        super("RemoveCachedVideo", deviceUniqueId, n, clientLogging$ModalView, userActionLogging$CommandName, clientLogging$CompletionReason, uiError);
    ...
    public RemoveCachedVideoSessionEndedEvent(final JSONObject jsonObject) {
        super(jsonObject);
        if (jsonObject != null) {

...
class ApmLoggingImpl$20 implements Runnable
{
    ...
    ApmLoggingImpl$20(final ApmLoggingImpl this$0, final DataContext val$dataContext, final IClientLogging$ModalView val$ui) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        this.this$0.handleEndedNetworkConnectionSession("mobileNetworkConnection", this.val$dataContext, this.val$ui);

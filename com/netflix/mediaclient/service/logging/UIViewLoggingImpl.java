...
public class UIViewLoggingImpl implements UIViewLogging
{
    ...
    public void endCommandSession() {
        ...
        this.mEventHandler.executeInBackground(new UIViewLoggingImpl$1(this, this.mDataContext));
    ...
    public void endImpressionSession(final boolean b, final Error error) {
        ...
        this.mEventHandler.executeInBackground(new UIViewLoggingImpl$2(this, b, error, this.mDataContext));

...
class UserActionLoggingImpl$10 implements Runnable
{
    final /* synthetic */ UserActionLoggingImpl this$0;
    final /* synthetic */ DataContext val$dataContext;
    final /* synthetic */ UIError val$error;
    final /* synthetic */ JSONObject val$errorCode;
    final /* synthetic */ UserActionLogging$PaymentType val$paymentType;
    final /* synthetic */ IClientLogging$CompletionReason val$reason;
    final /* synthetic */ boolean val$success;
    
    UserActionLoggingImpl$10(final UserActionLoggingImpl this$0, final IClientLogging$CompletionReason val$reason, final UIError val$error, final boolean val$success, final UserActionLogging$PaymentType val$paymentType, final JSONObject val$errorCode, final DataContext val$dataContext) {
        this.this$0 = this$0;
        this.val$reason = val$reason;
        this.val$error = val$error;
        this.val$success = val$success;
        this.val$paymentType = val$paymentType;
    ...
    public void run() {
        ...
        if (this.this$0.mSubmitPaymentSession == null) {
            Log.w("nf_log", "SubmitPayment session does NOT exist!");
            return;
        }
        final SubmitPaymentEndedEvent endedEvent = this.this$0.mSubmitPaymentSession.createEndedEvent(this.val$reason, this.val$error, this.val$success, this.val$paymentType, this.val$errorCode);
        if (endedEvent == null) {
            Log.d("nf_log", "SubmitPayment session still waits on session id, do not post at this time.");
            return;
        }
        this.this$0.populateEvent(endedEvent, this.val$dataContext, this.this$0.mSubmitPaymentSession.getView());
        this.this$0.mEventHandler.removeSession(this.this$0.mSubmitPaymentSession);
        Log.d("nf_log", "SubmitPayment session end event posting...");
        this.this$0.mEventHandler.post(endedEvent);
        this.this$0.mSubmitPaymentSession = null;

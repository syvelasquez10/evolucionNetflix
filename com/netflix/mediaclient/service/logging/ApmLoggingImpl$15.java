...
class ApmLoggingImpl$15 implements Runnable
{
    ...
    ApmLoggingImpl$15(final ApmLoggingImpl this$0, final DataContext val$dataContext, final IClientLogging$ModalView val$ui) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        this.this$0.handleStartNetworkConnectionSession(new WiredNetworkConnectionSession(), this.val$dataContext, this.val$ui);

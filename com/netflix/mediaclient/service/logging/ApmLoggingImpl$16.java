...
class ApmLoggingImpl$16 implements Runnable
{
    ...
    ApmLoggingImpl$16(final ApmLoggingImpl this$0, final DataContext val$dataContext, final IClientLogging$ModalView val$ui) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        this.this$0.handleEndedNetworkConnectionSession("wiredNetworkConnection", this.val$dataContext, this.val$ui);

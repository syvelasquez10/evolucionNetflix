...
class UserActionLoggingImpl$3 implements Runnable
{
    ...
    UserActionLoggingImpl$3(final UserActionLoggingImpl this$0, final IClientLogging$CompletionReason val$reason, final UIError val$error, final DataContext val$dataContext) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (this.this$0.mLoginSession == null) {
            Log.w("nf_log", "Login session does NOT exist!");
            return;
        }
        final LoginEndedEvent endedEvent = this.this$0.mLoginSession.createEndedEvent(this.val$reason, this.val$error);
        if (endedEvent == null) {
            Log.d("nf_log", "Login session still waits on session id, do not post at this time.");
            return;
        }
        this.this$0.populateEvent(endedEvent, this.val$dataContext, this.this$0.mLoginSession.getView());
        this.this$0.mEventHandler.removeSession(this.this$0.mLoginSession);
        Log.d("nf_log", "Login session end event posting...");
        this.this$0.mEventHandler.post(endedEvent);
        this.this$0.mLoginSession = null;

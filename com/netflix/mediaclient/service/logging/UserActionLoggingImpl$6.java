...
class UserActionLoggingImpl$6 implements Runnable
{
    ...
    UserActionLoggingImpl$6(final UserActionLoggingImpl this$0, final IClientLogging$CompletionReason val$reason, final UIError val$error, final DataContext val$dataContext) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (this.this$0.mRegisterSession == null) {
            Log.w("nf_log", "Register session does NOT exist!");
            return;
        }
        final RegisterEndedEvent endedEvent = this.this$0.mRegisterSession.createEndedEvent(this.val$reason, this.val$error);
        if (endedEvent == null) {
            Log.d("nf_log", "Register session still waits on session id, do not post at this time.");
            return;
        }
        this.this$0.populateEvent(endedEvent, this.val$dataContext, this.this$0.mRegisterSession.getView());
        this.this$0.mEventHandler.removeSession(this.this$0.mRegisterSession);
        Log.d("nf_log", "Register session end event posting...");
        this.this$0.mEventHandler.post(endedEvent);
        this.this$0.mRegisterSession = null;

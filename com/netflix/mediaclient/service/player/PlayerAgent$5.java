...
class PlayerAgent$5 extends SimpleUserAgentWebCallback
{
    ...
    public void onDummyWebCallDone(final Status status) {
        ...
        if (status.isSucces()) {
            ...
            final NccpError access$4400 = this.this$0.mActionId12Error;
            this.this$0.mActionId12Error = null;
            this.this$0.handlePlayerListener(this.this$0.mPlayerListenerManager.getPlayerListenerRestartPlaybackHandler(), access$4400);
            return;
        }
        if (Log.isLoggable()) {

...
{
    protected MasterIndex mMasterIndex;
    protected SegmentIndex[] mSegmentIndexes;
    
    public ImageSubtitleParser(final IPlayer player, final SubtitleUrl subtitleUrl, final long n, final SubtitleParser$DownloadFailedCallback subtitleParser$DownloadFailedCallback, final long n2) {
    ...
    private void downloadSegment(final SegmentIndex segmentIndex) {
        ...
        this.getResourceFetcher().fetchResource(this.mSubtitleData.getDownloadUrl(), IClientLogging$AssetType.imageSubtitlesSegment, segmentIndex.getSegmentStartPosition(), segmentIndex.getSegmentSize(), new ImageSubtitleParser$3(this, segmentIndex));
    }
    ...
    private void handleDownloadMasterIndex() {
        ...
        this.getResourceFetcher().fetchResource(this.mSubtitleData.getDownloadUrl(), IClientLogging$AssetType.imageSubtitlesMasterIndex, this.mSubtitleData.getMasterIndexOffset(), this.mSubtitleData.getMasterIndexSize(), new ImageSubtitleParser$1(this, nameServers));
    }
    ...
    private void handleDownloadSegmentIndexes() {
        ...
        this.getResourceFetcher().fetchResource(this.mSubtitleData.getDownloadUrl(), IClientLogging$AssetType.imageSubtitlesSegmentIndex, this.mMasterIndex.getStartOffset(), segmentIndexesSize, new ImageSubtitleParser$2(this, segmentIndexesSize));
    }
    ...
    protected boolean parseMasterIndex(final byte[] p0) {
        // 
    ...
    protected void parseSegment(final byte[] array, final SegmentIndex segmentIndex) {
        if (array == null) {
    ...
    protected void parseSegmentIndexes(final byte[] array, int i) {
        final int n = 0;
        if (array == null) {

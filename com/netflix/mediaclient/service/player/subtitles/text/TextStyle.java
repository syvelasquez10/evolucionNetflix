...
public class TextStyle
{
    ...
    public static TextStyle createInstanceFromContainer(final Element element, final TextSubtitleParser textSubtitleParser, final TextStyle textStyle) {
        if (element == null) {
        ...
        if (textStyle2.mParentStyleId != null) {
            ...
            final TextStyle namedStyle = textSubtitleParser.getNamedStyle(textStyle2.mParentStyleId);
            if (namedStyle != null) {
                if (Log.isLoggable()) {

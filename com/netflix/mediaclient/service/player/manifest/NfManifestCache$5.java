...
class NfManifestCache$5 implements Runnable
{
    final /* synthetic */ NfManifestCache this$0;
    
    NfManifestCache$5(final NfManifestCache this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        this.this$0.mManifestMap.clear();
        this.this$0.mPendingMovies.clear();
        this.this$0.mPriorityList.clear();
    }
}

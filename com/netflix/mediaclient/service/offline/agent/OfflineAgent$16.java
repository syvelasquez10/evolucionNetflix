...
class OfflineAgent$16 implements Runnable
{
    ...
    OfflineAgent$16(final OfflineAgent this$0, final long val$movieId, final OfflinePlaybackInterface$ManifestCallback val$callback) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (offlineViewableByPlayableId != null) {
            offlineViewableByPlayableId.requestManifestForPlayback(new OfflineAgent$16$1(this));
            return;
        }

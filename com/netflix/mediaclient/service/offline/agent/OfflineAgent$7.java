...
class OfflineAgent$7 implements Runnable
{
    final /* synthetic */ OfflineAgent this$0;
    final /* synthetic */ List val$playableIdList;
    
    OfflineAgent$7(final OfflineAgent this$0, final List val$playableIdList) {
        this.this$0 = this$0;
    ...
    @Override
    public void run() {
        for (int i = 0; i < this.val$playableIdList.size(); ++i) {
            RealmUtils.removeRecordsForPlayable((Context)this.this$0.getService(), this.this$0.getRealm(), (String)this.val$playableIdList.get(i));
        }
    }
}

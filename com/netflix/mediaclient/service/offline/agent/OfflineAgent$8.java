...
class OfflineAgent$8 implements Runnable
{
    final /* synthetic */ OfflineAgent this$0;
    final /* synthetic */ List val$realmPlayableIdsToDelete;
    
    OfflineAgent$8(final OfflineAgent this$0, final List val$realmPlayableIdsToDelete) {
        this.this$0 = this$0;
        this.val$realmPlayableIdsToDelete = val$realmPlayableIdsToDelete;
    }
    
    @Override
    public void run() {
        final Iterator<String> iterator = this.val$realmPlayableIdsToDelete.iterator();
        while (iterator.hasNext()) {
            RealmUtils.removeRecordsForPlayable((Context)this.this$0.getService(), this.this$0.getRealm(), iterator.next());
        }
    }
}

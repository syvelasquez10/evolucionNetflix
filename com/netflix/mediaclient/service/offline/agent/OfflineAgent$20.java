...
class OfflineAgent$20 extends SimpleBrowseAgentCallback
{
    final /* synthetic */ OfflineAgent this$0;
    final /* synthetic */ UserProfile val$curProfile;
    final /* synthetic */ String val$playableId;
    
    OfflineAgent$20(final OfflineAgent this$0, final UserProfile val$curProfile, final String val$playableId) {
        this.this$0 = this$0;
    ...
    public void onEpisodeDetailsFetched(final EpisodeDetails episodeDetails, final Status status) {
        ...
        if (status.isError()) {
            ...
            RealmVideoDetails.insertInRealm(this.this$0.mRealm, this.this$0.getService(), episodeDetails, this.val$curProfile.getProfileGuid());
            OfflineAgentHelper.updateBookmarkIfNewer(this.val$playableId, episodeDetails, this.val$curProfile.getProfileGuid());
            final String showId = episodeDetails.getShowId();
            if (RealmUtils.idNotExists(this.this$0.mRealm, RealmVideoDetails.class, showId)) {
                this.this$0.getBrowseAgent().fetchShowDetailsAndSeasons(showId, this.val$playableId, false, false, new OfflineAgent$20$1(this));
            }
        }
    }
}

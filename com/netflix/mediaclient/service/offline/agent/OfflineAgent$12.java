...
class OfflineAgent$12 implements Runnable
{
    final /* synthetic */ OfflineAgent this$0;
    final /* synthetic */ Map val$videoIdToProfileList;
    
    OfflineAgent$12(final OfflineAgent this$0, final Map val$videoIdToProfileList) {
        this.this$0 = this$0;
        this.val$videoIdToProfileList = val$videoIdToProfileList;
    }
    
    @Override
    public void run() {
        Log.i("nf_offlineAgent", "buildNewUiList now in main.. regenerate");
        this.this$0.mOfflinePlayableUiList.regenerate(this.this$0.mRealm, this.val$videoIdToProfileList, this.this$0.mSkipAdultContent);
    }
}

...
class OfflineAgent$27 extends SimpleBrowseAgentCallback
{
    final /* synthetic */ OfflineAgent this$0;
    final /* synthetic */ Runnable val$callback;
    final /* synthetic */ String val$profileId;
    
    OfflineAgent$27(final OfflineAgent this$0, final String val$profileId, final Runnable val$callback) {
        this.this$0 = this$0;
    ...
    public void onMovieDetailsFetched(final MovieDetails movieDetails, final Status status) {
        ...
        if (status.isError() || movieDetails == null) {
            ...
            this.this$0.getService().getBookmarkStore().createOrUpdateBookmark(movieDetails, this.val$profileId);

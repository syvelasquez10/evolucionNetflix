...
class OfflineAgent$26 implements Runnable
{
    ...
    OfflineAgent$26(final OfflineAgent this$0, final OfflinePlaybackInterface$OfflineManifest val$offlineManifest, final OfflinePlaybackInterface$ManifestCallback val$callback, final long val$movieId, final Status val$status) {
        this.this$0 = this$0;

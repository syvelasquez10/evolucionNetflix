...
class OfflineAgent$19 implements OfflineStorageMonitor$StorageChangeListener
{
    final /* synthetic */ OfflineAgent this$0;
    
    OfflineAgent$19(final OfflineAgent this$0) {
        this.this$0 = this$0;
    }
    ...
    public void onStorageAddedOrRemoved() {
        ...
        while (true) {
            try {
                final boolean access$4600 = this.this$0.stopAllDownloads(StopReason.WaitingToBeStarted);

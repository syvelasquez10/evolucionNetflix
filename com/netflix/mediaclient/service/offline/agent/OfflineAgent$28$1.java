...
class OfflineAgent$28$1 extends SimpleBrowseAgentCallback
{
    final /* synthetic */ OfflineAgent$28 this$1;
    final /* synthetic */ EpisodeDetails val$episodeDetails;
    
    OfflineAgent$28$1(final OfflineAgent$28 this$1, final EpisodeDetails val$episodeDetails) {
        this.this$1 = this$1;
    ...
    public void onShowDetailsAndSeasonsFetched(final ShowDetails showDetails, final List<SeasonDetails> list, final Status status) {
        ...
        if (status.isError() || showDetails == null) {
            ...
            this.this$1.this$0.getService().getBookmarkStore().createOrUpdateBookmark(this.val$episodeDetails, this.this$1.val$profileId);

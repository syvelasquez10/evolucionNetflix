...
public class OfflineAgentListenerHelper
{
    ...
    public void addOfflineAgentListener(final Handler handler, final OfflineAgentListener offlineAgentListener) {
        if (handler != null && offlineAgentListener != null) {
            ...
            handler.post((Runnable)new OfflineAgentListenerHelper$11(this, offlineAgentListener));
        }
    }
    ...
    public void onAllPlayablesDeleted(final Handler handler, final Status status) {
        if (Log.isLoggable()) {
            Log.i("nf_offlineAgent", "sendAllDeleted status=" + status);
        }
        handler.post((Runnable)new OfflineAgentListenerHelper$7(this, status));
    }
    ...
    public void onDownloadCompleted(final Handler handler, final OfflinePlayableViewData offlinePlayableViewData) {
        if (Log.isLoggable()) {
            Log.i("nf_offlineAgent", "sendDownloadCompleted playableId=" + offlinePlayableViewData.getPlayableId());
        }
    ...
    public void onDownloadResumedByUser(final Handler handler, final OfflinePlayableViewData offlinePlayableViewData) {
        if (Log.isLoggable()) {
            Log.i("nf_offlineAgent", "sendDownloadResumedByUser playableId=" + offlinePlayableViewData.getPlayableId());
        }
    ...
    public void onDownloadStopped(final Handler handler, final OfflinePlayableViewData offlinePlayableViewData, final StopReason stopReason) {
        if (Log.isLoggable()) {
            Log.i("nf_offlineAgent", "sendDownloadStopped playableId=" + offlinePlayableViewData.getPlayableId());
        }
    ...
    public void onLicenseRefreshDone(final Handler handler, final OfflinePlayableViewData offlinePlayableViewData, final Status status) {
        ...
        handler.post((Runnable)new OfflineAgentListenerHelper$9(this, offlinePlayableViewData, status));
    }
    
    public void onOfflinePlayableDeleted(final Handler handler, final String s, final Status status) {
        if (Log.isLoggable()) {
            Log.i("nf_offlineAgent", "sendDownloadDeleted playableId=" + s + " Status=" + status);
        }
    ...
    public void removeOfflineAgentListener(final Handler handler, final OfflineAgentListener offlineAgentListener) {
        if (handler != null && offlineAgentListener != null) {
            ...
            handler.post((Runnable)new OfflineAgentListenerHelper$12(this, offlineAgentListener));
        }
    }

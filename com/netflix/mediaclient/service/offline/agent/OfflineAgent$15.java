...
class OfflineAgent$15 implements Runnable
{
    ...
    OfflineAgent$15(final OfflineAgent this$0, final String val$playableId) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (offlineViewableByPlayableId != null) {
            offlineViewableByPlayableId.refreshLicenseIfNeeded(IBladeRunnerClient$OfflineRefreshInvoke.USER, new OfflineAgent$15$1(this, offlineViewableByPlayableId));
        }
    }
}

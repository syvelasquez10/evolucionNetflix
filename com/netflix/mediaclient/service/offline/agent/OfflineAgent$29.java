...
class OfflineAgent$29 implements OfflineLicenseManager$LicenseSyncResponseCallback
{
    final /* synthetic */ OfflineAgent this$0;
    
    OfflineAgent$29(final OfflineAgent this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void onLicenseSyncDone(final Map<String, ClientActionFromLase> map, final Status status) {
        Log.i("nf_offlineAgent", "onLicenseSyncDone res=%s", status);
        if (map != null) {
            for (final Map.Entry<String, ClientActionFromLase> entry : map.entrySet()) {
                final OfflinePlayable offlineViewableByPlayableId = OfflineAgentHelper.getOfflineViewableByPlayableId(entry.getKey(), this.this$0.mOfflinePlayableList);
                if (offlineViewableByPlayableId != null) {
                    offlineViewableByPlayableId.onLicenseSync(entry.getValue());
                }
            }
        }
    }

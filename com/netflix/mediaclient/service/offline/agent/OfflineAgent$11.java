...
class OfflineAgent$11 implements Runnable
{
    final /* synthetic */ OfflineAgent this$0;
    final /* synthetic */ String val$playableId;
    
    OfflineAgent$11(final OfflineAgent this$0, final String val$playableId) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (offlineViewableByPlayableId != null) {
            offlineViewableByPlayableId.refreshLicenseIfNeeded(IBladeRunnerClient$OfflineRefreshInvoke.USER, new OfflineAgent$11$1(this, offlineViewableByPlayableId));
        }
    }
}

...
class OfflineAgentListenerHelper$3 implements Runnable
{
    final /* synthetic */ OfflineAgentListenerHelper this$0;
    final /* synthetic */ OfflinePlayableViewData val$offlinePlayableViewData;
    
    OfflineAgentListenerHelper$3(final OfflineAgentListenerHelper this$0, final OfflinePlayableViewData val$offlinePlayableViewData) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        while (iterator.hasNext()) {
            iterator.next().onDownloadCompleted(this.val$offlinePlayableViewData);
        }
    }
}

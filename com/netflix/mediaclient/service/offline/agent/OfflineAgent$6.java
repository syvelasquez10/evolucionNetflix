...
class OfflineAgent$6 implements Runnable
{
    final /* synthetic */ OfflineAgent this$0;
    final /* synthetic */ String val$playableId;
    
    OfflineAgent$6(final OfflineAgent this$0, final String val$playableId) {
        this.this$0 = this$0;
    ...
    @Override
    public void run() {
        RealmUtils.removeRecordsForPlayable((Context)this.this$0.getService(), this.this$0.getRealm(), this.val$playableId);
    }
}

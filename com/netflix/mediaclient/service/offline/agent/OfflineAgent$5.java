...
class OfflineAgent$5 implements Runnable
{
    final /* synthetic */ OfflineAgent this$0;
    final /* synthetic */ Map val$geoPlayabilityResult;
    
    OfflineAgent$5(final OfflineAgent this$0, final Map val$geoPlayabilityResult) {
        this.this$0 = this$0;
    ...
    @Override
    public void run() {
        this.this$0.handleGeoPlayabilityUpdated(this.val$geoPlayabilityResult);
    }
}

...
class OfflineAgent$28 extends SimpleBrowseAgentCallback
{
    ...
    OfflineAgent$28(final OfflineAgent this$0, final String val$playableId, final String val$profileId, final Runnable val$callback) {
        this.this$0 = this$0;
    ...
    public void onEpisodeDetailsFetched(final EpisodeDetails episodeDetails, final Status status) {
        ...
        if (status.isError() || episodeDetails == null) {
            ...
            if (RealmUtils.idNotExists(this.this$0.mRealm, RealmVideoDetails.class, showId)) {
                this.this$0.getBrowseAgent().fetchShowDetailsAndSeasons(showId, this.val$playableId, false, false, new OfflineAgent$28$1(this, episodeDetails));
                return;
            }
            ...
            this.this$0.getService().getBookmarkStore().createOrUpdateBookmark(episodeDetails, this.val$profileId);

...
class OfflinePlayableImpl$11 implements OfflineLicenseManagerCallback
{
    ...
    OfflinePlayableImpl$11(final OfflinePlayableImpl this$0, final OfflineAgentInterface$PlayableRefreshLicenseCallBack val$callback) {
        this.this$0 = this$0;
    ...
    public void onOfflineLicenseRequestDone(final String s, final OfflineLicenseResponse offlineLicenseResponse, final Status status) {
        Log.i("nf_offlinePlayable", "onOfflineLicenseRequestDone status= %s", status);

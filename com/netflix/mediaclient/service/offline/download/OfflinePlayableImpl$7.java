...
class OfflinePlayableImpl$7 implements OfflineManifestCallback
{
    final /* synthetic */ OfflinePlayableImpl this$0;
    
    OfflinePlayableImpl$7(final OfflinePlayableImpl this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void onOfflineManifestResponse(final NfManifest nfManifest, final Status status) {
        this.this$0.handleManifestRefreshedFromServer(nfManifest, status);
    }
}

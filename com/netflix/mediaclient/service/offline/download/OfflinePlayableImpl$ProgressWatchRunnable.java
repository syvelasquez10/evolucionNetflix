...
class OfflinePlayableImpl$ProgressWatchRunnable implements Runnable
{
    final /* synthetic */ OfflinePlayableImpl this$0;
    
    private OfflinePlayableImpl$ProgressWatchRunnable(final OfflinePlayableImpl this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        this.this$0.onProgressWatchRunnable();
    }
}

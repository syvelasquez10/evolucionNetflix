...
class OfflinePlayableImpl$8 implements OfflineManifestCallback
{
    ...
    final /* synthetic */ IBladeRunnerClient$OfflineRefreshInvoke val$invokedFrom;
    
    OfflinePlayableImpl$8(final OfflinePlayableImpl this$0, final IBladeRunnerClient$OfflineRefreshInvoke val$invokedFrom, final OfflineAgentInterface$PlayableRefreshLicenseCallBack val$callback) {
        this.this$0 = this$0;
        this.val$invokedFrom = val$invokedFrom;
    ...
    public void onOfflineManifestResponse(final NfManifest nfManifest, final Status status) {
        if (status.isSucces()) {
            this.this$0.refreshLicense(this.val$invokedFrom, nfManifest, this.val$callback);
        }
        else if (this.val$callback != null) {
            this.val$callback.onLicenseRefreshDone(status);
        }
    }
}

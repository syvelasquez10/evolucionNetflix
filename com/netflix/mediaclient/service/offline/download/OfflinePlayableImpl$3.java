...
class OfflinePlayableImpl$3 implements OfflineManifestCallback
{
    final /* synthetic */ OfflinePlayableImpl this$0;
    
    OfflinePlayableImpl$3(final OfflinePlayableImpl this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void onOfflineManifestResponse(final NfManifest nfManifest, final Status status) {
        if (status.isError() || OfflineUtils.hasManifestExpired(nfManifest) || this.this$0.hasManifestNetworkChanged()) {
            this.this$0.refreshManifestFromServerAndContinue();
            return;
        }
        this.this$0.handleManifestUpdated(nfManifest);
    }
}

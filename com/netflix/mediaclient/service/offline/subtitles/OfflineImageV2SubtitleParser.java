...
import com.netflix.mediaclient.service.player.subtitles.ImageV2SubtitleParser;
...
public class OfflineImageV2SubtitleParser extends ImageV2SubtitleParser implements OfflineSubtitleParser
{
    ...
    public OfflineImageV2SubtitleParser(final IPlayer player, final OfflineImageSubtitle mSubtitle, final long n, final SubtitleParser$DownloadFailedCallback subtitleParser$DownloadFailedCallback, final long n2) {
    ...
    protected String getCacheName() {
        ...
        // 
        //     0: aload_0        
        //     1: getfield        com/netflix/mediaclient/service/offline/subtitles/OfflineImageV2SubtitleParser.mPlayer:Lcom/netflix/mediaclient/servicemgr/IPlayer;
        ...
        //    39: aload_0        
        //    40: getfield        com/netflix/mediaclient/service/offline/subtitles/OfflineImageV2SubtitleParser.mSubtitle:Lcom/netflix/mediaclient/ui/offline/OfflineImageSubtitle;
        ...
        //    60: aload_0        
        //    61: getfield        com/netflix/mediaclient/service/offline/subtitles/OfflineImageV2SubtitleParser.mSubtitle:Lcom/netflix/mediaclient/ui/offline/OfflineImageSubtitle;
        ...
        //    75: aload_0        
        //    76: getfield        com/netflix/mediaclient/service/offline/subtitles/OfflineImageV2SubtitleParser.mSubtitle:Lcom/netflix/mediaclient/ui/offline/OfflineImageSubtitle;
        ...
        //   128: pop            
        //   129: aload_0        
        //   130: getfield        com/netflix/mediaclient/service/offline/subtitles/OfflineImageV2SubtitleParser.mPlayer:Lcom/netflix/mediaclient/servicemgr/IPlayer;
    ...
    protected boolean handleImport() {
        ...
        if (this.importSegmentIndex()) {
            ...
            for (ISCSegment[] mSegmentIndexContainers = this.mSegmentIndexContainers; i < mSegmentIndexContainers.length; ++i) {
                this.importSegment(mSegmentIndexContainers[i]);
            }
            return true;
        }
    ...
    protected boolean importMasterIndex() {
        ...
        try {
            Log.d("nf_subtitles_imv2", "Reading master index file from downloaded file %s from position %d for %d bytes.", this.mSubtitleFile.getAbsolutePath(), this.mSubtitle.getMasterIndexOffset(), this.mSubtitle.getMasterIndexSize());
            final boolean masterIndexContainer = this.parseMasterIndexContainer(FileUtils.readBytesFromFile(this.mSubtitleFile, this.mSubtitle.getMasterIndexOffset(), this.mSubtitle.getMasterIndexSize()));
            Log.d("nf_subtitles_imv2", "Loading master index file from cache %s was success %b", this.mSubtitleFile.getAbsolutePath(), masterIndexContainer);
    ...
    protected boolean importSegment(final ISCSegment iscSegment) {
        try {
            Log.d("nf_subtitles_imv2", "Reading segment file from cache %s", this.mSubtitleFile.getAbsolutePath());
            this.parseSegment(FileUtils.readBytesFromFile(this.mSubtitleFile, (int)iscSegment.getSegmentIndex().getSegmentStartPosition(), (int)iscSegment.getSegmentIndex().getSegmentSize()), iscSegment.getSegmentIndex(), this.mSubtitleData.getDownloadUrl(), this.mSubtitleData.getDecryptionKey());
    ...
    protected boolean importSegmentIndex() {
        try {
            ...
            this.parseSegmentIndexes(FileUtils.readBytesFromFile(this.mSubtitleFile, (int)this.mMasterIndexContainer.getMasterIndex().getSegmentOffset(), segmentIndexesSize), segmentIndexesSize);

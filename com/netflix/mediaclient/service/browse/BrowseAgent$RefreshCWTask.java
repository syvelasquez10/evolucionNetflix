...
class BrowseAgent$RefreshCWTask extends BrowseAgent$FetchTask<Void>
{
    final /* synthetic */ BrowseAgent this$0;
    private final BrowseAgentCallback webClientCallback;
    
    public BrowseAgent$RefreshCWTask(final BrowseAgent this$0) {
        this.this$0 = this$0;
        super("refreshCW", BrowseAgent.mPrefetchFromCWVideo, BrowseAgent.mPrefetchToCWVideo, null);
        this.webClientCallback = new BrowseAgent$RefreshCWTask$1(this);
    }
    
    @Override
    public void run() {
        if (this.this$0.mCache.canRefreshCW() && this.this$0.mCache.cacheHasLolomoId()) {
            this.this$0.mBrowseWebClient.refreshCWList(this.getFromIndex(), this.getToIndex(), this.webClientCallback);
            return;
        }

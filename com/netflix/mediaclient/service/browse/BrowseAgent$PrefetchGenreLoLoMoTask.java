...
class BrowseAgent$PrefetchGenreLoLoMoTask extends BrowseAgent$FetchTask<Void>
{
    ...
    public BrowseAgent$PrefetchGenreLoLoMoTask(final BrowseAgent this$0, final String s, final int mFromLoMo, final int mToLoMo, final int n, final int n2, final BrowseAgentCallback browseAgentCallback) {
        this.this$0 = this$0;
    ...
    @Override
    public void run() {
        this.this$0.mBrowseWebClient.prefetchGenreLoLoMo(this.getCategory(), this.mFromLoMo, this.mToLoMo, this.getFromIndex(), this.getToIndex(), this.webClientCallback);
    }
}

...
class BrowseAgent$FetchGenreVideosTask extends BrowseAgent$CachedFetchTask<List<Video>>
{
    ...
    public BrowseAgent$FetchGenreVideosTask(final BrowseAgent this$0, final LoMo lomo, final int n, final int n2, final boolean includeKubrick, final BrowseAgentCallback browseAgentCallback) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (list == null) {
            this.this$0.mBrowseWebClient.fetchGenreVideos(this.lomo, this.getFromIndex(), this.getToIndex(), this.includeKubrick, this.webClientCallback);
            return;
        }

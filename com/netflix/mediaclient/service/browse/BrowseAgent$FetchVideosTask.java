...
class BrowseAgent$FetchVideosTask extends BrowseAgent$CachedFetchTask<List<Video>>
{
    ...
    public BrowseAgent$FetchVideosTask(final BrowseAgent this$0, final LoMo lomo, final int n, final int n2, final BrowseAgentCallback browseAgentCallback, final boolean b) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (list == null) {
            this.this$0.mBrowseWebClient.fetchVideos(this.lomo, this.getFromIndex(), this.getToIndex(), this.webClientCallback);
            return;
        }

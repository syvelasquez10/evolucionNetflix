...
class BrowseAgent$3 extends SimpleBrowseAgentCallback
{
    ...
    public void onSocialNotificationsListFetched(final SocialNotificationsList list, final Status status) {
        ...
        if (list != null && status.getStatusCode() == StatusCode.OK) {
            ...
            final SocialNotificationSummary access$3500 = this.this$0.getFirstUnreadNotification(list);
            final BrowseAgent this$0 = this.this$0;
            if (access$3500 != null) {
                b = true;
            }
            this$0.notifyOthersOfUnreadNotifications(b);
            if (this.val$sendNotificationToStatusbar && access$3500 != null && !NetflixApplication.isActivityVisible() && SocialNotificationsUtils.isSocialNotificationsFeatureSupported(this.this$0.getService().getCurrentProfile(), this.this$0.getContext()) && this.this$0.getService().getPushNotification().isOptIn()) {
                SocialNotificationsStaticFactory.getNotificationByType(access$3500.getType()).sendNotificationToStatusbar(access$3500, list.getSocialNotificationsListSummary(), this.this$0.getService().getImageLoader(), this.val$msg, this.this$0.getContext());
            }
        }
    }
}

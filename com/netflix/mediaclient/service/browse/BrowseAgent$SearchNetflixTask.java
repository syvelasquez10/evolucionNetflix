...
class BrowseAgent$SearchNetflixTask extends BrowseAgent$CachedFetchTask<ISearchResults>
{
    ...
    public BrowseAgent$SearchNetflixTask(final BrowseAgent this$0, final String s, final BrowseAgentCallback callback) {
        this.this$0 = this$0;
        super(this$0, s, 0, 0, callback);
        this.webClientCallback = new BrowseAgent$SearchNetflixTask$1(this);
    ...
    @Override
    public void run() {
        final ISearchResults searchResults = this.getCachedValue();
        if (searchResults == null) {
            ProfileType profileType = ProfileType.STANDARD;
            final UserProfile currentProfile = this.this$0.getUserAgent().getCurrentProfile();
            if (currentProfile != null) {
                profileType = currentProfile.getProfileType();
            }
            this.this$0.mBrowseWebClient.searchNetflix(this.query, profileType, this.webClientCallback);
            return;
        }

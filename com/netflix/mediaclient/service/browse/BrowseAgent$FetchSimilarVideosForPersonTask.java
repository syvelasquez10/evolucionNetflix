...
class BrowseAgent$FetchSimilarVideosForPersonTask extends BrowseAgent$CachedFetchTask<SearchVideoListProvider>
{
    ...
    public BrowseAgent$FetchSimilarVideosForPersonTask(final BrowseAgent this$0, final String s, final int n, final BrowseAgentCallback browseAgentCallback, final String originalSearchTerm) {
        this.this$0 = this$0;
        super(this$0, s, 0, n, browseAgentCallback);
        this.webClientCallback = new BrowseAgent$FetchSimilarVideosForPersonTask$1(this);
    ...
    public void run() {
        ...
        if (searchVideoListProvider == null) {
            this.this$0.mBrowseWebClient.fetchSimilarVideosForPerson(this.getCategory(), this.getToIndex(), this.webClientCallback, this.originalSearchTerm);
            return;
        }

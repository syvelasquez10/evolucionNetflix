...
class BrowseAgent$FetchBillboardVideosTask$1$1 implements Runnable
{
    final /* synthetic */ BrowseAgent$FetchBillboardVideosTask$1 this$2;
    final /* synthetic */ List val$requestedVideos;
    final /* synthetic */ Status val$res;
    
    BrowseAgent$FetchBillboardVideosTask$1$1(final BrowseAgent$FetchBillboardVideosTask$1 this$2, final List val$requestedVideos, final Status val$res) {
        this.this$2 = this$2;
    ...
    @Override
    public void run() {
        this.this$2.this$1.getCallback().onBBVideosFetched(this.val$requestedVideos, this.val$res);

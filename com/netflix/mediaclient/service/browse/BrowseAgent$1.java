...
class BrowseAgent$1 extends SimpleBrowseAgentCallback
{
    ...
    BrowseAgent$1(final BrowseAgent this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void onLoLoMoPrefetched(final Status status) {
        Log.d("nf_service_browseagent", String.format("preAppData fetch completed res: %s", status.getStatusCode()));
        this.this$0.mCache.removeLoLoMoId();
    }
}

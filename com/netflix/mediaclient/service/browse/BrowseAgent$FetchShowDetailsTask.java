...
class BrowseAgent$FetchShowDetailsTask extends BrowseAgent$CachedFetchTask<ShowDetails>
{
    ...
    public BrowseAgent$FetchShowDetailsTask(final BrowseAgent this$0, final String s, final String mCurrentEpisodeId, final BrowseAgentCallback browseAgentCallback) {
        this.this$0 = this$0;
    ...
    public void run() {
        ...
        if (showDetails == null || StringUtils.isNotEmpty(this.mCurrentEpisodeId)) {
            this.this$0.mBrowseWebClient.fetchShowDetails(this.getCategory(), this.mCurrentEpisodeId, this.webClientCallback);
            return;
        }

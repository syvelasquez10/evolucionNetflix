...
class PreAppAgentDataHandler$5 extends SimpleBrowseAgentCallback
{
    ...
    PreAppAgentDataHandler$5(final PreAppAgentDataHandler this$0, final PDiskData val$newData, final Set val$fetchCallbacksList, final PreAppAgentEventType val$updateType) {
        this.this$0 = this$0;
    ...
    public void onVideosFetched(final List<Video> list, final Status status) {
        Log.d("nf_preappagentdatahandler", String.format("nonMemberVideos fetched videos:%s", list));
        this.this$0.copyListIntoDiskData(this.val$newData, list, PDiskData$ListType.NON_MEMBER);
        this.val$fetchCallbacksList.remove(PDiskData$ListType.NON_MEMBER);

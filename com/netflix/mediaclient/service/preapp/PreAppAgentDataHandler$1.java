...
class PreAppAgentDataHandler$1 extends SimpleBrowseAgentCallback
{
    ...
    PreAppAgentDataHandler$1(final PreAppAgentDataHandler this$0, final PDiskData val$newData, final Set val$listsToFetch, final PreAppAgentEventType val$updateType) {
        this.this$0 = this$0;
    ...
    public void onBBVideosFetched(final List<Billboard> list, final Status status) {
        ...
        this.val$listsToFetch.remove(PDiskData$ListName.BILLBOARD);
    ...
    public void onCWVideosFetched(final List<CWVideo> list, final Status status) {
        ...
        this.val$listsToFetch.remove(PDiskData$ListName.CW);
        this.this$0.proceedAfterFetchOfLists(this.val$listsToFetch, this.val$newData, this.val$updateType);
    }
}

...
class PreAppAgentDataHandler$2 extends SimpleBrowseAgentCallback
{
    ...
    PreAppAgentDataHandler$2(final PreAppAgentDataHandler this$0, final PDiskData val$newData, final Set val$fetchCallbacksList, final PreAppAgentEventType val$updateType) {
        this.this$0 = this$0;
    ...
    public void onVideosFetched(final List<Video> list, final Status status) {
        ...
        this.this$0.copyListIntoDiskData(this.val$newData, list, PDiskData$ListType.IQ);
        this.val$fetchCallbacksList.remove(PDiskData$ListType.IQ);

...
class PreAppAgentDataHandler$4 extends SimpleBrowseAgentCallback
{
    ...
    PreAppAgentDataHandler$4(final PreAppAgentDataHandler this$0, final PDiskData val$newData, final Set val$listsToFetch, final PreAppAgentEventType val$updateType) {
        this.this$0 = this$0;
    ...
    public void onVideosFetched(final List<Video> list, final Status status) {
        this.this$0.copyListIntoDiskData(this.val$newData, list, PDiskData$ListName.STANDARD_SECOND);
        this.val$listsToFetch.remove(PDiskData$ListName.STANDARD_SECOND);

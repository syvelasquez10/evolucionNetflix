...
class PreAppAgentDataHandler$4 extends PDiskDataRepository$LoadCallback
{
    ...
    PreAppAgentDataHandler$4(final PreAppAgentDataHandler this$0, final PreAppAgentEventType val$updateType, final PDiskData val$newData) {
        this.this$0 = this$0;
    ...
    public void onDataLoaded(final PDiskData pDiskData) {
        ...
        PreAppAgentDataHandler.mServiceAgent.getMainHandler().post((Runnable)new PreAppAgentDataHandler$4$1(this, pDiskData));
    }
}

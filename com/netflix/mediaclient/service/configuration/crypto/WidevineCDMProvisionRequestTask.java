...
public final class WidevineCDMProvisionRequestTask extends AsyncTask<String, Void, byte[]>
{
    ...
    public WidevineCDMProvisionRequestTask(final byte[] drmRequest, final MSLWidevineCryptoManager$WidewineProvisionCallback callback) {
        this.TAG = "nf_net";
    ...
    public WidevineCDMProvisionRequestTask(final byte[] array, final MSLWidevineCryptoManager$WidewineProvisionCallback mslWidevineCryptoManager$WidewineProvisionCallback, final int connectionTimeout, final int socketTimeout) {
        this(array, mslWidevineCryptoManager$WidewineProvisionCallback);

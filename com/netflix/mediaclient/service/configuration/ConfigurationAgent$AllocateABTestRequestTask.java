...
class ConfigurationAgent$AllocateABTestRequestTask extends ConfigurationAgent$FetchTask
{
    private final int mCellId;
    private final int mTestId;
    final /* synthetic */ ConfigurationAgent this$0;
    
    public ConfigurationAgent$AllocateABTestRequestTask(final ConfigurationAgent this$0, final int mTestId, final int mCellId, final ConfigurationAgentWebCallback configurationAgentWebCallback) {
        this.this$0 = this$0;
    ...
    @Override
    public void run() {
        this.this$0.mConfigurationWebClient.allocateABTest(this.mTestId, this.mCellId, this.getCallback());
    }
}

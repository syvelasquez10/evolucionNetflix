...
public class WidevineErrorDescriptor implements ErrorDescriptor
{
    ...
    private void createData() {
        ...
        if (uri != null) {
            this.mData = new AlertDialogFactory$TwoButtonAlertDialogDescriptor("", message, null, mOkTask, this.mContext.getString(2131231058), new LaunchBrowser(this.mContext, uri));
            return;
        }
    ...
    private String getMessage(final int n, final StatusCode statusCode) {
        ...
        if (n == Integer.MAX_VALUE) {
            string = this.mContext.getString(2131231070);
        }
        else {
            String s;
            if (statusCode != null) {
            ...
            string = s;
            if (s == null) {
                return this.mContext.getString(2131231070);
            }
        }
        return string;
    }

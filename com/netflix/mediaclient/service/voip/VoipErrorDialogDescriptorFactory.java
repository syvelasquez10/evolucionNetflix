...
public class VoipErrorDialogDescriptorFactory
{
    ...
    private static ErrorDescriptor getHandle(final Context context, final String s, final String s2, final Runnable runnable) {
        return new VoipErrorDescriptor(new AlertDialogFactory$TwoButtonAlertDialogDescriptor(s, s2, context.getString(2131231176), new VoipErrorDialogDescriptorFactory$1(context), context.getString(2131230993), runnable));
    }

...
class MdxNotificationManagerLollipop$BuilderFactory
{
    ...
    private Notification$Builder createPlayerBuilder() {
        ...
        return new Notification$Builder(this.this$0.context).setOngoing(true).setVisibility(1).setOnlyAlertOnce(true).setShowWhen(false).setSmallIcon(2130837967).setStyle((Notification$Style)this.this$0.getStyle()).addAction(2130838090, (CharSequence)"Rewind", this.this$0.mdxAgent.getSkipbackIntent(-30)).addAction(2130838094, (CharSequence)"Pause", this.this$0.mdxAgent.getResumeIntent()).addAction(2130838096, (CharSequence)"Stop", this.this$0.mdxAgent.getStopIntent());
    }
    
    @SuppressLint({ "InlinedApi" })
    private Notification$Builder createPlayerPausedBuilder() {
        Log.i("nf_mdxnotification", "createPlayerPausedBuilder");
        return new Notification$Builder(this.this$0.context).setOngoing(true).setVisibility(1).setOnlyAlertOnce(true).setShowWhen(false).setSmallIcon(2130837967).setStyle((Notification$Style)this.this$0.getStyle()).addAction(2130838090, (CharSequence)"Rewind", this.this$0.mdxAgent.getSkipbackIntent(-30)).addAction(2130838092, (CharSequence)"Play", this.this$0.mdxAgent.getPauseIntent()).addAction(2130838096, (CharSequence)"Stop", this.this$0.mdxAgent.getStopIntent());
    }
    
    @SuppressLint({ "InlinedApi" })
    private Notification$Builder createPostPlayerBuilder() {
        return new Notification$Builder(this.this$0.context).setOngoing(true).setVisibility(1).setShowWhen(false).setOnlyAlertOnce(true).setSmallIcon(2130837967).setStyle((Notification$Style)this.this$0.getStyle()).addAction(2130838094, (CharSequence)"Play", this.this$0.mdxAgent.getPlayNextIntent()).addAction(2130838096, (CharSequence)"Stop", this.this$0.mdxAgent.getStopIntent());
    }

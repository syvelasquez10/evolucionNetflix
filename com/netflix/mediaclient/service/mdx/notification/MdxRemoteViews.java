...
public abstract class MdxRemoteViews
{
    ...
    private void updateBoxart(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewBitmap(2131427688, this.mBoxart);
    }
    
    private void updateTitles(final RemoteViews remoteViews) {
        if (remoteViews != null) {
            if (StringUtils.isNotEmpty(this.mMainTitle)) {
                remoteViews.setTextViewText(2131427689, (CharSequence)this.mMainTitle);
            }
            else {
                remoteViews.setTextViewText(2131427689, (CharSequence)"");
            }
            if (StringUtils.isNotEmpty(this.getHeader())) {
                remoteViews.setTextViewText(2131427695, (CharSequence)this.getHeader());
            }
            else {
                remoteViews.setTextViewText(2131427695, (CharSequence)"");
            }
            if (this.mIsEpisode) {
                if (StringUtils.isNotEmpty(this.mSubTitle)) {
                    remoteViews.setTextViewText(2131427690, (CharSequence)this.mSubTitle);
                    return;
                }
                remoteViews.setTextViewText(2131427690, (CharSequence)"");
            }
        }
    }
    ...
    protected void setPauseActive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131427692, 2130837819);
        remoteViews.setOnClickPendingIntent(2131427692, this.mIntentRetriever.getPauseIntent());
    }
    ...
    protected void setPauseInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131427692, 2130837820);
        remoteViews.setOnClickPendingIntent(2131427692, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setPlayActiveWithResume(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131427692, 2130837821);
        remoteViews.setOnClickPendingIntent(2131427692, this.mIntentRetriever.getResumeIntent());
    }
    ...
    protected void setPlayInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131427692, 2130837822);
        remoteViews.setOnClickPendingIntent(2131427692, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setStopInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131427693, 2130837824);
        remoteViews.setOnClickPendingIntent(2131427693, this.mIntentRetriever.getNoActionIntent());
    }

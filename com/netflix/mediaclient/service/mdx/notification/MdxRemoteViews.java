...
public abstract class MdxRemoteViews
{
    ...
    private RemoteViews createViewsForMovies(final boolean b) {
        ...
        if (b) {
            return new RemoteViews(this.mPackageName, 2130903173);
        }
        return new RemoteViews(this.mPackageName, 2130903172);
    }
    ...
    private void updateBoxart(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewBitmap(2131624347, this.mBoxart);
    }
    
    private void updateTitles(final RemoteViews remoteViews) {
        if (remoteViews != null) {
            if (StringUtils.isNotEmpty(this.mMainTitle)) {
                remoteViews.setTextViewText(2131624348, (CharSequence)this.mMainTitle);
            }
            else {
                remoteViews.setTextViewText(2131624348, (CharSequence)"");
            }
            if (StringUtils.isNotEmpty(this.getHeader())) {
                remoteViews.setTextViewText(2131624354, (CharSequence)this.getHeader());
            }
            else {
                remoteViews.setTextViewText(2131624354, (CharSequence)"");
            }
            if (this.mIsEpisode) {
                if (StringUtils.isNotEmpty(this.mSubTitle)) {
                    remoteViews.setTextViewText(2131624349, (CharSequence)this.mSubTitle);
                    return;
                }
                remoteViews.setTextViewText(2131624349, (CharSequence)"");
            }
        }
    }
    ...
    protected void setPauseActive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131624351, 2130837881);
        remoteViews.setOnClickPendingIntent(2131624351, this.mIntentRetriever.getPauseIntent());
    }
    ...
    protected void setPauseInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131624351, 2130837882);
        remoteViews.setOnClickPendingIntent(2131624351, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setPlayActiveWithGetNext(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131624351, 2130837883);
        remoteViews.setOnClickPendingIntent(2131624351, this.mIntentRetriever.getPlayNextIntent());
    }
    ...
    protected void setPlayActiveWithResume(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131624351, 2130837883);
        remoteViews.setOnClickPendingIntent(2131624351, this.mIntentRetriever.getResumeIntent());
    }
    ...
    protected void setPlayInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131624351, 2130837884);
        remoteViews.setOnClickPendingIntent(2131624351, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setStopActive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131624352, 2130837885);
        remoteViews.setOnClickPendingIntent(2131624352, this.mIntentRetriever.getStopIntent());
    }
    ...
    protected void setStopInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131624352, 2130837886);
        remoteViews.setOnClickPendingIntent(2131624352, this.mIntentRetriever.getNoActionIntent());
    }

...
public abstract class MdxRemoteViews
{
    ...
    private void updateBoxart(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewBitmap(2131689973, this.mBoxart);
    }
    
    private void updateTitles(final RemoteViews remoteViews) {
        if (remoteViews != null) {
            if (StringUtils.isNotEmpty(this.mMainTitle)) {
                remoteViews.setTextViewText(2131689974, (CharSequence)this.mMainTitle);
            }
            else {
                remoteViews.setTextViewText(2131689974, (CharSequence)"");
            }
            if (StringUtils.isNotEmpty(this.getHeader())) {
                remoteViews.setTextViewText(2131689980, (CharSequence)this.getHeader());
            }
            else {
                remoteViews.setTextViewText(2131689980, (CharSequence)"");
            }
            if (this.mIsEpisode) {
                if (StringUtils.isNotEmpty(this.mSubTitle)) {
                    remoteViews.setTextViewText(2131689975, (CharSequence)this.mSubTitle);
                    return;
                }
                remoteViews.setTextViewText(2131689975, (CharSequence)"");
            }
        }
    }
    ...
    protected void setPauseActive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131689977, 2130837875);
        remoteViews.setOnClickPendingIntent(2131689977, this.mIntentRetriever.getPauseIntent());
    }
    ...
    protected void setPauseInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131689977, 2130837876);
        remoteViews.setOnClickPendingIntent(2131689977, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setPlayActiveWithResume(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131689977, 2130837877);
        remoteViews.setOnClickPendingIntent(2131689977, this.mIntentRetriever.getResumeIntent());
    }
    ...
    protected void setPlayInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131689977, 2130837878);
        remoteViews.setOnClickPendingIntent(2131689977, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setStopInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131689978, 2130837880);
        remoteViews.setOnClickPendingIntent(2131689978, this.mIntentRetriever.getNoActionIntent());
    }

...
public abstract class MdxRemoteViews
{
    ...
    private RemoteViews createViewsForMovies(final boolean b) {
        ...
        if (b) {
            return new RemoteViews(this.mPackageName, 2130903206);
        }
    ...
    private void updateBoxart(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewBitmap(2131821128, this.mBoxart);
    }
    
    private void updateTitles(final RemoteViews remoteViews) {
        if (remoteViews != null) {
            if (StringUtils.isNotEmpty(this.mMainTitle)) {
                remoteViews.setTextViewText(2131821129, (CharSequence)this.mMainTitle);
            }
            else {
                remoteViews.setTextViewText(2131821129, (CharSequence)"");
            }
            if (StringUtils.isNotEmpty(this.getHeader())) {
                remoteViews.setTextViewText(2131821135, (CharSequence)this.getHeader());
            }
            else {
                remoteViews.setTextViewText(2131821135, (CharSequence)"");
            }
            if (this.mIsEpisode) {
                if (StringUtils.isNotEmpty(this.mSubTitle)) {
                    remoteViews.setTextViewText(2131821130, (CharSequence)this.mSubTitle);
                    return;
                }
                remoteViews.setTextViewText(2131821130, (CharSequence)"");
            }
        }
    }
    ...
    protected void setPauseActive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821132, 2130838092);
        remoteViews.setOnClickPendingIntent(2131821132, this.mIntentRetriever.getPauseIntent());
    }
    ...
    protected void setPauseInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821132, 2130838093);
        remoteViews.setOnClickPendingIntent(2131821132, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setPlayActiveWithResume(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821132, 2130838094);
        remoteViews.setOnClickPendingIntent(2131821132, this.mIntentRetriever.getResumeIntent());
    }
    ...
    protected void setPlayInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821132, 2130838095);
        remoteViews.setOnClickPendingIntent(2131821132, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setStopInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821133, 2130838097);
        remoteViews.setOnClickPendingIntent(2131821133, this.mIntentRetriever.getNoActionIntent());
    }

...
public abstract class MdxRemoteViews
{
    ...
    private void updateBoxart(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewBitmap(2131690000, this.mBoxart);
    }
    
    private void updateTitles(final RemoteViews remoteViews) {
        if (remoteViews != null) {
            if (StringUtils.isNotEmpty(this.mMainTitle)) {
                remoteViews.setTextViewText(2131690001, (CharSequence)this.mMainTitle);
            }
            else {
                remoteViews.setTextViewText(2131690001, (CharSequence)"");
            }
            if (StringUtils.isNotEmpty(this.getHeader())) {
                remoteViews.setTextViewText(2131690007, (CharSequence)this.getHeader());
            }
            else {
                remoteViews.setTextViewText(2131690007, (CharSequence)"");
            }
            if (this.mIsEpisode) {
                if (StringUtils.isNotEmpty(this.mSubTitle)) {
                    remoteViews.setTextViewText(2131690002, (CharSequence)this.mSubTitle);
                    return;
                }
                remoteViews.setTextViewText(2131690002, (CharSequence)"");
            }
        }
    }
    ...
    protected void setPauseActive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131690004, 2130837929);
        remoteViews.setOnClickPendingIntent(2131690004, this.mIntentRetriever.getPauseIntent());
    }
    ...
    protected void setPauseInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131690004, 2130837930);
    ...
    protected void setPlayActiveWithResume(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131690004, 2130837931);
        remoteViews.setOnClickPendingIntent(2131690004, this.mIntentRetriever.getResumeIntent());
    }
    ...
    protected void setPlayInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131690004, 2130837932);
        remoteViews.setOnClickPendingIntent(2131690004, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setStopInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131690005, 2130837934);
        remoteViews.setOnClickPendingIntent(2131690005, this.mIntentRetriever.getNoActionIntent());
    }

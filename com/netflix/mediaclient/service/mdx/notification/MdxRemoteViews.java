...
public abstract class MdxRemoteViews
{
    ...
    private void updateBoxart(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewBitmap(2131821118, this.mBoxart);
    }
    
    private void updateTitles(final RemoteViews remoteViews) {
        if (remoteViews != null) {
            if (StringUtils.isNotEmpty(this.mMainTitle)) {
                remoteViews.setTextViewText(2131821119, (CharSequence)this.mMainTitle);
            }
            else {
                remoteViews.setTextViewText(2131821119, (CharSequence)"");
            }
            if (StringUtils.isNotEmpty(this.getHeader())) {
                remoteViews.setTextViewText(2131821125, (CharSequence)this.getHeader());
            }
            else {
                remoteViews.setTextViewText(2131821125, (CharSequence)"");
            }
            if (this.mIsEpisode) {
                if (StringUtils.isNotEmpty(this.mSubTitle)) {
                    remoteViews.setTextViewText(2131821120, (CharSequence)this.mSubTitle);
                    return;
                }
                remoteViews.setTextViewText(2131821120, (CharSequence)"");
            }
        }
    }
    ...
    protected void setPauseActive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821122, 2130838069);
        remoteViews.setOnClickPendingIntent(2131821122, this.mIntentRetriever.getPauseIntent());
    }
    ...
    protected void setPauseInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821122, 2130838070);
        remoteViews.setOnClickPendingIntent(2131821122, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setPlayActiveWithGetNext(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821122, 2130838071);
        remoteViews.setOnClickPendingIntent(2131821122, this.mIntentRetriever.getPlayNextIntent());
    }
    ...
    protected void setPlayActiveWithResume(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821122, 2130838071);
        remoteViews.setOnClickPendingIntent(2131821122, this.mIntentRetriever.getResumeIntent());
    }
    ...
    protected void setPlayInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821122, 2130838072);
        remoteViews.setOnClickPendingIntent(2131821122, this.mIntentRetriever.getNoActionIntent());
    }
    ...
    protected void setStopActive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821123, 2130838073);
        remoteViews.setOnClickPendingIntent(2131821123, this.mIntentRetriever.getStopIntent());
    }
    ...
    protected void setStopInactive(final RemoteViews remoteViews) {
        ...
        remoteViews.setImageViewResource(2131821123, 2130838074);
        remoteViews.setOnClickPendingIntent(2131821123, this.mIntentRetriever.getNoActionIntent());
    }

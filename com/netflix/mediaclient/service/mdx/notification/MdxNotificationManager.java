...
public final class MdxNotificationManager implements IMdxNotificationManager
{
    ...
    private void createPlayerBuilder() {
        this.playerBuilder = new NotificationCompat$Builder(this.context).setOngoing(true).setOnlyAlertOnce(true).setSmallIcon(2130837799).setWhen(System.currentTimeMillis());
    }
    
    private void createPostPlayerBuilder() {
        this.postPlayerBuilder = new NotificationCompat$Builder(this.context).setOngoing(true).setOnlyAlertOnce(true).setSmallIcon(2130837799).setWhen(System.currentTimeMillis());
    }

...
class CastManager$6 implements Runnable
{
    ...
    CastManager$6(final CastManager this$0, final String val$uuid, final String val$location, final String val$friendlyName) {
        this.this$0 = this$0;

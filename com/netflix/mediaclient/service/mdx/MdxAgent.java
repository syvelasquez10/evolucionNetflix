...
public class MdxAgent extends ServiceAgent implements MdxController$PropertyUpdateListener, MdxImageLoader$MdxImageLoaderInterface, MdxSessionWatchDog$SessionWatchDogInterface, SwitchTarget$SwitchTargetInterface, TargetSelector$TargetSelectorInterface, CastAgent, MdxNotificationManager$MdxNotificationIntentRetriever, IMdx
{
    ...
    private String getCurrentEpisodeTitle() {
        ...
        if (this.mVideoDetails == null) {
            ...
            string = this.getContext().getString(2131231062, new Object[] { playable.getSeasonAbbrSeqLabel(), playable.getEpisodeNumber(), this.mVideoDetails.getTitle() });
            if (this.mVideoDetails.isNSRE()) {
                return this.getContext().getString(2131231063, new Object[] { this.mVideoDetails.getTitle() });
            }
        }
        return string;
    }
    ...
    private String getNextEpisodeTitle() {
        ...
        final String string = this.getContext().getString(2131231062, new Object[] { episodeDetails.getSeasonAbbrSeqLabel(), episodeDetails.getEpisodeNumber(), episodeDetails.getTitle() });
        if (episodeDetails.isNSRE()) {
            return this.getContext().getString(2131231063, new Object[] { episodeDetails.getTitle() });
        }
        return string;
    }
    ...
    private void updateMdxRemoteClient(final boolean b) {
        if ((!b || this.mVideoDetailsPostplay != null) && (b || this.mVideoDetails != null)) {
            ...
            if (videoDetails.getType() == VideoType.EPISODE) {
                String s;
                if (b) {
                    s = this.getContext().getString(2131231103);
                }
                else {

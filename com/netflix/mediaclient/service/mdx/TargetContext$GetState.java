...
class TargetContext$GetState implements Runnable
{
    final /* synthetic */ TargetContext this$0;
    
    TargetContext$GetState(final TargetContext this$0) {
        this.this$0 = this$0;
    }
    ...
    public void run() {
        ...
        this.this$0.mController.getSession().sendMessage(this.this$0.mSessionId, playerGetCurrentState.messageName(), playerGetCurrentState.messageObject());
    }
}

...
class TargetContext$DoPair implements Runnable
{
    final /* synthetic */ TargetContext this$0;
    
    TargetContext$DoPair(final TargetContext this$0) {
        this.this$0 = this$0;
    }
    
    @Override
    public void run() {
        this.this$0.mController.getPairing().pairingRequest(this.this$0.mUuid);
    }
}

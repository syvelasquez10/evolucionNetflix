...
public final class AutoValue_UmaCta$GsonTypeAdapter extends TypeAdapter<UmaCta>
{
    ...
    public UmaCta read(final JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (jsonReader.peek() == JsonToken.NULL) {
                ...
                switch (nextName) {
                    ...
                    case "text": {
                        s5 = this.textAdapter.read(jsonReader);
                        continue;
                    }
                    case "action": {
                        s4 = this.actionAdapter.read(jsonReader);
                        continue;
                    }
                    case "actionType": {
                        s3 = this.actionTypeAdapter.read(jsonReader);
                        continue;
                    }
                    case "callback": {
                        s2 = this.callbackAdapter.read(jsonReader);
                        continue;
                    }
                    case "trackingInfo": {
                        s = this.trackingInfoAdapter.read(jsonReader);
                        continue;
                    }
                    case "selected": {
        ...
        return new AutoValue_UmaCta(s5, s4, s3, s2, s, booleanValue2, booleanValue);
    }

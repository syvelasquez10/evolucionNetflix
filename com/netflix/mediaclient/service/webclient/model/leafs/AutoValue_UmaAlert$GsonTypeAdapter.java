...
public final class AutoValue_UmaAlert$GsonTypeAdapter extends TypeAdapter<UmaAlert>
{
    ...
    public UmaAlert read(final JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (jsonReader.peek() == JsonToken.NULL) {
                ...
                switch (nextName) {
                    ...
                    case "trackingInfo": {
                        s6 = this.trackingInfoAdapter.read(jsonReader);
                        continue;
                    }
                    case "timestamp": {
        ...
        return new AutoValue_UmaAlert(intValue, intValue2, s, s2, longValue, s3, booleanValue, s4, s5, umaCta, umaCta2, s6, longValue2);
    }

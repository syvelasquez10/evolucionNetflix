...
abstract class $$AutoValue_UmaCta extends UmaCta
{
    ...
    $$AutoValue_UmaCta(final String text, final String action, final String actionType, final String callback, final boolean selected, final boolean autoLogin) {
        this.text = text;
        this.action = action;
    ...
    public int hashCode() {
        ...
        if (this.callback != null) {
            hashCode = this.callback.hashCode();
        }
        int n2;
        if (this.selected) {
            n2 = 1231;
        ...
        return (n2 ^ ((hashCode4 ^ (hashCode3 ^ (hashCode2 ^ 0xF4243) * 1000003) * 1000003) * 1000003 ^ hashCode) * 1000003) * 1000003 ^ n;
    }

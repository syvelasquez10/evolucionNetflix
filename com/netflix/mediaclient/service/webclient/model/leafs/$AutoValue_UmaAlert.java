...
abstract class $AutoValue_UmaAlert extends UmaAlert
{
    ...
    $AutoValue_UmaAlert(final int abTestCell, final int abTestId, final String locale, final String messageName, final long messageId, final String viewType, final boolean blocking, final String title, final String body, final UmaCta cta1, final UmaCta cta2, final String trackingInfo, final long timestamp) {
                ...
                if (this.abTestCell == umaAlert.abTestCell() && this.abTestId == umaAlert.abTestId()) {
                    ...
                    if (this.messageId == umaAlert.messageId()) {
                        ...
                        if (this.blocking == umaAlert.blocking()) {
                            ...
                            else if (!this.trackingInfo.equals(umaAlert.trackingInfo())) {
                                return false;
                            }
    ...
    public int hashCode() {
        ...
        if (this.cta2 == null) {
            ...
            hashCode8 = this.cta2.hashCode();
        }
        if (this.trackingInfo != null) {
            hashCode = this.trackingInfo.hashCode();
        }
        return (int)(((hashCode8 ^ (hashCode7 ^ (hashCode6 ^ (hashCode5 ^ (n2 ^ (hashCode4 ^ n * 1000003) * 1000003) * 1000003) * 1000003) * 1000003) * 1000003) * 1000003 ^ hashCode) * 1000003 ^ (this.timestamp >>> 32 ^ this.timestamp));
    }
    ...
    public String toString() {
        return "UmaAlert{abTestCell=" + this.abTestCell + ", abTestId=" + this.abTestId + ", locale=" + this.locale + ", messageName=" + this.messageName + ", messageId=" + this.messageId + ", viewType=" + this.viewType + ", blocking=" + this.blocking + ", title=" + this.title + ", body=" + this.body + ", cta1=" + this.cta1 + ", cta2=" + this.cta2 + ", trackingInfo=" + this.trackingInfo + ", timestamp=" + this.timestamp + "}";
    }

...
public class PServiceWidgetAgent extends PServiceAgent implements PServiceAgent$PServiceWidgetAgentInterface
{
    ...
    private RemoteViews adjustLogoAndRefreshIcon(final Context context, final RemoteViews remoteViews, int n, final PVideo pVideo, final PDiskData$ListType pDiskData$ListType, final int n2, final int n3, final String s, final List<PVideo> list) {
        remoteViews.setOnClickPendingIntent(2131690144, this.getWidgetHomeIntent(n2));
        if (2130903234 == n3) {
            remoteViews.setOnClickPendingIntent(2131690145, this.getWidgetRefreshIntent(pVideo, pDiskData$ListType, n2));
            remoteViews.setViewVisibility(2131690143, 8);
            remoteViews.setViewVisibility(this.getGradientResourceId(1), 0);
        }
        else {
            remoteViews.setOnClickPendingIntent(2131690143, this.getWidgetRefreshIntent(pVideo, pDiskData$ListType, n2));
            if (this.canFitListName(context, n2)) {
                if (PDiskData$ListType.NON_MEMBER.equals(pDiskData$ListType)) {
                    ...
                    remoteViews.setTextViewText(2131690143, (CharSequence)this.getPreAppAdString(context, n));
                    return remoteViews;
                }
                remoteViews.setTextViewText(2131690143, (CharSequence)s);
                return remoteViews;
            }
        }
        return remoteViews;
    ...
    private void adjustViews(final Context context, final RemoteViews remoteViews, int n) {
        final int n2 = 0;
        remoteViews.setViewVisibility(2131690140, 8);
        remoteViews.setViewVisibility(2131690150, 8);
        remoteViews.setViewVisibility(2131690144, 0);
        remoteViews.setViewVisibility(2131690147, 0);
        remoteViews.setViewVisibility(2131690148, 0);
        ...
        if (n != 0 && cellFromDp2 <= 3) {
            remoteViews.setViewVisibility(2131690148, 8);
        }
        if (cellFromDp <= 1) {
            remoteViews.setViewVisibility(2131690147, 8);
            remoteViews.setViewVisibility(2131690148, 8);
        }
    }
    ...
    private RemoteViews buildWidgetStaticImageRemoteView(final Context context, final int n) {
        ...
        remoteViews.setImageViewResource(2131690139, 2130837908);
        remoteViews.setViewVisibility(2131690147, 0);
        remoteViews.setViewVisibility(2131690148, 0);
        remoteViews.setTextViewText(2131690147, context.getText(2131231246));
        remoteViews.setOnClickPendingIntent(2131690139, this.getWidgetHomeIntent(n));
        remoteViews.setOnClickPendingIntent(2131690143, this.getWidgetRefreshIntent(null, null, n));
        remoteViews.setOnClickPendingIntent(2131690144, this.getWidgetHomeIntent(n));
        return remoteViews;
    }
    ...
    private int getLayoutId(final Context context, int n) {
        if (this.isWidgetOneCellHigh(context, n)) {
            Log.d("nf_preapp_widgetagent", String.format("using preapp_widget_align_height %d", 2130903234));
            return 2130903234;
        }
        if (this.toAlignByWidth(context, n)) {
            Log.d("nf_preapp_widgetagent", String.format("using preapp_widget_vertical %d", 2130903236));
            return 2130903236;
        }
        ...
        Log.d("nf_preapp_widgetagent", String.format("using %d, preapp_widget_align_height=%d, preapp_width:%d, (widthInCell:%d) preapp_width_2cell:%d", n, 2130903234, 2130903237, cellFromDp, 2130903238));
        return n;
    }
    ...
    private int getNumberOfImages(final Context context, int widgetHeight, final int n) {
        int n2 = 3;
        if (2130903234 == widgetHeight || 2130903238 == widgetHeight) {
            n2 = 1;
        }
        else if (2130903236 != widgetHeight) {
            if (2130903237 != widgetHeight) {
                return 1;
            }
    ...
    private String getPreAppAdString(final Context context, final int n) {
        ...
        switch (n % 3) {
            default: {
                s = context.getString(2131231246);
                break;
            }
            case 0: {
                s = context.getString(2131231244);
                break;
            }
            case 1: {
                s = context.getString(2131231245);
                break;
            }
        }
    ...
    private String getVideoTitle(final Context context, final PDiskData$ListType pDiskData$ListType, final PVideo pVideo) {
        if (PDiskData$ListType.CW.equals(pDiskData$ListType) && VideoType.SHOW.equals(pVideo.videoType)) {
            return context.getString(2131231152, new Object[] { pVideo.title, pVideo.playableSeasonNumAbbrLabel, pVideo.playableEpisodeNumber });
        }
        return pVideo.title;
    }
    ...
    private void setViewsToDefault(final RemoteViews remoteViews) {
        remoteViews.setTextViewText(2131690143, (CharSequence)"");
        remoteViews.setViewVisibility(2131690140, 8);
        remoteViews.setViewVisibility(2131690153, 8);
        remoteViews.setViewVisibility(2131690160, 8);
        remoteViews.setViewVisibility(2131690142, 8);
        remoteViews.setViewVisibility(2131690154, 8);
        remoteViews.setViewVisibility(2131690161, 8);
        remoteViews.setViewVisibility(2131690149, 8);
        remoteViews.setViewVisibility(2131690155, 8);

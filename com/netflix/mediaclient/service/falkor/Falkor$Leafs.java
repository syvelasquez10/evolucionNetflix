...
public class Falkor$Leafs
{
    ...
    public static final String CLEAN_BOXSHOT = "cleanBoxart";
    public static final String COPYRIGHT = "copyright";
    public static final String DEFAULT_TRAILER = "defaultTrailer";
    public static final String DETAIL = "detail";
    public static final String EVIDENCE = "evidence";
    public static final String HAS_WATCHED = "hasWatched";
    ...
    public static final String INTERESTING_MOMENTS_URL = "intrUrl";
    ...
    public static final String TRICK_PLAY_BASE_BIG_URL = "trickplayBaseBigUrl";
    public static final String TRICK_PLAY_BASE_URL = "trickplayBaseUrl";

...
{
    public static RatingInfo getUserRating(final String s, final ServiceManager serviceManager, final VideoDetails videoDetails) {
        PQL pql;
        ...
        return (RatingInfo)serviceManager.getBrowse().getModelProxy().getValue(pql);
    }
}

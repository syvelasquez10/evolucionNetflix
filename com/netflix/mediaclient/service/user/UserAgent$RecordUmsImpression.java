...
class UserAgent$RecordUmsImpression implements Runnable
{
    final String mImpressionType;
    final String mMsgName;
    final /* synthetic */ UserAgent this$0;
    
    public UserAgent$RecordUmsImpression(final UserAgent this$0, final String mMsgName, final String mImpressionType) {
        this.this$0 = this$0;
    ...
    @Override
    public void run() {
        this.this$0.mUserWebClient.recordUmsImpression(this.mMsgName, this.mImpressionType);
    }
}

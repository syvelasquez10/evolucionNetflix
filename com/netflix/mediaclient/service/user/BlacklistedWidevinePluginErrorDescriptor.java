...
public class BlacklistedWidevinePluginErrorDescriptor implements ErrorDescriptor
{
    ...
    public BlacklistedWidevinePluginErrorDescriptor(final Context context) {
        ...
        this.mMetadata = new AlertDialogFactory$AlertDialogDescriptor("", context.getString(2131230875, new Object[] { 15003 }), null, new BlacklistedWidevinePluginErrorDescriptor$1(this, context));
    }

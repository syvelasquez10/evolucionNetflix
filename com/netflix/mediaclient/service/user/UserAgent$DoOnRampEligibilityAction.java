...
class UserAgent$DoOnRampEligibilityAction extends UserAgent$FetchTask<Void>
{
    OnRampEligibility$Action action;
    final /* synthetic */ UserAgent this$0;
    private final UserAgentWebCallback webClientCallback;
    
    public UserAgent$DoOnRampEligibilityAction(final UserAgent this$0, final OnRampEligibility$Action action, final UserAgent$UserAgentCallback userAgent$UserAgentCallback) {
        this.this$0 = this$0;
        super(userAgent$UserAgentCallback);
        this.webClientCallback = new UserAgent$DoOnRampEligibilityAction$1(this);
        this.action = action;
    }
    
    @Override
    public void run() {
        this.this$0.mUserWebClient.doOnRampEligibilityAction(this.action, this.webClientCallback);
    }
}

...
class UserAgent$MarkSurveysAsReadTask extends UserAgent$FetchTask<Void>
{
    final /* synthetic */ UserAgent this$0;
    
    public UserAgent$MarkSurveysAsReadTask(final UserAgent this$0) {
        this.this$0 = this$0;
        super(null);
    }
    ...
    @Override
    public void run() {
        this.this$0.mUserWebClient.markSurveysAsRead();
    }
}

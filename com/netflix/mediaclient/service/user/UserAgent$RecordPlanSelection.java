...
class UserAgent$RecordPlanSelection implements Runnable
{
    final String mPlanId;
    final String mPriceTier;
    final /* synthetic */ UserAgent this$0;
    
    public UserAgent$RecordPlanSelection(final UserAgent this$0, final String mPlanId, final String mPriceTier) {
        this.this$0 = this$0;
    ...
    @Override
    public void run() {
        this.this$0.mUserWebClient.recordPlanSelection(this.mPlanId, this.mPriceTier);
    }
}

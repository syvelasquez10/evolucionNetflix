...
class UserAgent$VerifyAgeTask extends UserAgent$FetchTask<Void>
{
    final /* synthetic */ UserAgent this$0;
    private final UserAgentWebCallback webClientCallback;
    
    public UserAgent$VerifyAgeTask(final UserAgent this$0, final UserAgent$UserAgentCallback userAgent$UserAgentCallback) {
        this.this$0 = this$0;
        super(userAgent$UserAgentCallback);
        this.webClientCallback = new UserAgent$VerifyAgeTask$1(this);
    }
    
    @Override
    public void run() {
        this.this$0.mUserWebClient.fetchUserData(this.webClientCallback);
    }
}

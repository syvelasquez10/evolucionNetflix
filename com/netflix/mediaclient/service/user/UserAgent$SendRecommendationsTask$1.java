...
class UserAgent$SendRecommendationsTask$1 extends SimpleUserAgentWebCallback
{
    ...
    public void onRecommendationsSent(final Set<FriendForRecommendation> set, final Status status) {
        Label_0182: {
            ...
            String s;
            if (n == 0) {
                s = this.this$1.this$0.getContext().getString(2131165671, new Object[] { firstName });
            }
            else {
                s = this.this$1.this$0.getContext().getResources().getQuantityString(2131230723, n, new Object[] { n, firstName });
            }

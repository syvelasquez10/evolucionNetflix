...
class UserAgent$AddWebUserProfilesTask implements Runnable
{
    ...
    public UserAgent$AddWebUserProfilesTask(final UserAgent this$0, final String profileName, final boolean startInKidsZone, final String profileIconName, final UserAgent$UserAgentCallback mCallback) {
        this.this$0 = this$0;
    ...
    @Override
    public void run() {
        this.this$0.mUserWebClient.addWebUserProfile(this.profileName, this.startInKidsZone, this.profileIconName, new UserAgent$ProfilesUpdateCallBackWithResult(this.this$0, this.mCallback, null));
    }
}

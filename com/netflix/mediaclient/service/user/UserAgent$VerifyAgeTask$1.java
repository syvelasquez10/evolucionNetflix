...
class UserAgent$VerifyAgeTask$1 extends SimpleUserAgentWebCallback
{
    final /* synthetic */ UserAgent$VerifyAgeTask this$1;
    
    UserAgent$VerifyAgeTask$1(final UserAgent$VerifyAgeTask this$1) {
        this.this$1 = this$1;
    }
    ...
    public void onUserDataFetched(final User user, final Status status) {
        if (status.isSucces()) {
            this.this$1.this$0.persistUser(user);
        }
        this.this$1.this$0.getMainHandler().post((Runnable)new UserAgent$VerifyAgeTask$1$1(this, status));
    }
}

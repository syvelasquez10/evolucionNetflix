...
class UserAgent$FetchSurveyTask extends UserAgent$FetchTask<Void>
{
    final /* synthetic */ UserAgent this$0;
    private final UserAgentWebCallback webClientCallback;
    
    public UserAgent$FetchSurveyTask(final UserAgent this$0, final UserAgent$UserAgentCallback userAgent$UserAgentCallback) {
        this.this$0 = this$0;
        super(userAgent$UserAgentCallback);
        this.webClientCallback = new UserAgent$FetchSurveyTask$1(this);
    }
    
    @Override
    public void run() {
        this.this$0.mUserWebClient.fetchSurvey(this.webClientCallback);
    }
}

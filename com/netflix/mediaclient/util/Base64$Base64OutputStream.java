...
public class Base64$Base64OutputStream extends FilterOutputStream
{
    private byte[] b4;
    ...
    public Base64$Base64OutputStream(final OutputStream outputStream) {
        this(outputStream, 1);
    }
    
    public Base64$Base64OutputStream(final OutputStream outputStream, final int options) {

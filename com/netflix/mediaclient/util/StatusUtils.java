...
public final class StatusUtils
{
    ...
    public static Status createStatus(final StatusCode statusCode, final String s, final boolean b, final RootCause rootCause) {
        ...
        debug.setMessage(JsonUtils.createJson("reason", s));
        netflixStatus.setError(createError(statusCode, b, rootCause, debug));
            ...
            while (true) {
                ...
                while (true) {
                    try {
                        ...
                        netflixStatus2.setError(createError(statusCode, b, RootCause.serverFailure, debug));
                        return netflixStatus;
                        Label_0159: {
                            statusCode = StatusCode.NRD_LOGIN_ACTIONID_1;
                        }
                        continue Label_0070_Outer;
                        // switch([Lcom.strobel.decompiler.ast.Label;@6db62c96, actionID)
                        Label_0217:

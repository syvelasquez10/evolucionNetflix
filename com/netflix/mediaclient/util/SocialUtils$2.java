...
final class SocialUtils$2 implements View$OnClickListener
{
    ...
    public void onClick(final View view) {
        ...
        if (this.val$manager.getCurrentProfile().isSocialConnected()) {
            ...
            final Dialog displayDialog = this.val$activity.displayDialog(new AlertDialog$Builder((Context)this.val$activity).setPositiveButton(2131165485, (DialogInterface$OnClickListener)new SocialUtils$2$1(this)).setMessage((CharSequence)Html.fromHtml(this.val$activity.getString(2131165605))).setNegativeButton(2131165400, (DialogInterface$OnClickListener)null));

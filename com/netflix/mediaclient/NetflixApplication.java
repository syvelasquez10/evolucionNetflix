...
public class NetflixApplication extends Application
{
    ...
    private void reportFailedToLoadNativeLibraries(final Throwable t, final int n) {
        ...
        final NotificationCompat$Builder setAutoCancel = new NotificationCompat$Builder((Context)this).setOngoing(false).setOnlyAlertOnce(false).setSmallIcon(2130837744).setWhen(System.currentTimeMillis()).setTicker(this.getString(2131493273, new Object[] { n })).setContentTitle(this.getString(2131493271, new Object[] { n })).setContentText(this.getString(2131493272, new Object[] { n })).setAutoCancel(true);

...
final class RealmUtils$2 implements Realm$Transaction
{
    final /* synthetic */ Context val$context;
    final /* synthetic */ String val$playableId;
    
    RealmUtils$2(final String val$playableId, final Context val$context) {
    ...
    public void execute(final Realm realm) {
        final RealmVideoDetails realmVideoDetails = realm.where(RealmVideoDetails.class).equalTo("id", this.val$playableId).findFirst();
        ...
        while (true) {
            Label_0272: {
                ...
                if (realm.where(RealmVideoDetails.class).equalTo("playable.parentId", realmVideoDetails.getPlayable().getParentId()).equalTo("videoType", Integer.valueOf(VideoType.EPISODE.getKey())).findAll().size() == 1) {

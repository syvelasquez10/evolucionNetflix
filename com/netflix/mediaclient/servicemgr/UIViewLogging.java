...
public interface UIViewLogging
{
    ...
    public static final String EXTRA_IS_MODAL = "isModalView";
    public static final String EXTRA_MODEL = "model";
    public static final String EXTRA_SUCCESS = "success";
    public static final String EXTRA_TRACKING_INFO = "trackingInfo";
    ...
    public static final String MODAL_VIEW_ENDED = "com.netflix.mediaclient.intent.action.LOG_UIVIEW_MDL_VW_ENDED";
    public static final String MODAL_VIEW_START = "com.netflix.mediaclient.intent.action.LOG_UIVIEW_MDL_VW_START";
    ...
    void endModalViewSession(final IClientLogging$ModalView p0, final String p1, final boolean p2);

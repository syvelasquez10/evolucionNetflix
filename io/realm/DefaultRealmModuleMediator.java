...
class DefaultRealmModuleMediator extends RealmProxyMediator
{
    ...
    static {
        ...
        set.add(RealmIncompleteVideoDetails.class);
        set.add((Class<RealmIncompleteVideoDetails>)RealmProfile.class);
        set.add((Class<RealmIncompleteVideoDetails>)RealmVideoDetails.class);
        set.add((Class<RealmIncompleteVideoDetails>)RealmSeason.class);
        set.add((Class<RealmIncompleteVideoDetails>)RealmPlayable.class);

...
public final class r extends HttpURLConnection
{
    ...
    public r(final HttpURLConnection b, final e a, final d d) {
        super(b.getURL());
        this.e = false;
        this.f = false;
        this.b = b;
    ...
    private void b() {
        ...
        //     3: istore_1       
        //     4: aload_0        
        //     5: getfield        crittercism/android/r.e:Z
        //     8: ifne            159
        //    11: aload_0        
        //    12: iconst_1       
        //    13: putfield        crittercism/android/r.e:Z
        //    16: aload_0        
        //    17: getfield        crittercism/android/r.c:Lcrittercism/android/c;
        //    20: invokevirtual   crittercism/android/c.c:()V
        //    23: aload_0        
        //    24: getfield        crittercism/android/r.b:Ljava/net/HttpURLConnection;
        //    27: invokevirtual   java/net/HttpURLConnection.getHeaderFields:()Ljava/util/Map;
        //    30: ifnull          130
        //    33: new             Lcrittercism/android/p;
        //    36: dup            
        //    37: aload_0        
        //    38: getfield        crittercism/android/r.b:Ljava/net/HttpURLConnection;
        //    41: invokevirtual   java/net/HttpURLConnection.getHeaderFields:()Ljava/util/Map;
        ...
        //    59: if_icmpeq       73
        //    62: aload_0        
        //    63: getfield        crittercism/android/r.c:Lcrittercism/android/c;
        //    66: iload_2        
        //    67: i2l            
        ...
        //   108: ifeq            130
        //   111: aload_0        
        //   112: getfield        crittercism/android/r.c:Lcrittercism/android/c;
        //   115: lload_3        
        //   116: invokevirtual   crittercism/android/c.e:(J)V
        //   119: aload_0        
        //   120: getfield        crittercism/android/r.c:Lcrittercism/android/c;
        //   123: lload           5
        //   125: invokevirtual   crittercism/android/c.f:(J)V
        //   128: iload_1        
        //   129: istore_2       
        //   130: aload_0        
        //   131: getfield        crittercism/android/r.c:Lcrittercism/android/c;
        //   134: aload_0        
        //   135: getfield        crittercism/android/r.b:Ljava/net/HttpURLConnection;
        //   138: invokevirtual   java/net/HttpURLConnection.getResponseCode:()I
        //   141: putfield        crittercism/android/c.e:I
        //   144: iload_2        
        //   145: ifeq            159
        //   148: aload_0        
        //   149: getfield        crittercism/android/r.a:Lcrittercism/android/e;
        //   152: aload_0        
        //   153: getfield        crittercism/android/r.c:Lcrittercism/android/c;
